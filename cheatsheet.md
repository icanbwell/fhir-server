...
| By extension             | extension={system}&#124;{value} | https://fhir.icanbwell.com/4_0_0/Practitioner/?extension=http://hl7.org/fhir/sid/us-npi&#124;1487831681  | All                                                                               |     |
...
| Before recorded date      | date=lt{date}                                                                                                                      | https://fhir.icanbwell.com/4_0_0/Appointment?date=lt2021-09-19                                                                                                                                                    | Appointment                                                                        |     |
| After recorded date       | date=gt{date}                                                                                                                      | https://fhir.icanbwell.com/4_0_0/Appointment?date=gt2021-09-19                                                                                                                                                    | Appointment                                                                        |     |
...
### 1.6 Negating a search filter
You can append a search filter with `:not` per the FHIR specification:
Example: `/4_0_0/Patient?_security:not=https://www.icanbwell.com/owner%7Cbwell`

### 1.7 Getting total count

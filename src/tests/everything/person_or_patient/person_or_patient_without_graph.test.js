...
const expectedPatientContainedResources = require('./fixtures/expected/expected_Patient_everything.json');
...
describe('Person and Patient $everything Tests', () => {
    ...
    describe('Person and Patient $everything Tests', () => {
        test('Person and Patient $everything works when rawResource and rawSeriazlier is enabled', async () => {
            ...
            // One Query Less as 2nd level person is not fetched
            expect(query.split('|').length).toEqual(75);

/* eslint-disable no-useless-escape,no-throw-literal,no-unused-vars */
// Generated from FHIRPath.g4 by ANTLR 4.9.3
// jshint ignore: start
const antlr4 = require('antlr4');
const FHIRPathListener = require('./FHIRPathListener');
const FHIRPathVisitor = require('./FHIRPathVisitor');
...
class FHIRPathParser extends antlr4.Parser {
    ...
    entireExpression () {
        const localctx = new EntireExpressionContext(this, this._ctx, this.state);
    ...
    invocation () {
        ...
        try {
            this.state = 111;
            this._errHandler.sync(this);
            const la_ = this._interp.adaptivePredict(this._input, 6, this._ctx);
            switch (la_) {
                case 1:
    ...
    functn () {
        const localctx = new FunctnContext(this, this._ctx, this.state);
    ...
    paramList () {
        const localctx = new ParamListContext(this, this._ctx, this.state);
    ...
    quantity () {
        const localctx = new QuantityContext(this, this._ctx, this.state);
    ...
    unit () {
        const localctx = new UnitContext(this, this._ctx, this.state);
    ...
    dateTimePrecision () {
        const localctx = new DateTimePrecisionContext(this, this._ctx, this.state);
    ...
    pluralDateTimePrecision () {
        const localctx = new PluralDateTimePrecisionContext(this, this._ctx, this.state);
    ...
    typeSpecifier () {
        const localctx = new TypeSpecifierContext(this, this._ctx, this.state);

...
describe('AuditEvent when all is set Tests', () => {
    ...
    describe('AuditEvent accessIndex Tests when all is set', () => {
        test('accessIndex works for audit event when all is set', async () => {
            ...
            resp = await request
                .get('/4_0_0/AuditEvent/?date=lt2021-09-22&date=gt2021-09-19&_bundle=1&_debug=1&_count=2&_getpagesoffset=0&_security=https://www.icanbwell.com/access%7Cmedstar')
                .set(getHeaders());
            // noinspection JSUnresolvedFunction

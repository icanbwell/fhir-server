...
/**
 * fixDuplicateUuid.js: thin CLI wrapper around FixDuplicateUuidRunner.
 */

const SCRIPT_PATH = '../../../../admin/scripts/fixDuplicateUuid';
const RUNNER_PATH = '../../../../admin/runners/fixDuplicateUuidRunner';
...
jestGlobal.mock(RUNNER_PATH, () => ({
    FixDuplicateUuidRunner: mockRunnerCtor
}));
...
describe('fixDuplicateUuid.js (admin script)', () => {
    let exitSpy;
    let consoleLogSpy;
    let consoleErrorSpy;
    ...
    test('splits and trims a comma-separated --collections', async () => {
        await runScript({ collections: 'Practitioner_4_0_0 , Person_4_0_0' });
        expect(mockRunnerCtor.mock.calls[0][0].collections).toEqual(['Practitioner_4_0_0', 'Person_4_0_0']);
    });
    ...
    test('splits and trims a comma-separated --properties', async () => {

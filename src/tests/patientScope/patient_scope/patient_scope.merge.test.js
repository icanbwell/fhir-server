...
describe('Patient scope resource testcases', () => {
    ...
    test('Patient everything test', async () => {
        ...
        // resp = await request.post('/4_0_0/Account/$merge').send(AccountResource2).set(headers1);
        // // noinspection JSUnresolvedFunction
        // expect(resp).toHaveMergeResponse({ created: true });
        ...
        resp = await request.post('/4_0_0/Basic/$merge').send(BasicResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Basic/$merge').send(BasicResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });
        ...
        resp = await request.post('/4_0_0/Claim/$merge').send(ClaimResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Claim/$merge').send(ClaimResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });
        ...
        resp = await request.post('/4_0_0/Consent/$merge').send(ConsentResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Consent/$merge').send(ConsentResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });
        ...
        resp = await request.post('/4_0_0/Device/$merge').send(DeviceResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Device/$merge').send(DeviceResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });
        ...
        resp = await request.post('/4_0_0/Flag/$merge').send(FlagResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Flag/$merge').send(FlagResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Goal/$merge').send(GoalResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Goal/$merge').send(GoalResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        // resp = await request.post('/4_0_0/Group/$merge').send(GroupResource1).set(headers1);
        // // noinspection JSUnresolvedFunction
        // expect(resp).toHaveMergeResponse({ created: true });

        // resp = await request.post('/4_0_0/Group/$merge').send(GroupResource2).set(headers1);
        // // noinspection JSUnresolvedFunction
        // expect(resp).toHaveMergeResponse({ created: true });
        ...
        resp = await request.post('/4_0_0/Invoice/$merge').send(InvoiceResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Invoice/$merge').send(InvoiceResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/List/$merge').send(ListResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/List/$merge').send(ListResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });
        ...
        resp = await request.post('/4_0_0/Media/$merge').send(MediaResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Media/$merge').send(MediaResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });
        ...
        resp = await request.post('/4_0_0/Patient/$merge').send(PatientResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Patient/$merge').send(PatientResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });
        ...
        resp = await request.post('/4_0_0/Task/$merge').send(TaskResource1).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

        resp = await request.post('/4_0_0/Task/$merge').send(TaskResource2).set(headers1);
        // noinspection JSUnresolvedFunction
        expect(resp).toHaveMergeResponse({ created: true });

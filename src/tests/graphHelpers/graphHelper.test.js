        ...
        test('graphHelper multiple Practitioners with 2 level nesting and extension and contained works with debug', async () => {
            ...
            expect(result.toJSON()).toStrictEqual({
                ...
                'meta': {
                    'tag': [
                        {
                            'display': "db.Practitioner_4_0_0.find({'id':{'$in':['1','2']}}, {'_id':0})  | db.Practitioner_4_0_0.find({'$and':[{'practitioner.reference':{'$in':['Practitioner/1','Practitioner/2']}}]}, {}) | db.Practitioner_4_0_0.find({'$and':[{'id':{'$in':['100','200']}}]}, {}) | db.Practitioner_4_0_0.find({'$and':[{'id':{'$in':['AETNA-Aetna-Elect-Choice--EPO--Aetna-Health-Fund--Innovation-He']}}]}, {})",
            ...
            expect(result.toJSON()).toStrictEqual({
                ...
                'meta': {
                    'tag': [
                        {
                            'system': 'https://www.icanbwell.com/query',
                            'display': "db.Practitioner_4_0_0.find({'id':{'$in':['1','2']}}, {'_id':0})  | db.Practitioner_4_0_0.find({'$and':[{'practitioner.reference':'Practitioner/1'}]}, {}) | db.Practitioner_4_0_0.find({'$and':[{'id':{'$in':['100']}}]}, {}) | db.Practitioner_4_0_0.find({'$and':[{'id':{'$in':['AETNA-Aetna-Elect-Choice--EPO--Aetna-Health-Fund--Innovation-He']}}]}, {})",
                        },
                        {
                            'system': 'https://www.icanbwell.com/queryCollection',
                            'code': 'Practitioner_4_0_0'

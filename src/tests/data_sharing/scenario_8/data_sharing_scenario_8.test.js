...
const client1ConsentGivenResource = require('./fixtures/consent/client_1_consent_given.json');
const client1ConsentDeniedResource = require('./fixtures/consent/client_1_consent_denied.json');
...
describe('Data sharing test cases for different scenarios', () => {
    ...
    describe('Data Sharing Scenario - 8', () => {
        ...
        test('Ref of master person: Get Client-1 patient data only, no proa data as consent denied provided', async () => {
            const request = await createTestRequest((c) => {
                return c;
            });
        ...
        test('Ref of master person: Get Client-1 patient & proa patient data, consent provided, and later consent revoked.', async () => {
            ...
            expect(respIds1.length).toEqual(1);
            expect(respIds1).toEqual([client1ObservationResource.id]);
        });

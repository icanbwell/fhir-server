...
describe('AuditEventLastUpdatedTests', () => {
    ...
    describe('AuditEvent Last Updated Tests', () => {
        test('search by last updated works', async () => {
            ...
            resp = await request
                .get(
                    '/4_0_0/AuditEvent/?_security=https://www.icanbwell.com/access|fake&_lastUpdated=gt2021-06-01&_lastUpdated=lt2031-10-26&_count=10&_getpagesoffset=0&_debug=1&date=gt2021-06-01&date=lt2030-02-02&_bundle=1&streamResponse=1'
                )
                .set(getHeaders());

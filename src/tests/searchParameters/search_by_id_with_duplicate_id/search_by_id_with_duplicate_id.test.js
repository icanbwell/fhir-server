...
describe('Observation Tests', () => {
    ...
    describe('Observation search_by_id_with_duplicate_id Tests', () => {
        test('search_by_id_with_duplicate_id adds two resources with same id', async () => {
            ...
            resp = await request
                .get('/4_0_0/Observation/1/?_bundle=1&_debug=1&_security=https://www.icanbwell.com/owner|C')
                .set(getHeaders());
            // noinspection JSUnresolvedFunction
            ...
            resp = await request
                .get('/4_0_0/Observation/1/?_bundle=1&_debug=1&_security=https://www.icanbwell.com/sourceAssigningAuthority|C')
                .set(getHeaders());
            // noinspection JSUnresolvedFunction
            ...
            resp = await request
                .get('/4_0_0/Observation/1/?_bundle=1&_debug=1')
                .set(getHeaders());
            // noinspection JSUnresolvedFunction

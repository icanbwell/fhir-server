...
describe('AuditEventRecordedTests', () => {
    ...
    describe('AuditEvent Recorded Tests', () => {
        test('search by recorded works', async () => {
            ...
            let resp = await request.get('/4_0_0/AuditEvent/?date=gt2021-08-10&date=lt2021-11-02').set(getHeaders());
            ...
            resp = await request
                .get(
                    '/4_0_0/AuditEvent/?_security=https://www.icanbwell.com/access|fake&_lastUpdated=gt2021-06-01&_lastUpdated=lt2031-10-26&_count=10&_getpagesoffset=0&_setIndexHint=1&_debug=1&date=gt2021-08-10&date=lt2021-11-02&_bundle=1'
                )
                .set(getHeaders());

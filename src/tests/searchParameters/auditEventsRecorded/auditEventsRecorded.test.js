                ...
                'issue': [
                    {
                        ...
                        'code': 'invalid',
                        'details': {
                            'text': '2020-02-02 is not valid to query audit event. [lt, gt] operation is required',
                        },
                        'diagnostics': '2020-02-02 is not valid to query audit event. [lt, gt] operation is required',
                    }
                ]
            });

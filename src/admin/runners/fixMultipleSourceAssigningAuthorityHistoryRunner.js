 ...
 */
class FixMultipleSourceAssigningAuthorityHistoryRunner extends BaseBulkOperationRunner {
    /**
     * constructor
    ...
    async processRecordAsync (doc) {
        ...
        let resourceRaw = doc.resource;
        resourceRaw = fixMultipleAuthorities(resourceRaw);
...
module.exports = {
    FixMultipleSourceAssigningAuthorityHistoryRunner
};

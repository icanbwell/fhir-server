...
class FixReferenceIdRunner extends BaseBulkOperationRunner {
    ...
    async updateReferenceAsync(reference, databaseQueryFactory) {
        try {
            ...
            // create current reference with uuid
            let uuidReference;
            if (uuid) {
    ...
    async processAsync() {
        ...
        try {
            ...
            for (const collectionName of this.collections) {
                 ...
                 * @type {import('mongodb').Filter<import('mongodb').Document>}
                 */
                let query = this.getQueryFromParameters();
                ...
                // if query is not empty then run the function and change the resources found in it

 ...
 * node --max-old-space-size=8192 src/admin/scripts/fixHistory.js --collections=all --batchSize=10000
 * node --max-old-space-size=8192 src/admin/scripts/fixHistory.js --collections=all --batchSize=10000 --startFromCollection Practitioner_4_0_0
 * node --max-old-space-size=8192 src/admin/scripts/fixHistory.js --collections=all --batchSize=10000 --startFromCollection Practitioner_4_0_0 --skipIfResourcePresent

...
} = require('../runners/fixDuplicatePractitionerRunner');
...
async function main () {
     ...
     * @type {string[]}
     */
    const collections = ['Practitioner_4_0_0'];

    const batchSize = parameters.batchSize || process.env.BULK_BUFFER_SIZE || 10000;
    const adminLogger = new AdminLogger();

    adminLogger.logInfo(`[${currentDateTime}] Running fixDuplicatePractitioners script`);
    ...
    /**
     * @type {FixDuplicatePractitionerRunner}
     */
    const fixDuplicatePractitionerRunner = container.fixDuplicatePractitionerRunner;
    await fixDuplicatePractitionerRunner.processAsync();
 ...
 * NODE_OPTIONS=--max_old_space_size=8192 node --max-old-space-size=8192 src/admin/scripts/fixDuplicatePractitioner.js --batchSize=10000 --useTransaction --startFromId=123
 * NODE_OPTIONS=--max_old_space_size=8192 node --max-old-space-size=8192 src/admin/scripts/fixDuplicatePractitioner.js --batchSize=10000 --useTransaction --skip 200000
 * NODE_OPTIONS=--max_old_space_size=8192 node --max-old-space-size=8192 src/admin/scripts/fixDuplicatePractitioner.js --batchSize=10000 --limit 10 --before 2023-10-28
 * NODE_OPTIONS=--max_old_space_size=8192 node --max-old-space-size=8192 src/admin/scripts/fixDuplicatePractitioner.js --batchSize=10000 --limit 10 --after 2023-10-28
 */

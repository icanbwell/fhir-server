...
/** @type {import('../backboneElements/testScriptAction1.js')} */
let TestScriptAction1Serializer;

class TestScriptTestSerializer extends BaseSerializer {
        ...
        action: () => {
            ...
            if (!this.#configCache['action']) {
                if (!TestScriptAction1Serializer) {
                    TestScriptAction1Serializer = require('../backboneElements/testScriptAction1.js');
                }
                this.#configCache['action'] = {
                    serializeFunction: 'serializeArray',
                    serializerClass: TestScriptAction1Serializer
                };
            }
...
module.exports = new TestScriptTestSerializer();

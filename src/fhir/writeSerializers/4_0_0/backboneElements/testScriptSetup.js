...
/** @type {import('../backboneElements/testScriptAction.js')} */
let TestScriptActionSerializer;

class TestScriptSetupSerializer extends BaseSerializer {
    ...
    fhirPropertyToSerializerMap = {
        ...
        action: () => {
            if (!this.#configCache['action']) {
                if (!TestScriptActionSerializer) {
                    TestScriptActionSerializer = require('../backboneElements/testScriptAction.js');
                }
                this.#configCache['action'] = {
                    serializeFunction: 'serializeArray',
                    serializerClass: TestScriptActionSerializer
                };
            }
...
module.exports = new TestScriptSetupSerializer();

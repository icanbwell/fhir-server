...
/** @type {import('../backboneElements/testScriptAction2.js')} */
let TestScriptAction2Serializer;

class TestScriptTeardownSerializer extends BaseSerializer {
    ...
    fhirPropertyToSerializerMap = {
        ...
        action: () => {
            if (!this.#configCache['action']) {
                if (!TestScriptAction2Serializer) {
                    TestScriptAction2Serializer = require('../backboneElements/testScriptAction2.js');
                }
                this.#configCache['action'] = {
                    serializeFunction: 'serializeArray',
                    serializerClass: TestScriptAction2Serializer
                };
            }
...
module.exports = new TestScriptTeardownSerializer();

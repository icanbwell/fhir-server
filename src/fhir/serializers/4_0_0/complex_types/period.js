...
class PeriodSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PeriodSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PeriodSerializer.propertyToSerializerMap) {
                if (PeriodSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PeriodSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = PeriodSerializer;

...
class DataRequirementCodeFilterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DataRequirementCodeFilterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DataRequirementCodeFilterSerializer.propertyToSerializerMap) {
                if (DataRequirementCodeFilterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DataRequirementCodeFilterSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = DataRequirementCodeFilterSerializer;

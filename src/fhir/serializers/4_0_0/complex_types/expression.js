...
class ExpressionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExpressionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExpressionSerializer.propertyToSerializerMap) {
                if (ExpressionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExpressionSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ExpressionSerializer;

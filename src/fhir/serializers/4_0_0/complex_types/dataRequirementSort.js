...
class DataRequirementSortSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DataRequirementSortSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DataRequirementSortSerializer.propertyToSerializerMap) {
                if (DataRequirementSortSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DataRequirementSortSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = DataRequirementSortSerializer;

...
class AnnotationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AnnotationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AnnotationSerializer.propertyToSerializerMap) {
                if (AnnotationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AnnotationSerializer.propertyToSerializerMap[propertyName](value, context);

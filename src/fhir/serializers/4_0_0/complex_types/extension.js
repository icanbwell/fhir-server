...
class ExtensionSerializer {
    static propertyToSerializerMap = {
        ...
        valueCodeableReference: (value, context) => {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExtensionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExtensionSerializer.propertyToSerializerMap) {
                if (ExtensionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExtensionSerializer.propertyToSerializerMap[propertyName](value, context);

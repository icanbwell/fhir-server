...
class UsageContextSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => UsageContextSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in UsageContextSerializer.propertyToSerializerMap) {
                if (UsageContextSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = UsageContextSerializer.propertyToSerializerMap[propertyName](value, context);

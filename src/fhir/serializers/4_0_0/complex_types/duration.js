...
class DurationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DurationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DurationSerializer.propertyToSerializerMap) {
                if (DurationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DurationSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = DurationSerializer;

...
class DataRequirementDateFilterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DataRequirementDateFilterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DataRequirementDateFilterSerializer.propertyToSerializerMap) {
                if (DataRequirementDateFilterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DataRequirementDateFilterSerializer.propertyToSerializerMap[propertyName](value, context);

...
class CodeableConceptSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CodeableConceptSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CodeableConceptSerializer.propertyToSerializerMap) {
                if (CodeableConceptSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CodeableConceptSerializer.propertyToSerializerMap[propertyName](value, context);

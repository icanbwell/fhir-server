...
class NarrativeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => NarrativeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in NarrativeSerializer.propertyToSerializerMap) {
                if (NarrativeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = NarrativeSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = NarrativeSerializer;

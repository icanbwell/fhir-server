...
class HumanNameSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => HumanNameSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in HumanNameSerializer.propertyToSerializerMap) {
                if (HumanNameSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = HumanNameSerializer.propertyToSerializerMap[propertyName](value, context);

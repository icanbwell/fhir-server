...
class AddressSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AddressSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AddressSerializer.propertyToSerializerMap) {
                if (AddressSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AddressSerializer.propertyToSerializerMap[propertyName](value, context);

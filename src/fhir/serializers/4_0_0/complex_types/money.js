...
class MoneySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MoneySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MoneySerializer.propertyToSerializerMap) {
                if (MoneySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MoneySerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MoneySerializer;

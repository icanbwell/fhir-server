...
class RatioSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => RatioSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in RatioSerializer.propertyToSerializerMap) {
                if (RatioSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = RatioSerializer.propertyToSerializerMap[propertyName](value, context);

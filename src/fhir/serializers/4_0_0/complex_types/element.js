...
class ElementSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ElementSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ElementSerializer.propertyToSerializerMap) {
                if (ElementSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ElementSerializer.propertyToSerializerMap[propertyName](value, context);

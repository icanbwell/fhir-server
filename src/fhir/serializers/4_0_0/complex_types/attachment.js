...
class AttachmentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AttachmentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AttachmentSerializer.propertyToSerializerMap) {
                if (AttachmentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AttachmentSerializer.propertyToSerializerMap[propertyName](value, context);

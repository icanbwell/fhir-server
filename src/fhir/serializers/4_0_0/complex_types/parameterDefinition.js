...
class ParameterDefinitionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ParameterDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ParameterDefinitionSerializer.propertyToSerializerMap) {
                if (ParameterDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ParameterDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);

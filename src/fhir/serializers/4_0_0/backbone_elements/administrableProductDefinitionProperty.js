...
class AdministrableProductDefinitionPropertySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AdministrableProductDefinitionPropertySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AdministrableProductDefinitionPropertySerializer.propertyToSerializerMap) {
                if (AdministrableProductDefinitionPropertySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AdministrableProductDefinitionPropertySerializer.propertyToSerializerMap[propertyName](value, context);

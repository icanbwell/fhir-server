...
class MedicationRequestInitialFillSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationRequestInitialFillSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationRequestInitialFillSerializer.propertyToSerializerMap) {
                if (MedicationRequestInitialFillSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationRequestInitialFillSerializer.propertyToSerializerMap[propertyName](value, context);

...
class MolecularSequenceRocSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MolecularSequenceRocSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MolecularSequenceRocSerializer.propertyToSerializerMap) {
                if (MolecularSequenceRocSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MolecularSequenceRocSerializer.propertyToSerializerMap[propertyName](value, context);

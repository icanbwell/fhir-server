...
class EncounterDiagnosisSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EncounterDiagnosisSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EncounterDiagnosisSerializer.propertyToSerializerMap) {
                if (EncounterDiagnosisSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EncounterDiagnosisSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ExplanationOfBenefitSubDetailSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitSubDetailSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitSubDetailSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitSubDetailSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitSubDetailSerializer.propertyToSerializerMap[propertyName](value, context);

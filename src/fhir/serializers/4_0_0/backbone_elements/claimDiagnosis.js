...
class ClaimDiagnosisSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimDiagnosisSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimDiagnosisSerializer.propertyToSerializerMap) {
                if (ClaimDiagnosisSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimDiagnosisSerializer.propertyToSerializerMap[propertyName](value, context);

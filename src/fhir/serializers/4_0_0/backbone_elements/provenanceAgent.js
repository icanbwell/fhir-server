...
class ProvenanceAgentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ProvenanceAgentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ProvenanceAgentSerializer.propertyToSerializerMap) {
                if (ProvenanceAgentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ProvenanceAgentSerializer.propertyToSerializerMap[propertyName](value, context);

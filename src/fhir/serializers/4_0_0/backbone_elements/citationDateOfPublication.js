...
class CitationDateOfPublicationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationDateOfPublicationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationDateOfPublicationSerializer.propertyToSerializerMap) {
                if (CitationDateOfPublicationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationDateOfPublicationSerializer.propertyToSerializerMap[propertyName](value, context);

...
class MedicinalProductDefinitionCharacteristicSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicinalProductDefinitionCharacteristicSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicinalProductDefinitionCharacteristicSerializer.propertyToSerializerMap) {
                if (MedicinalProductDefinitionCharacteristicSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicinalProductDefinitionCharacteristicSerializer.propertyToSerializerMap[propertyName](value, context);

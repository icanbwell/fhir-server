...
class MeasureReportComponentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MeasureReportComponentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MeasureReportComponentSerializer.propertyToSerializerMap) {
                if (MeasureReportComponentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MeasureReportComponentSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ChargeItemDefinitionApplicabilitySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ChargeItemDefinitionApplicabilitySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ChargeItemDefinitionApplicabilitySerializer.propertyToSerializerMap) {
                if (ChargeItemDefinitionApplicabilitySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ChargeItemDefinitionApplicabilitySerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ChargeItemDefinitionApplicabilitySerializer;

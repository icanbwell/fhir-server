...
class SpecimenDefinitionContainerSerializer {
    static propertyToSerializerMap = {
        ...
        description: null,
        capacity: (value, context) => {
            initializeSerializers('Quantity');
            return FhirResourceSerializer.serialize(value, QuantitySerializer, context);
        },
        minimumVolumeQuantity: (value, context) => {
            initializeSerializers('Quantity');
            return FhirResourceSerializer.serialize(value, QuantitySerializer, context);
        },
        minimumVolumeString: null,
        additive: (value, context) => {
            initializeSerializers('SpecimenDefinitionAdditive');
            return FhirResourceSerializer.serializeArray(value, SpecimenDefinitionAdditiveSerializer, context);
        },
        preparation: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SpecimenDefinitionContainerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SpecimenDefinitionContainerSerializer.propertyToSerializerMap) {
                if (SpecimenDefinitionContainerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SpecimenDefinitionContainerSerializer.propertyToSerializerMap[propertyName](value, context);

...
let SpecimenDefinitionAdditive;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SpecimenDefinitionAdditive' && !SpecimenDefinitionAdditive) {
        SpecimenDefinitionAdditive = require('../backbone_elements/specimenDefinitionAdditive.js');
...
class SpecimenDefinitionContainerSerializer {
    static propertyToSerializerMap = {
        ...
        additive: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, SpecimenDefinitionAdditive);
        },
        preparation: null
    };

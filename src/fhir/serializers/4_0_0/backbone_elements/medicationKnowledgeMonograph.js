...
class MedicationKnowledgeMonographSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeMonographSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeMonographSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeMonographSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeMonographSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ConceptMapDependsOn' && !ConceptMapDependsOn) {
        ConceptMapDependsOn = require('../backbone_elements/conceptMapDependsOn.js');
...
class ConceptMapTargetSerializer {
    static propertyToSerializerMap = {
        ...
        dependsOn: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ConceptMapDependsOn);
        },
        product: (value) => {
            initializeSerializers('ConceptMapDependsOn');
            return FhirResourceSerializer.serializeArray(value, ConceptMapDependsOn);

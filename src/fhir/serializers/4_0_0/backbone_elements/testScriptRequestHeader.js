...
class TestScriptRequestHeaderSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestScriptRequestHeaderSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestScriptRequestHeaderSerializer.propertyToSerializerMap) {
                if (TestScriptRequestHeaderSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestScriptRequestHeaderSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = TestScriptRequestHeaderSerializer;

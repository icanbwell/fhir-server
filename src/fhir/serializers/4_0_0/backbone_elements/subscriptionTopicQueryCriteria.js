...
class SubscriptionTopicQueryCriteriaSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubscriptionTopicQueryCriteriaSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubscriptionTopicQueryCriteriaSerializer.propertyToSerializerMap) {
                if (SubscriptionTopicQueryCriteriaSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubscriptionTopicQueryCriteriaSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = SubscriptionTopicQueryCriteriaSerializer;

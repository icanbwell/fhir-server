...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'TestReportAction' && !TestReportAction) {
        TestReportAction = require('../backbone_elements/testReportAction.js');
...
class TestReportSetupSerializer {
    static propertyToSerializerMap = {
        ...
        action: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, TestReportAction);
        }
    };

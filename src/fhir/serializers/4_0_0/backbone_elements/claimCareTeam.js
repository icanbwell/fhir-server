...
class ClaimCareTeamSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimCareTeamSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimCareTeamSerializer.propertyToSerializerMap) {
                if (ClaimCareTeamSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimCareTeamSerializer.propertyToSerializerMap[propertyName](value, context);

...
class MedicationKnowledgeRelatedMedicationKnowledgeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeRelatedMedicationKnowledgeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeRelatedMedicationKnowledgeSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeRelatedMedicationKnowledgeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeRelatedMedicationKnowledgeSerializer.propertyToSerializerMap[propertyName](value, context);

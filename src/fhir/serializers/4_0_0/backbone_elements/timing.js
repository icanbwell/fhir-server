...
class TimingSerializer {
    static propertyToSerializerMap = {
        ...
        repeat: (value, context) => {
            ...
            return FhirResourceSerializer.serialize(value, TimingRepeatSerializer, context);
        },
        code: (value, context) => {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TimingSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TimingSerializer.propertyToSerializerMap) {
                if (TimingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TimingSerializer.propertyToSerializerMap[propertyName](value, context);

...
class CitationVersionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationVersionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationVersionSerializer.propertyToSerializerMap) {
                if (CitationVersionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationVersionSerializer.propertyToSerializerMap[propertyName](value, context);

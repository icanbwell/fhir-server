...
class DeviceRequestParameterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceRequestParameterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceRequestParameterSerializer.propertyToSerializerMap) {
                if (DeviceRequestParameterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceRequestParameterSerializer.propertyToSerializerMap[propertyName](value, context);

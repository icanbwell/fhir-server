...
let NutritionOrderAdministration;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'NutritionOrderAdministration' && !NutritionOrderAdministration) {
        NutritionOrderAdministration = require('../backbone_elements/nutritionOrderAdministration.js');
...
class NutritionOrderEnteralFormulaSerializer {
    static propertyToSerializerMap = {
        ...
        administration: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, NutritionOrderAdministration);
        },

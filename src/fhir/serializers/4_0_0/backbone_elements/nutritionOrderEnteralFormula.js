...
class NutritionOrderEnteralFormulaSerializer {
    static propertyToSerializerMap = {
        ...
        administration: (value, context) => {
            initializeSerializers('NutritionOrderAdministration');
            return FhirResourceSerializer.serializeArray(value, NutritionOrderAdministrationSerializer, context);
        },
        maxVolumeToDeliver: (value, context) => {
            initializeSerializers('Quantity');
            return FhirResourceSerializer.serialize(value, QuantitySerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => NutritionOrderEnteralFormulaSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in NutritionOrderEnteralFormulaSerializer.propertyToSerializerMap) {
                if (NutritionOrderEnteralFormulaSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = NutritionOrderEnteralFormulaSerializer.propertyToSerializerMap[propertyName](value, context);

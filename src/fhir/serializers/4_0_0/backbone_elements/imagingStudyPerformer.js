...
class ImagingStudyPerformerSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImagingStudyPerformerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImagingStudyPerformerSerializer.propertyToSerializerMap) {
                if (ImagingStudyPerformerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImagingStudyPerformerSerializer.propertyToSerializerMap[propertyName](value, context);

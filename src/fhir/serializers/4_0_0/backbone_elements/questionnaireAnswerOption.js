...
class QuestionnaireAnswerOptionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => QuestionnaireAnswerOptionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in QuestionnaireAnswerOptionSerializer.propertyToSerializerMap) {
                if (QuestionnaireAnswerOptionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = QuestionnaireAnswerOptionSerializer.propertyToSerializerMap[propertyName](value, context);

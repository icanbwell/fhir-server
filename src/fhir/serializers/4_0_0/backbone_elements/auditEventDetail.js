...
class AuditEventDetailSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AuditEventDetailSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AuditEventDetailSerializer.propertyToSerializerMap) {
                if (AuditEventDetailSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AuditEventDetailSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = AuditEventDetailSerializer;

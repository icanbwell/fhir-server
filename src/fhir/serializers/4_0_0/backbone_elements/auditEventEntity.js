...
class AuditEventEntitySerializer {
    static propertyToSerializerMap = {
        ...
        detail: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, AuditEventDetailSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AuditEventEntitySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AuditEventEntitySerializer.propertyToSerializerMap) {
                if (AuditEventEntitySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AuditEventEntitySerializer.propertyToSerializerMap[propertyName](value, context);

...
class PlanDefinitionDynamicValueSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PlanDefinitionDynamicValueSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PlanDefinitionDynamicValueSerializer.propertyToSerializerMap) {
                if (PlanDefinitionDynamicValueSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PlanDefinitionDynamicValueSerializer.propertyToSerializerMap[propertyName](value, context);

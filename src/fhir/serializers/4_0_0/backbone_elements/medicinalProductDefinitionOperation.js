...
class MedicinalProductDefinitionOperationSerializer {
    static propertyToSerializerMap = {
        ...
        type: (value) => CodeableReferenceSerializer.serialize(value),
        effectiveDate: (value) => PeriodSerializer.serialize(value),
        organization: (value) => ReferenceSerializer.serialize(value),
        confidentialityIndicator: (value) => CodeableConceptSerializer.serialize(value)
    };

...
class MolecularSequenceRepositorySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MolecularSequenceRepositorySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MolecularSequenceRepositorySerializer.propertyToSerializerMap) {
                if (MolecularSequenceRepositorySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MolecularSequenceRepositorySerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MolecularSequenceRepositorySerializer;

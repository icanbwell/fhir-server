...
const CarePlanDetailSerializer = require('../backbone_elements/carePlanDetail.js');
...
class CarePlanActivitySerializer {
    static propertyToSerializerMap = {
        ...
        outcomeCodeableConcept: (value) => CodeableConceptSerializer.serialize(value),
        outcomeReference: (value) => ReferenceSerializer.serialize(value),
        progress: (value) => AnnotationSerializer.serialize(value),
        reference: (value) => ReferenceSerializer.serialize(value),
        detail: (value) => CarePlanDetailSerializer.serialize(value)
    };
...
module.exports = CarePlanActivitySerializer;
...
let Annotation;
/** @type {import('../backbone_elements/carePlanDetail.js')} */
let CarePlanDetail;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CarePlanDetail' && !CarePlanDetail) {
        CarePlanDetail = require('../backbone_elements/carePlanDetail.js');
...
class CarePlanActivitySerializer {
    static propertyToSerializerMap = {
        ...
        detail: (value) => {
            ...
            return FhirResourceSerializer.serialize(value, CarePlanDetail);
        }
    };

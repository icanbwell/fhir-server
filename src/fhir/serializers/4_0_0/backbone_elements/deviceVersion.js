...
class DeviceVersionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceVersionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceVersionSerializer.propertyToSerializerMap) {
                if (DeviceVersionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceVersionSerializer.propertyToSerializerMap[propertyName](value, context);

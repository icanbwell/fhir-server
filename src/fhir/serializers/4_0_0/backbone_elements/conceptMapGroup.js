...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ConceptMapElement' && !ConceptMapElementSerializer) {
        ConceptMapElementSerializer = require('../backbone_elements/conceptMapElement.js');
        return ConceptMapElementSerializer;
    }
    if (serializerName === 'ConceptMapUnmapped' && !ConceptMapUnmappedSerializer) {
        ConceptMapUnmappedSerializer = require('../backbone_elements/conceptMapUnmapped.js');
        return ConceptMapUnmappedSerializer;
    }
}

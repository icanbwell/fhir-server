...
class AdverseEventCausalitySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AdverseEventCausalitySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AdverseEventCausalitySerializer.propertyToSerializerMap) {
                if (AdverseEventCausalitySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AdverseEventCausalitySerializer.propertyToSerializerMap[propertyName](value, context);

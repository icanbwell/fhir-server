...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'EvidenceVariableTimeFromStart' && !EvidenceVariableTimeFromStartSerializer) {
        EvidenceVariableTimeFromStartSerializer = require('../backbone_elements/evidenceVariableTimeFromStart.js');
        return EvidenceVariableTimeFromStartSerializer;
    }
}
...
class EvidenceVariableCharacteristicSerializer {
    static propertyToSerializerMap = {
        ...
        description: null,
        definitionReference: (value, context) => {
        ...
        exclude: null,
        timeFromStart: (value, context) => {
            initializeSerializers('EvidenceVariableTimeFromStart');
            return FhirResourceSerializer.serialize(value, EvidenceVariableTimeFromStartSerializer, context);
        },
        groupMeasure: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EvidenceVariableCharacteristicSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EvidenceVariableCharacteristicSerializer.propertyToSerializerMap) {
                if (EvidenceVariableCharacteristicSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EvidenceVariableCharacteristicSerializer.propertyToSerializerMap[propertyName](value, context);

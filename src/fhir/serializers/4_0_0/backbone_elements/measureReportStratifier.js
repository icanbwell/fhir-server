...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MeasureReportStratum' && !MeasureReportStratum) {
        MeasureReportStratum = require('../backbone_elements/measureReportStratum.js');
...
class MeasureReportStratifierSerializer {
    static propertyToSerializerMap = {
        ...
        stratum: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MeasureReportStratum);
        }
    };

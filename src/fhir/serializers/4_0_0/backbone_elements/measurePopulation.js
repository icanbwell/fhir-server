...
class MeasurePopulationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MeasurePopulationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MeasurePopulationSerializer.propertyToSerializerMap) {
                if (MeasurePopulationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MeasurePopulationSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ContractContextSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ContractContextSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ContractContextSerializer.propertyToSerializerMap) {
                if (ContractContextSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ContractContextSerializer.propertyToSerializerMap[propertyName](value, context);

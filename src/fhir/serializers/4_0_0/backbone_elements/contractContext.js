...
class ContractContextSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ContractContextSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ContractContextSerializer.propertyToSerializerMap) {
                if (ContractContextSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ContractContextSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = ContractContextSerializer;
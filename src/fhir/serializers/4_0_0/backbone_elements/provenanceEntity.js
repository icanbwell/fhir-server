...
class ProvenanceEntitySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ProvenanceEntitySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ProvenanceEntitySerializer.propertyToSerializerMap) {
                if (ProvenanceEntitySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ProvenanceEntitySerializer.propertyToSerializerMap[propertyName](value, context);

...
class BiologicallyDerivedProductManipulationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => BiologicallyDerivedProductManipulationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in BiologicallyDerivedProductManipulationSerializer.propertyToSerializerMap) {
                if (BiologicallyDerivedProductManipulationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = BiologicallyDerivedProductManipulationSerializer.propertyToSerializerMap[propertyName](value, context);

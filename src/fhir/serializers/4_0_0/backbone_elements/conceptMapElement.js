...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ConceptMapTarget' && !ConceptMapTarget) {
        ConceptMapTarget = require('../backbone_elements/conceptMapTarget.js');
...
class ConceptMapElementSerializer {
    static propertyToSerializerMap = {
        ...
        target: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ConceptMapTarget);
        }
    };

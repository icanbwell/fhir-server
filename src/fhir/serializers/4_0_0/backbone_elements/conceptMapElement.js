...
class ConceptMapElementSerializer {
    static propertyToSerializerMap = {
        ...
        target: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ConceptMapTargetSerializer);
        }
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ConceptMapElementSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ConceptMapElementSerializer.propertyToSerializerMap) {
                if (ConceptMapElementSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ConceptMapElementSerializer.propertyToSerializerMap[propertyName](value);

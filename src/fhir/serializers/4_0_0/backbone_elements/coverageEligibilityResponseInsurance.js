...
let CoverageEligibilityResponseItem;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CoverageEligibilityResponseItem' && !CoverageEligibilityResponseItem) {
        CoverageEligibilityResponseItem = require('../backbone_elements/coverageEligibilityResponseItem.js');
...
class CoverageEligibilityResponseInsuranceSerializer {
    static propertyToSerializerMap = {
        ...
        item: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CoverageEligibilityResponseItem);
        }
    };

...
class CoverageEligibilityResponseInsuranceSerializer {
    static propertyToSerializerMap = {
        ...
        item: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CoverageEligibilityResponseItemSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CoverageEligibilityResponseInsuranceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CoverageEligibilityResponseInsuranceSerializer.propertyToSerializerMap) {
                if (CoverageEligibilityResponseInsuranceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CoverageEligibilityResponseInsuranceSerializer.propertyToSerializerMap[propertyName](value, context);

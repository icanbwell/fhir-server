...
class ListEntrySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ListEntrySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ListEntrySerializer.propertyToSerializerMap) {
                if (ListEntrySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ListEntrySerializer.propertyToSerializerMap[propertyName](value, context);

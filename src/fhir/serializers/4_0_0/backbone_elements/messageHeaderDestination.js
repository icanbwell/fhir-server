...
class MessageHeaderDestinationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MessageHeaderDestinationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MessageHeaderDestinationSerializer.propertyToSerializerMap) {
                if (MessageHeaderDestinationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MessageHeaderDestinationSerializer.propertyToSerializerMap[propertyName](value, context);

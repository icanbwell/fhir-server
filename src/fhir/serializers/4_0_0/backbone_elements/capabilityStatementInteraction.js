...
class CapabilityStatementInteractionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CapabilityStatementInteractionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CapabilityStatementInteractionSerializer.propertyToSerializerMap) {
                if (CapabilityStatementInteractionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CapabilityStatementInteractionSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CapabilityStatementInteractionSerializer;

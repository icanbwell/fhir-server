...
class MessageDefinitionAllowedResponseSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MessageDefinitionAllowedResponseSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MessageDefinitionAllowedResponseSerializer.propertyToSerializerMap) {
                if (MessageDefinitionAllowedResponseSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MessageDefinitionAllowedResponseSerializer.propertyToSerializerMap[propertyName](value, context);

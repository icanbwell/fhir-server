...
class CoverageEligibilityRequestDiagnosisSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CoverageEligibilityRequestDiagnosisSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CoverageEligibilityRequestDiagnosisSerializer.propertyToSerializerMap) {
                if (CoverageEligibilityRequestDiagnosisSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CoverageEligibilityRequestDiagnosisSerializer.propertyToSerializerMap[propertyName](value, context);

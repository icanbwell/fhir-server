...
class CapabilityStatementSoftwareSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CapabilityStatementSoftwareSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CapabilityStatementSoftwareSerializer.propertyToSerializerMap) {
                if (CapabilityStatementSoftwareSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CapabilityStatementSoftwareSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CapabilityStatementSoftwareSerializer;

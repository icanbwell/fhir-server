...
class EncounterLocationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EncounterLocationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EncounterLocationSerializer.propertyToSerializerMap) {
                if (EncounterLocationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EncounterLocationSerializer.propertyToSerializerMap[propertyName](value, context);

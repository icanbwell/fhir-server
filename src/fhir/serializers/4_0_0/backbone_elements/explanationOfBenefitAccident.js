...
class ExplanationOfBenefitAccidentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitAccidentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitAccidentSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitAccidentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitAccidentSerializer.propertyToSerializerMap[propertyName](value, context);

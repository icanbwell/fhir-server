...
let ElementDefinitionDiscriminator;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ElementDefinitionDiscriminator' && !ElementDefinitionDiscriminator) {
        ElementDefinitionDiscriminator = require('../backbone_elements/elementDefinitionDiscriminator.js');
...
class ElementDefinitionSlicingSerializer {
    static propertyToSerializerMap = {
        ...
        discriminator: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ElementDefinitionDiscriminator);
        },
        description: null,
        ordered: null,
        rules: null

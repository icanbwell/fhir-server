...
class CoverageExceptionSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CoverageExceptionSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CoverageExceptionSerializer.propertyToSerializerMap) {
                if (CoverageExceptionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CoverageExceptionSerializer.propertyToSerializerMap[propertyName](value);

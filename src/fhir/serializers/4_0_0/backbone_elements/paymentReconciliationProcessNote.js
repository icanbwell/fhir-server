...
class PaymentReconciliationProcessNoteSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PaymentReconciliationProcessNoteSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PaymentReconciliationProcessNoteSerializer.propertyToSerializerMap) {
                if (PaymentReconciliationProcessNoteSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PaymentReconciliationProcessNoteSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = PaymentReconciliationProcessNoteSerializer;

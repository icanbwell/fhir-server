...
class MedicinalProductDefinitionContactSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicinalProductDefinitionContactSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicinalProductDefinitionContactSerializer.propertyToSerializerMap) {
                if (MedicinalProductDefinitionContactSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicinalProductDefinitionContactSerializer.propertyToSerializerMap[propertyName](value, context);

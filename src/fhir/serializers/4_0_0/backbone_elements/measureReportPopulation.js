...
class MeasureReportPopulationSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MeasureReportPopulationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MeasureReportPopulationSerializer.propertyToSerializerMap) {
                if (MeasureReportPopulationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MeasureReportPopulationSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = MeasureReportPopulationSerializer;
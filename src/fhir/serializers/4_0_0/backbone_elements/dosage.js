...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'DosageDoseAndRate' && !DosageDoseAndRateSerializer) {
        DosageDoseAndRateSerializer = require('../backbone_elements/dosageDoseAndRate.js');
        return DosageDoseAndRateSerializer;
    }

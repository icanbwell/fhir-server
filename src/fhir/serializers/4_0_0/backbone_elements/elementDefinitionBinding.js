...
class ElementDefinitionBindingSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ElementDefinitionBindingSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ElementDefinitionBindingSerializer.propertyToSerializerMap) {
                if (ElementDefinitionBindingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ElementDefinitionBindingSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ElementDefinitionBindingSerializer;

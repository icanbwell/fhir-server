...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'InsurancePlanGeneralCost' && !InsurancePlanGeneralCost) {
        InsurancePlanGeneralCost = require('../backbone_elements/insurancePlanGeneralCost.js');
        return InsurancePlanGeneralCost;
    }
    if (serializerName === 'InsurancePlanSpecificCost' && !InsurancePlanSpecificCost) {
        InsurancePlanSpecificCost = require('../backbone_elements/insurancePlanSpecificCost.js');
...
class InsurancePlanPlanSerializer {
    static propertyToSerializerMap = {
        ...
        generalCost: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanGeneralCost);
        },
        specificCost: (value) => {
            initializeSerializers('InsurancePlanSpecificCost');
            return FhirResourceSerializer.serializeArray(value, InsurancePlanSpecificCost);
        }
    };

...
class TestScriptAssertSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestScriptAssertSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestScriptAssertSerializer.propertyToSerializerMap) {
                if (TestScriptAssertSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestScriptAssertSerializer.propertyToSerializerMap[propertyName](value, context);

...
class TestScriptDestinationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestScriptDestinationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestScriptDestinationSerializer.propertyToSerializerMap) {
                if (TestScriptDestinationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestScriptDestinationSerializer.propertyToSerializerMap[propertyName](value, context);

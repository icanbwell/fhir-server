...
class MessageDefinitionFocusSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MessageDefinitionFocusSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MessageDefinitionFocusSerializer.propertyToSerializerMap) {
                if (MessageDefinitionFocusSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MessageDefinitionFocusSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MessageDefinitionFocusSerializer;

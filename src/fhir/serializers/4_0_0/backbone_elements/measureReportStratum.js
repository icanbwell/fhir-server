...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MeasureReportComponent' && !MeasureReportComponent) {
        MeasureReportComponent = require('../backbone_elements/measureReportComponent.js');
        return MeasureReportComponent;
    }
    if (serializerName === 'MeasureReportPopulation1' && !MeasureReportPopulation1) {
        MeasureReportPopulation1 = require('../backbone_elements/measureReportPopulation1.js');
...
class MeasureReportStratumSerializer {
    static propertyToSerializerMap = {
        ...
        component: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MeasureReportComponent);
        },
        population: (value) => {
            initializeSerializers('MeasureReportPopulation1');
            return FhirResourceSerializer.serializeArray(value, MeasureReportPopulation1);
        },
        measureScore: (value) => {

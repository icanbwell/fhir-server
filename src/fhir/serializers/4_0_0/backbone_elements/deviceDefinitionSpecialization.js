...
class DeviceDefinitionSpecializationSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceDefinitionSpecializationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceDefinitionSpecializationSerializer.propertyToSerializerMap) {
                if (DeviceDefinitionSpecializationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceDefinitionSpecializationSerializer.propertyToSerializerMap[propertyName](value);

...
class DeviceDefinitionSpecializationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceDefinitionSpecializationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceDefinitionSpecializationSerializer.propertyToSerializerMap) {
                if (DeviceDefinitionSpecializationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceDefinitionSpecializationSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = DeviceDefinitionSpecializationSerializer;

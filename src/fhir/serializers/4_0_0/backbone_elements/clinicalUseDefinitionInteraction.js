...
class ClinicalUseDefinitionInteractionSerializer {
    static propertyToSerializerMap = {
        ...
        interactant: (value, context) => {
            initializeSerializers('ClinicalUseDefinitionInteractant');
            return FhirResourceSerializer.serializeArray(value, ClinicalUseDefinitionInteractantSerializer, context);
        },
        type: (value, context) => {
        ...
        incidence: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        },
        management: (value, context) => {
            initializeSerializers('CodeableConcept');
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClinicalUseDefinitionInteractionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClinicalUseDefinitionInteractionSerializer.propertyToSerializerMap) {
                if (ClinicalUseDefinitionInteractionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClinicalUseDefinitionInteractionSerializer.propertyToSerializerMap[propertyName](value, context);

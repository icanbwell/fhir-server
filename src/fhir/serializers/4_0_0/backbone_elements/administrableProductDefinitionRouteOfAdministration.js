...
let AdministrableProductDefinitionTargetSpecies;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'AdministrableProductDefinitionTargetSpecies' && !AdministrableProductDefinitionTargetSpecies) {
        AdministrableProductDefinitionTargetSpecies = require('../backbone_elements/administrableProductDefinitionTargetSpecies.js');
...
class AdministrableProductDefinitionRouteOfAdministrationSerializer {
    static propertyToSerializerMap = {
        ...
        targetSpecies: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, AdministrableProductDefinitionTargetSpecies);
        }
    };

...
class GroupCharacteristicSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GroupCharacteristicSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GroupCharacteristicSerializer.propertyToSerializerMap) {
                if (GroupCharacteristicSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GroupCharacteristicSerializer.propertyToSerializerMap[propertyName](value, context);

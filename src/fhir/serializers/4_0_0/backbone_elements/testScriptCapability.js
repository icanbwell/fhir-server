...
class TestScriptCapabilitySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestScriptCapabilitySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestScriptCapabilitySerializer.propertyToSerializerMap) {
                if (TestScriptCapabilitySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestScriptCapabilitySerializer.propertyToSerializerMap[propertyName](value, context);

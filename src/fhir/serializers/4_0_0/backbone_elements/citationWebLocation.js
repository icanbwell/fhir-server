...
class CitationWebLocationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationWebLocationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationWebLocationSerializer.propertyToSerializerMap) {
                if (CitationWebLocationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationWebLocationSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CitationWebLocationSerializer;

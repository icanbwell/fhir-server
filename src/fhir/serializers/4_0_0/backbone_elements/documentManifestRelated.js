...
class DocumentManifestRelatedSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DocumentManifestRelatedSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DocumentManifestRelatedSerializer.propertyToSerializerMap) {
                if (DocumentManifestRelatedSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DocumentManifestRelatedSerializer.propertyToSerializerMap[propertyName](value, context);

...
class LinkageItemSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => LinkageItemSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in LinkageItemSerializer.propertyToSerializerMap) {
                if (LinkageItemSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = LinkageItemSerializer.propertyToSerializerMap[propertyName](value, context);

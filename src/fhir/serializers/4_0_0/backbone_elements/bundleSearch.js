...
class BundleSearchSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => BundleSearchSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in BundleSearchSerializer.propertyToSerializerMap) {
                if (BundleSearchSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = BundleSearchSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = BundleSearchSerializer;

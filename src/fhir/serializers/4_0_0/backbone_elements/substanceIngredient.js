...
class SubstanceIngredientSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubstanceIngredientSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubstanceIngredientSerializer.propertyToSerializerMap) {
                if (SubstanceIngredientSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubstanceIngredientSerializer.propertyToSerializerMap[propertyName](value, context);

...
class StructureDefinitionMappingSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => StructureDefinitionMappingSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in StructureDefinitionMappingSerializer.propertyToSerializerMap) {
                if (StructureDefinitionMappingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = StructureDefinitionMappingSerializer.propertyToSerializerMap[propertyName](value);

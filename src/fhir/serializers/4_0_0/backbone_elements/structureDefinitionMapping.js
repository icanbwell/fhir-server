...
class StructureDefinitionMappingSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => StructureDefinitionMappingSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in StructureDefinitionMappingSerializer.propertyToSerializerMap) {
                if (StructureDefinitionMappingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = StructureDefinitionMappingSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = StructureDefinitionMappingSerializer;

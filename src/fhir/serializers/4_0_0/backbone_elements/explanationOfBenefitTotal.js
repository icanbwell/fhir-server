...
class ExplanationOfBenefitTotalSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitTotalSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitTotalSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitTotalSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitTotalSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ContractPartySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ContractPartySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ContractPartySerializer.propertyToSerializerMap) {
                if (ContractPartySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ContractPartySerializer.propertyToSerializerMap[propertyName](value, context);

...
class NutritionOrderNutrientSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => NutritionOrderNutrientSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in NutritionOrderNutrientSerializer.propertyToSerializerMap) {
                if (NutritionOrderNutrientSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = NutritionOrderNutrientSerializer.propertyToSerializerMap[propertyName](value, context);

...
class GraphDefinitionCompartmentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GraphDefinitionCompartmentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GraphDefinitionCompartmentSerializer.propertyToSerializerMap) {
                if (GraphDefinitionCompartmentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GraphDefinitionCompartmentSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = GraphDefinitionCompartmentSerializer;

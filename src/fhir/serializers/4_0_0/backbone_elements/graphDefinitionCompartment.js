...
class GraphDefinitionCompartmentSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GraphDefinitionCompartmentSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GraphDefinitionCompartmentSerializer.propertyToSerializerMap) {
                if (GraphDefinitionCompartmentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GraphDefinitionCompartmentSerializer.propertyToSerializerMap[propertyName](value);

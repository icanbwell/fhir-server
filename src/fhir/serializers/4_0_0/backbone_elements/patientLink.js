...
class PatientLinkSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PatientLinkSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PatientLinkSerializer.propertyToSerializerMap) {
                if (PatientLinkSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PatientLinkSerializer.propertyToSerializerMap[propertyName](value, context);

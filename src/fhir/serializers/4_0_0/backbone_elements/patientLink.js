...
class PatientLinkSerializer {
    static propertyToSerializerMap = {
        ...
        other: (value) => ReferenceSerializer.serialize(value),
        type: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PatientLinkSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PatientLinkSerializer.propertyToSerializerMap) {
                if (PatientLinkSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PatientLinkSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = PatientLinkSerializer;
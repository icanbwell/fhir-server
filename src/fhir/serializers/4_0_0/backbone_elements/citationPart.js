...
class CitationPartSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationPartSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationPartSerializer.propertyToSerializerMap) {
                if (CitationPartSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationPartSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = CitationPartSerializer;
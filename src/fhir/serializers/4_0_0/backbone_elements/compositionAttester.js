...
class CompositionAttesterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CompositionAttesterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CompositionAttesterSerializer.propertyToSerializerMap) {
                if (CompositionAttesterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CompositionAttesterSerializer.propertyToSerializerMap[propertyName](value, context);

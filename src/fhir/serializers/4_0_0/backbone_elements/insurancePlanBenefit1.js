...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'InsurancePlanCost' && !InsurancePlanCost) {
        InsurancePlanCost = require('../backbone_elements/insurancePlanCost.js');
...
class InsurancePlanBenefit1Serializer {
    static propertyToSerializerMap = {
        ...
        cost: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanCost);
        }
    };

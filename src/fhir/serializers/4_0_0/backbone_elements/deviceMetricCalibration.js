...
class DeviceMetricCalibrationSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceMetricCalibrationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceMetricCalibrationSerializer.propertyToSerializerMap) {
                if (DeviceMetricCalibrationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceMetricCalibrationSerializer.propertyToSerializerMap[propertyName](value);

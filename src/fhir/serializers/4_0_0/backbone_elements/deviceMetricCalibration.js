...
class DeviceMetricCalibrationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceMetricCalibrationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceMetricCalibrationSerializer.propertyToSerializerMap) {
                if (DeviceMetricCalibrationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceMetricCalibrationSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = DeviceMetricCalibrationSerializer;

...
class GroupMemberSerializer {
    static propertyToSerializerMap = {
        ...
        entity: (value) => ReferenceSerializer.serialize(value),
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GroupMemberSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GroupMemberSerializer.propertyToSerializerMap) {
                if (GroupMemberSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GroupMemberSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = GroupMemberSerializer;
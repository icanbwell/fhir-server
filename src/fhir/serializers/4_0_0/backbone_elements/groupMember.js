...
class GroupMemberSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GroupMemberSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GroupMemberSerializer.propertyToSerializerMap) {
                if (GroupMemberSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GroupMemberSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ConditionEvidenceSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ConditionEvidenceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ConditionEvidenceSerializer.propertyToSerializerMap) {
                if (ConditionEvidenceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ConditionEvidenceSerializer.propertyToSerializerMap[propertyName](value, context);

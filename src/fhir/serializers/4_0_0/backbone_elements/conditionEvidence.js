...
class ConditionEvidenceSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ConditionEvidenceSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ConditionEvidenceSerializer.propertyToSerializerMap) {
                if (ConditionEvidenceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ConditionEvidenceSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = ConditionEvidenceSerializer;
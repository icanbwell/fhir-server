...
class SupplyDeliverySuppliedItemSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SupplyDeliverySuppliedItemSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SupplyDeliverySuppliedItemSerializer.propertyToSerializerMap) {
                if (SupplyDeliverySuppliedItemSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SupplyDeliverySuppliedItemSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ExplanationOfBenefitSupportingInfoSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitSupportingInfoSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitSupportingInfoSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitSupportingInfoSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitSupportingInfoSerializer.propertyToSerializerMap[propertyName](value, context);

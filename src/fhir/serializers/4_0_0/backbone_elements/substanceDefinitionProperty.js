...
class SubstanceDefinitionPropertySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubstanceDefinitionPropertySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubstanceDefinitionPropertySerializer.propertyToSerializerMap) {
                if (SubstanceDefinitionPropertySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubstanceDefinitionPropertySerializer.propertyToSerializerMap[propertyName](value, context);

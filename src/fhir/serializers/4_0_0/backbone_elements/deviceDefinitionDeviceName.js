...
class DeviceDefinitionDeviceNameSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceDefinitionDeviceNameSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceDefinitionDeviceNameSerializer.propertyToSerializerMap) {
                if (DeviceDefinitionDeviceNameSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceDefinitionDeviceNameSerializer.propertyToSerializerMap[propertyName](value, context);

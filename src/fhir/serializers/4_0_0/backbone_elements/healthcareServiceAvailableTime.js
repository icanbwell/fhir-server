...
class HealthcareServiceAvailableTimeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => HealthcareServiceAvailableTimeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in HealthcareServiceAvailableTimeSerializer.propertyToSerializerMap) {
                if (HealthcareServiceAvailableTimeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = HealthcareServiceAvailableTimeSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = HealthcareServiceAvailableTimeSerializer;

...
class HealthcareServiceAvailableTimeSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => HealthcareServiceAvailableTimeSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in HealthcareServiceAvailableTimeSerializer.propertyToSerializerMap) {
                if (HealthcareServiceAvailableTimeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = HealthcareServiceAvailableTimeSerializer.propertyToSerializerMap[propertyName](value);

...
class PractitionerRoleAvailableTimeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PractitionerRoleAvailableTimeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PractitionerRoleAvailableTimeSerializer.propertyToSerializerMap) {
                if (PractitionerRoleAvailableTimeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PractitionerRoleAvailableTimeSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = PractitionerRoleAvailableTimeSerializer;

...
class CitationStatusDate1Serializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationStatusDate1Serializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationStatusDate1Serializer.propertyToSerializerMap) {
                if (CitationStatusDate1Serializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationStatusDate1Serializer.propertyToSerializerMap[propertyName](value, context);

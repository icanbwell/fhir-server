...
class HealthcareServiceNotAvailableSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => HealthcareServiceNotAvailableSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in HealthcareServiceNotAvailableSerializer.propertyToSerializerMap) {
                if (HealthcareServiceNotAvailableSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = HealthcareServiceNotAvailableSerializer.propertyToSerializerMap[propertyName](value, context);

...
class SubscriptionTopicNotificationShapeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubscriptionTopicNotificationShapeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubscriptionTopicNotificationShapeSerializer.propertyToSerializerMap) {
                if (SubscriptionTopicNotificationShapeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubscriptionTopicNotificationShapeSerializer.propertyToSerializerMap[propertyName](value, context);

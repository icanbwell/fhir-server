...
class ClinicalImpressionFindingSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClinicalImpressionFindingSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClinicalImpressionFindingSerializer.propertyToSerializerMap) {
                if (ClinicalImpressionFindingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClinicalImpressionFindingSerializer.propertyToSerializerMap[propertyName](value, context);

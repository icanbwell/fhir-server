...
class QuestionnaireEnableWhenSerializer {
    static propertyToSerializerMap = {
        ...
        answerTime: null,
        answerString: null,
        answerCoding: (value) => CodingSerializer.serialize(value),
        answerQuantity: (value) => QuantitySerializer.serialize(value),
        answerReference: (value) => ReferenceSerializer.serialize(value)
    };

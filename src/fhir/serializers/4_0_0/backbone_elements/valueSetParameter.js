...
class ValueSetParameterSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ValueSetParameterSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ValueSetParameterSerializer.propertyToSerializerMap) {
                if (ValueSetParameterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ValueSetParameterSerializer.propertyToSerializerMap[propertyName](value);

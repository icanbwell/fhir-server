...
class ImplementationGuideParameterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImplementationGuideParameterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImplementationGuideParameterSerializer.propertyToSerializerMap) {
                if (ImplementationGuideParameterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImplementationGuideParameterSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ImplementationGuideParameterSerializer;

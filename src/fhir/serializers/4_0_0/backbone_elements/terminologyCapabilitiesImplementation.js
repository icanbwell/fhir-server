...
class TerminologyCapabilitiesImplementationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TerminologyCapabilitiesImplementationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TerminologyCapabilitiesImplementationSerializer.propertyToSerializerMap) {
                if (TerminologyCapabilitiesImplementationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TerminologyCapabilitiesImplementationSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = TerminologyCapabilitiesImplementationSerializer;

...
class TerminologyCapabilitiesImplementationSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TerminologyCapabilitiesImplementationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TerminologyCapabilitiesImplementationSerializer.propertyToSerializerMap) {
                if (TerminologyCapabilitiesImplementationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TerminologyCapabilitiesImplementationSerializer.propertyToSerializerMap[propertyName](value);

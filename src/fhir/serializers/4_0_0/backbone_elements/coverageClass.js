...
class CoverageClassSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CoverageClassSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CoverageClassSerializer.propertyToSerializerMap) {
                if (CoverageClassSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CoverageClassSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CoverageClassSerializer;

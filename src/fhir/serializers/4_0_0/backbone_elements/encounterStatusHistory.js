...
class EncounterStatusHistorySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EncounterStatusHistorySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EncounterStatusHistorySerializer.propertyToSerializerMap) {
                if (EncounterStatusHistorySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EncounterStatusHistorySerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = EncounterStatusHistorySerializer;

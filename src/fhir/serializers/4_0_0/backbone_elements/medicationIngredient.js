...
class MedicationIngredientSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationIngredientSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationIngredientSerializer.propertyToSerializerMap) {
                if (MedicationIngredientSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationIngredientSerializer.propertyToSerializerMap[propertyName](value, context);

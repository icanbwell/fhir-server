...
class ExplanationOfBenefitPayeeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitPayeeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitPayeeSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitPayeeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitPayeeSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'AuditEventNetwork' && !AuditEventNetwork) {
        AuditEventNetwork = require('../backbone_elements/auditEventNetwork.js');
...
class AuditEventAgentSerializer {
    static propertyToSerializerMap = {
        ...
        network: (value) => {
            ...
            return FhirResourceSerializer.serialize(value, AuditEventNetwork);
        },
        purposeOfUse: (value) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConcept);

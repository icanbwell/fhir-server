...
class EvidenceSampleSizeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EvidenceSampleSizeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EvidenceSampleSizeSerializer.propertyToSerializerMap) {
                if (EvidenceSampleSizeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EvidenceSampleSizeSerializer.propertyToSerializerMap[propertyName](value, context);

...
class SubstanceDefinitionRepresentationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubstanceDefinitionRepresentationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubstanceDefinitionRepresentationSerializer.propertyToSerializerMap) {
                if (SubstanceDefinitionRepresentationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubstanceDefinitionRepresentationSerializer.propertyToSerializerMap[propertyName](value, context);

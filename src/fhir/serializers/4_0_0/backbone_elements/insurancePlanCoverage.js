...
/** @type {import('../backbone_elements/insurancePlanBenefit.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'InsurancePlanBenefit' && !InsurancePlanBenefitSerializer) {
        InsurancePlanBenefitSerializer = require('../backbone_elements/insurancePlanBenefit.js');
        return InsurancePlanBenefitSerializer;
    }
}
...
class InsurancePlanCoverageSerializer {
    static propertyToSerializerMap = {
        ...
        benefit: (value, context) => {
            initializeSerializers('InsurancePlanBenefit');
            return FhirResourceSerializer.serializeArray(value, InsurancePlanBenefitSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => InsurancePlanCoverageSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in InsurancePlanCoverageSerializer.propertyToSerializerMap) {
                if (InsurancePlanCoverageSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = InsurancePlanCoverageSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = InsurancePlanCoverageSerializer;

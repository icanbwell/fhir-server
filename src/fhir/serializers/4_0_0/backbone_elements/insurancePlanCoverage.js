...
class InsurancePlanCoverageSerializer {
    static propertyToSerializerMap = {
        ...
        benefit: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanBenefitSerializer);
        }
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => InsurancePlanCoverageSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in InsurancePlanCoverageSerializer.propertyToSerializerMap) {
                if (InsurancePlanCoverageSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = InsurancePlanCoverageSerializer.propertyToSerializerMap[propertyName](value);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'InsurancePlanBenefit' && !InsurancePlanBenefit) {
        InsurancePlanBenefit = require('../backbone_elements/insurancePlanBenefit.js');
...
class InsurancePlanCoverageSerializer {
    static propertyToSerializerMap = {
        ...
        benefit: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanBenefit);
        }
    };

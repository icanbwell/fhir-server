...
class ProcedurePerformerSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ProcedurePerformerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ProcedurePerformerSerializer.propertyToSerializerMap) {
                if (ProcedurePerformerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ProcedurePerformerSerializer.propertyToSerializerMap[propertyName](value, context);

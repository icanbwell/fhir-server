...
class ImplementationGuideGroupingSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImplementationGuideGroupingSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImplementationGuideGroupingSerializer.propertyToSerializerMap) {
                if (ImplementationGuideGroupingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImplementationGuideGroupingSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ImplementationGuideGroupingSerializer;

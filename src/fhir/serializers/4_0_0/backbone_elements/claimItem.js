...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ClaimDetail' && !ClaimDetail) {
        ClaimDetail = require('../backbone_elements/claimDetail.js');
        return ClaimDetail;
    }
}
...
class ClaimItemSerializer {
    static propertyToSerializerMap = {
        ...
        detail: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ClaimDetail);
        }
    };

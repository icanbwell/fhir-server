...
class PackagedProductDefinitionPropertySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PackagedProductDefinitionPropertySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PackagedProductDefinitionPropertySerializer.propertyToSerializerMap) {
                if (PackagedProductDefinitionPropertySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PackagedProductDefinitionPropertySerializer.propertyToSerializerMap[propertyName](value, context);

...
class BundleRequestSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => BundleRequestSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in BundleRequestSerializer.propertyToSerializerMap) {
                if (BundleRequestSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = BundleRequestSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = BundleRequestSerializer;

...
class ConsentDataSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ConsentDataSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ConsentDataSerializer.propertyToSerializerMap) {
                if (ConsentDataSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ConsentDataSerializer.propertyToSerializerMap[propertyName](value, context);

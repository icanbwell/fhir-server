...
class ExampleScenarioActorSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExampleScenarioActorSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExampleScenarioActorSerializer.propertyToSerializerMap) {
                if (ExampleScenarioActorSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExampleScenarioActorSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ExampleScenarioActorSerializer;

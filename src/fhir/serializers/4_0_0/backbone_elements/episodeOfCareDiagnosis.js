...
class EpisodeOfCareDiagnosisSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EpisodeOfCareDiagnosisSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EpisodeOfCareDiagnosisSerializer.propertyToSerializerMap) {
                if (EpisodeOfCareDiagnosisSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EpisodeOfCareDiagnosisSerializer.propertyToSerializerMap[propertyName](value, context);

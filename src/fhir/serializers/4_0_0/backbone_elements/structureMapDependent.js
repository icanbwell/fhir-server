...
class StructureMapDependentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => StructureMapDependentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in StructureMapDependentSerializer.propertyToSerializerMap) {
                if (StructureMapDependentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = StructureMapDependentSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = StructureMapDependentSerializer;

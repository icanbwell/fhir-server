...
class ClaimAccidentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimAccidentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimAccidentSerializer.propertyToSerializerMap) {
                if (ClaimAccidentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimAccidentSerializer.propertyToSerializerMap[propertyName](value, context);

...
class NutritionProductIngredientSerializer {
    static propertyToSerializerMap = {
        ...
        amount: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, RatioSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => NutritionProductIngredientSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in NutritionProductIngredientSerializer.propertyToSerializerMap) {
                if (NutritionProductIngredientSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = NutritionProductIngredientSerializer.propertyToSerializerMap[propertyName](value, context);

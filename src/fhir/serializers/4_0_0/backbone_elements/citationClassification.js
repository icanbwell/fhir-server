...
class CitationClassificationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationClassificationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationClassificationSerializer.propertyToSerializerMap) {
                if (CitationClassificationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationClassificationSerializer.propertyToSerializerMap[propertyName](value, context);

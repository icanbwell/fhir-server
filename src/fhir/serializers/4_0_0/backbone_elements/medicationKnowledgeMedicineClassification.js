...
class MedicationKnowledgeMedicineClassificationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeMedicineClassificationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeMedicineClassificationSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeMedicineClassificationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeMedicineClassificationSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MedicationKnowledgeMedicineClassificationSerializer;

...
class MedicationKnowledgeMedicineClassificationSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeMedicineClassificationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeMedicineClassificationSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeMedicineClassificationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeMedicineClassificationSerializer.propertyToSerializerMap[propertyName](value);

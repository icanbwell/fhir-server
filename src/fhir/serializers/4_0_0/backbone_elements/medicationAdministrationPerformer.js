...
class MedicationAdministrationPerformerSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationAdministrationPerformerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationAdministrationPerformerSerializer.propertyToSerializerMap) {
                if (MedicationAdministrationPerformerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationAdministrationPerformerSerializer.propertyToSerializerMap[propertyName](value, context);

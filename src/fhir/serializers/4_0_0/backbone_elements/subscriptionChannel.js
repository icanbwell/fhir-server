...
class SubscriptionChannelSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubscriptionChannelSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubscriptionChannelSerializer.propertyToSerializerMap) {
                if (SubscriptionChannelSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubscriptionChannelSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = SubscriptionChannelSerializer;

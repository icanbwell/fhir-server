...
class ImplementationGuideDependsOnSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImplementationGuideDependsOnSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImplementationGuideDependsOnSerializer.propertyToSerializerMap) {
                if (ImplementationGuideDependsOnSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImplementationGuideDependsOnSerializer.propertyToSerializerMap[propertyName](value);

...
class ImplementationGuideDependsOnSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImplementationGuideDependsOnSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImplementationGuideDependsOnSerializer.propertyToSerializerMap) {
                if (ImplementationGuideDependsOnSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImplementationGuideDependsOnSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ImplementationGuideDependsOnSerializer;

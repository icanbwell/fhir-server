...
class ResearchStudyObjectiveSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ResearchStudyObjectiveSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ResearchStudyObjectiveSerializer.propertyToSerializerMap) {
                if (ResearchStudyObjectiveSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ResearchStudyObjectiveSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ResearchStudyObjectiveSerializer;

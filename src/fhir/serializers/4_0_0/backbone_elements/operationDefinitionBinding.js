...
class OperationDefinitionBindingSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => OperationDefinitionBindingSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in OperationDefinitionBindingSerializer.propertyToSerializerMap) {
                if (OperationDefinitionBindingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = OperationDefinitionBindingSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = OperationDefinitionBindingSerializer;

...
class OperationDefinitionBindingSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => OperationDefinitionBindingSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in OperationDefinitionBindingSerializer.propertyToSerializerMap) {
                if (OperationDefinitionBindingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = OperationDefinitionBindingSerializer.propertyToSerializerMap[propertyName](value);

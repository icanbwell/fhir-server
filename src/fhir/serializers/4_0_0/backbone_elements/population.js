...
class PopulationSerializer {
    static propertyToSerializerMap = {
        ...
        physiologicalCondition: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PopulationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PopulationSerializer.propertyToSerializerMap) {
                if (PopulationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PopulationSerializer.propertyToSerializerMap[propertyName](value, context);

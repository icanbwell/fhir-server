...
class CapabilityStatementSupportedMessageSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CapabilityStatementSupportedMessageSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CapabilityStatementSupportedMessageSerializer.propertyToSerializerMap) {
                if (CapabilityStatementSupportedMessageSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CapabilityStatementSupportedMessageSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CapabilityStatementSupportedMessageSerializer;

...
class TimingRepeatSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TimingRepeatSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TimingRepeatSerializer.propertyToSerializerMap) {
                if (TimingRepeatSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TimingRepeatSerializer.propertyToSerializerMap[propertyName](value, context);

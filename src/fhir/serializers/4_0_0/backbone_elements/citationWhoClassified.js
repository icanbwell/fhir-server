...
class CitationWhoClassifiedSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationWhoClassifiedSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationWhoClassifiedSerializer.propertyToSerializerMap) {
                if (CitationWhoClassifiedSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationWhoClassifiedSerializer.propertyToSerializerMap[propertyName](value, context);

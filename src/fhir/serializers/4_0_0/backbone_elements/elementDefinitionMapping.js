...
class ElementDefinitionMappingSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ElementDefinitionMappingSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ElementDefinitionMappingSerializer.propertyToSerializerMap) {
                if (ElementDefinitionMappingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ElementDefinitionMappingSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ElementDefinitionMappingSerializer;

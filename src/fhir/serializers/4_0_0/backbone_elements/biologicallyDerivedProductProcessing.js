...
class BiologicallyDerivedProductProcessingSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => BiologicallyDerivedProductProcessingSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in BiologicallyDerivedProductProcessingSerializer.propertyToSerializerMap) {
                if (BiologicallyDerivedProductProcessingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = BiologicallyDerivedProductProcessingSerializer.propertyToSerializerMap[propertyName](value, context);

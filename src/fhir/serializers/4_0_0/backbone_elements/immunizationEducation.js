...
class ImmunizationEducationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImmunizationEducationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImmunizationEducationSerializer.propertyToSerializerMap) {
                if (ImmunizationEducationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImmunizationEducationSerializer.propertyToSerializerMap[propertyName](value, context);

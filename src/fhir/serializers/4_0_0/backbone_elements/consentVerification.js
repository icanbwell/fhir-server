...
class ConsentVerificationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ConsentVerificationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ConsentVerificationSerializer.propertyToSerializerMap) {
                if (ConsentVerificationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ConsentVerificationSerializer.propertyToSerializerMap[propertyName](value, context);

...
class MeasureReportPopulation1Serializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MeasureReportPopulation1Serializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MeasureReportPopulation1Serializer.propertyToSerializerMap) {
                if (MeasureReportPopulation1Serializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MeasureReportPopulation1Serializer.propertyToSerializerMap[propertyName](value, context);

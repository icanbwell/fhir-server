...
class PractitionerQualificationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PractitionerQualificationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PractitionerQualificationSerializer.propertyToSerializerMap) {
                if (PractitionerQualificationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PractitionerQualificationSerializer.propertyToSerializerMap[propertyName](value, context);

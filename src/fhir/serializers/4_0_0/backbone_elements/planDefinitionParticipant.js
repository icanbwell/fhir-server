...
class PlanDefinitionParticipantSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PlanDefinitionParticipantSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PlanDefinitionParticipantSerializer.propertyToSerializerMap) {
                if (PlanDefinitionParticipantSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PlanDefinitionParticipantSerializer.propertyToSerializerMap[propertyName](value, context);

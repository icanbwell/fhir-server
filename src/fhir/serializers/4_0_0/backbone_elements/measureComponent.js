...
class MeasureComponentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MeasureComponentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MeasureComponentSerializer.propertyToSerializerMap) {
                if (MeasureComponentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MeasureComponentSerializer.propertyToSerializerMap[propertyName](value, context);

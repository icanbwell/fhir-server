...
class ContractActionSerializer {
    static propertyToSerializerMap = {
        ...
        subject: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ContractSubjectSerializer, context);
        },
        intent: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        },
        linkId: null,
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ContractActionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ContractActionSerializer.propertyToSerializerMap) {
                if (ContractActionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ContractActionSerializer.propertyToSerializerMap[propertyName](value, context);

...
class AccountGuarantorSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AccountGuarantorSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AccountGuarantorSerializer.propertyToSerializerMap) {
                if (AccountGuarantorSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AccountGuarantorSerializer.propertyToSerializerMap[propertyName](value, context);

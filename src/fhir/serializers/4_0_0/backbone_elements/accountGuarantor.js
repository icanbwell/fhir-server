...
class AccountGuarantorSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AccountGuarantorSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AccountGuarantorSerializer.propertyToSerializerMap) {
                if (AccountGuarantorSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AccountGuarantorSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = AccountGuarantorSerializer;
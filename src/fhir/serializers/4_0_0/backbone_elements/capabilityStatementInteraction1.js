...
class CapabilityStatementInteraction1Serializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CapabilityStatementInteraction1Serializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CapabilityStatementInteraction1Serializer.propertyToSerializerMap) {
                if (CapabilityStatementInteraction1Serializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CapabilityStatementInteraction1Serializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CapabilityStatementInteraction1Serializer;

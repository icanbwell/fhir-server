...
class ClaimResponseSubDetail1Serializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimResponseSubDetail1Serializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimResponseSubDetail1Serializer.propertyToSerializerMap) {
                if (ClaimResponseSubDetail1Serializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimResponseSubDetail1Serializer.propertyToSerializerMap[propertyName](value, context);

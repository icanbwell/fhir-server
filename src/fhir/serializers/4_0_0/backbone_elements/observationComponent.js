...
class ObservationComponentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ObservationComponentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ObservationComponentSerializer.propertyToSerializerMap) {
                if (ObservationComponentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ObservationComponentSerializer.propertyToSerializerMap[propertyName](value, context);

...
class InsurancePlanLimitSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => InsurancePlanLimitSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in InsurancePlanLimitSerializer.propertyToSerializerMap) {
                if (InsurancePlanLimitSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = InsurancePlanLimitSerializer.propertyToSerializerMap[propertyName](value, context);

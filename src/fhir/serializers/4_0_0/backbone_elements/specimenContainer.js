...
class SpecimenContainerSerializer {
    static propertyToSerializerMap = {
        ...
        specimenQuantity: (value) => QuantitySerializer.serialize(value),
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SpecimenContainerSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SpecimenContainerSerializer.propertyToSerializerMap) {
                if (SpecimenContainerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SpecimenContainerSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = SpecimenContainerSerializer;
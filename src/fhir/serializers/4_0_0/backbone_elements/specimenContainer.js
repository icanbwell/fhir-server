...
class SpecimenContainerSerializer {
    static propertyToSerializerMap = {
        ...
        specimenQuantity: (value, context) => {
            initializeSerializers('Quantity');
            return FhirResourceSerializer.serialize(value, QuantitySerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SpecimenContainerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SpecimenContainerSerializer.propertyToSerializerMap) {
                if (SpecimenContainerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SpecimenContainerSerializer.propertyToSerializerMap[propertyName](value, context);

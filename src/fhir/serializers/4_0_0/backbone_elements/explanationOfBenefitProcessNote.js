...
class ExplanationOfBenefitProcessNoteSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitProcessNoteSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitProcessNoteSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitProcessNoteSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitProcessNoteSerializer.propertyToSerializerMap[propertyName](value, context);

...
class AppointmentParticipantSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AppointmentParticipantSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AppointmentParticipantSerializer.propertyToSerializerMap) {
                if (AppointmentParticipantSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AppointmentParticipantSerializer.propertyToSerializerMap[propertyName](value, context);

...
let SubstanceDefinitionOfficial;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SubstanceDefinitionOfficial' && !SubstanceDefinitionOfficial) {
        SubstanceDefinitionOfficial = require('../backbone_elements/substanceDefinitionOfficial.js');
...
class SubstanceDefinitionNameSerializer {
    static propertyToSerializerMap = {
        ...
        official: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, SubstanceDefinitionOfficial);
        },
        source: (value) => {

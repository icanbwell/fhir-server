...
class OperationOutcomeIssueSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => OperationOutcomeIssueSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in OperationOutcomeIssueSerializer.propertyToSerializerMap) {
                if (OperationOutcomeIssueSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = OperationOutcomeIssueSerializer.propertyToSerializerMap[propertyName](value, context);

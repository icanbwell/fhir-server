...
class TestScriptLinkSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestScriptLinkSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestScriptLinkSerializer.propertyToSerializerMap) {
                if (TestScriptLinkSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestScriptLinkSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = TestScriptLinkSerializer;

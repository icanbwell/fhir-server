...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'TestReportAction1' && !TestReportAction1Serializer) {
        TestReportAction1Serializer = require('../backbone_elements/testReportAction1.js');
        return TestReportAction1Serializer;
    }
}

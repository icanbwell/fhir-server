...
class LocationPositionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => LocationPositionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in LocationPositionSerializer.propertyToSerializerMap) {
                if (LocationPositionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = LocationPositionSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = LocationPositionSerializer;

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'GraphDefinitionTarget' && !GraphDefinitionTargetSerializer) {
        GraphDefinitionTargetSerializer = require('../backbone_elements/graphDefinitionTarget.js');
        return GraphDefinitionTargetSerializer;
    }
}

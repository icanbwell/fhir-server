...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ValueSetInclude' && !ValueSetInclude) {
        ValueSetInclude = require('../backbone_elements/valueSetInclude.js');
...
class ValueSetComposeSerializer {
    static propertyToSerializerMap = {
        ...
        include: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ValueSetInclude);
        },
        exclude: (value) => {
            initializeSerializers('ValueSetInclude');
            return FhirResourceSerializer.serializeArray(value, ValueSetInclude);

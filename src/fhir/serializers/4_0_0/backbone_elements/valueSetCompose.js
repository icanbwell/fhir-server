...
/** @type {import('../backbone_elements/valueSetInclude.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ValueSetInclude' && !ValueSetIncludeSerializer) {
        ValueSetIncludeSerializer = require('../backbone_elements/valueSetInclude.js');
        return ValueSetIncludeSerializer;
    }
}
...
class ValueSetComposeSerializer {
    static propertyToSerializerMap = {
        ...
        include: (value, context) => {
            initializeSerializers('ValueSetInclude');
            return FhirResourceSerializer.serializeArray(value, ValueSetIncludeSerializer, context);
        },
        exclude: (value, context) => {
            initializeSerializers('ValueSetInclude');
            return FhirResourceSerializer.serializeArray(value, ValueSetIncludeSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ValueSetComposeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ValueSetComposeSerializer.propertyToSerializerMap) {
                if (ValueSetComposeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ValueSetComposeSerializer.propertyToSerializerMap[propertyName](value, context);

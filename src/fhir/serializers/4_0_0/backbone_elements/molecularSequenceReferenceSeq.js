...
class MolecularSequenceReferenceSeqSerializer {
    static propertyToSerializerMap = {
        ...
        chromosome: (value) => CodeableConceptSerializer.serialize(value),
        genomeBuild: null,
        orientation: null,
        referenceSeqId: (value) => CodeableConceptSerializer.serialize(value),
        referenceSeqPointer: (value) => ReferenceSerializer.serialize(value),

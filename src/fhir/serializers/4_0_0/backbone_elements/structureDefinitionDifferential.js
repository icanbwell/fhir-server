...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ElementDefinition' && !ElementDefinition) {
        ElementDefinition = require('../backbone_elements/elementDefinition.js');
...
class StructureDefinitionDifferentialSerializer {
    static propertyToSerializerMap = {
        ...
        element: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ElementDefinition);
        }
    };

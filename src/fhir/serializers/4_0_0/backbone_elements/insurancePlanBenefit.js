...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'InsurancePlanLimit' && !InsurancePlanLimit) {
        InsurancePlanLimit = require('../backbone_elements/insurancePlanLimit.js');
...
class InsurancePlanBenefitSerializer {
    static propertyToSerializerMap = {
        ...
        limit: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanLimit);
        }
    };

...
class InsurancePlanBenefitSerializer {
    static propertyToSerializerMap = {
        ...
        limit: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanLimitSerializer);
        }
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => InsurancePlanBenefitSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in InsurancePlanBenefitSerializer.propertyToSerializerMap) {
                if (InsurancePlanBenefitSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = InsurancePlanBenefitSerializer.propertyToSerializerMap[propertyName](value);

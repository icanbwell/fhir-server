...
/** @type {import('../backbone_elements/insurancePlanLimit.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'InsurancePlanLimit' && !InsurancePlanLimitSerializer) {
        InsurancePlanLimitSerializer = require('../backbone_elements/insurancePlanLimit.js');
        return InsurancePlanLimitSerializer;
    }
}
...
class InsurancePlanBenefitSerializer {
    static propertyToSerializerMap = {
        ...
        requirement: null,
        limit: (value, context) => {
            initializeSerializers('InsurancePlanLimit');
            return FhirResourceSerializer.serializeArray(value, InsurancePlanLimitSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => InsurancePlanBenefitSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in InsurancePlanBenefitSerializer.propertyToSerializerMap) {
                if (InsurancePlanBenefitSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = InsurancePlanBenefitSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = InsurancePlanBenefitSerializer;

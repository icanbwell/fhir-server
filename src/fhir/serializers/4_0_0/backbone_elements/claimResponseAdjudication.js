...
class ClaimResponseAdjudicationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimResponseAdjudicationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimResponseAdjudicationSerializer.propertyToSerializerMap) {
                if (ClaimResponseAdjudicationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimResponseAdjudicationSerializer.propertyToSerializerMap[propertyName](value, context);

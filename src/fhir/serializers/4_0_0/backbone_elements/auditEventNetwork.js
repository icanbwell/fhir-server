...
class AuditEventNetworkSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AuditEventNetworkSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AuditEventNetworkSerializer.propertyToSerializerMap) {
                if (AuditEventNetworkSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AuditEventNetworkSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = AuditEventNetworkSerializer;

...
class EpisodeOfCareStatusHistorySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EpisodeOfCareStatusHistorySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EpisodeOfCareStatusHistorySerializer.propertyToSerializerMap) {
                if (EpisodeOfCareStatusHistorySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EpisodeOfCareStatusHistorySerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = EpisodeOfCareStatusHistorySerializer;

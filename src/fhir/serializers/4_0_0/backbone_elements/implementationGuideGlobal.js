...
class ImplementationGuideGlobalSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImplementationGuideGlobalSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImplementationGuideGlobalSerializer.propertyToSerializerMap) {
                if (ImplementationGuideGlobalSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImplementationGuideGlobalSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ImplementationGuideGlobalSerializer;

...
class ExplanationOfBenefitAdjudicationSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitAdjudicationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitAdjudicationSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitAdjudicationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitAdjudicationSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = ExplanationOfBenefitAdjudicationSerializer;
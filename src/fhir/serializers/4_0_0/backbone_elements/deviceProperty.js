...
class DevicePropertySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DevicePropertySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DevicePropertySerializer.propertyToSerializerMap) {
                if (DevicePropertySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DevicePropertySerializer.propertyToSerializerMap[propertyName](value, context);

...
class LocationHoursOfOperationSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => LocationHoursOfOperationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in LocationHoursOfOperationSerializer.propertyToSerializerMap) {
                if (LocationHoursOfOperationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = LocationHoursOfOperationSerializer.propertyToSerializerMap[propertyName](value);

...
class LocationHoursOfOperationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => LocationHoursOfOperationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in LocationHoursOfOperationSerializer.propertyToSerializerMap) {
                if (LocationHoursOfOperationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = LocationHoursOfOperationSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = LocationHoursOfOperationSerializer;

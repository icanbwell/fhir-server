...
class AccountCoverageSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AccountCoverageSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AccountCoverageSerializer.propertyToSerializerMap) {
                if (AccountCoverageSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AccountCoverageSerializer.propertyToSerializerMap[propertyName](value, context);

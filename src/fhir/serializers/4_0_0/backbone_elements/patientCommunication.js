...
class PatientCommunicationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PatientCommunicationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PatientCommunicationSerializer.propertyToSerializerMap) {
                if (PatientCommunicationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PatientCommunicationSerializer.propertyToSerializerMap[propertyName](value, context);

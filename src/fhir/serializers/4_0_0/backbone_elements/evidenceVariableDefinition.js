...
class EvidenceVariableDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        intended: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serialize(value, ReferenceSerializer, context);
        },
        directnessMatch: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EvidenceVariableDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EvidenceVariableDefinitionSerializer.propertyToSerializerMap) {
                if (EvidenceVariableDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EvidenceVariableDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);

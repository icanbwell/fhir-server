...
class SubstanceInstanceSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubstanceInstanceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubstanceInstanceSerializer.propertyToSerializerMap) {
                if (SubstanceInstanceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubstanceInstanceSerializer.propertyToSerializerMap[propertyName](value, context);

...
class InvoicePriceComponentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => InvoicePriceComponentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in InvoicePriceComponentSerializer.propertyToSerializerMap) {
                if (InvoicePriceComponentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = InvoicePriceComponentSerializer.propertyToSerializerMap[propertyName](value, context);

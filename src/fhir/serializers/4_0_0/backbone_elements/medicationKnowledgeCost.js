...
class MedicationKnowledgeCostSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeCostSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeCostSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeCostSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeCostSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = MedicationKnowledgeCostSerializer;
...
class MedicationKnowledgeCostSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeCostSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeCostSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeCostSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeCostSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ImplementationGuideTemplateSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImplementationGuideTemplateSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImplementationGuideTemplateSerializer.propertyToSerializerMap) {
                if (ImplementationGuideTemplateSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImplementationGuideTemplateSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ImplementationGuideTemplateSerializer;

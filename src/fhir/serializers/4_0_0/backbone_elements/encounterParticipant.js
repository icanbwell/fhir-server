...
class EncounterParticipantSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EncounterParticipantSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EncounterParticipantSerializer.propertyToSerializerMap) {
                if (EncounterParticipantSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EncounterParticipantSerializer.propertyToSerializerMap[propertyName](value, context);

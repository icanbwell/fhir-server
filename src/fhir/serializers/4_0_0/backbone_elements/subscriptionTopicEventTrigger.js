...
class SubscriptionTopicEventTriggerSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubscriptionTopicEventTriggerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubscriptionTopicEventTriggerSerializer.propertyToSerializerMap) {
                if (SubscriptionTopicEventTriggerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubscriptionTopicEventTriggerSerializer.propertyToSerializerMap[propertyName](value, context);

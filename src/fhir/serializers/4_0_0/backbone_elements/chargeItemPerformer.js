...
class ChargeItemPerformerSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ChargeItemPerformerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ChargeItemPerformerSerializer.propertyToSerializerMap) {
                if (ChargeItemPerformerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ChargeItemPerformerSerializer.propertyToSerializerMap[propertyName](value, context);

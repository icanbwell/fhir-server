...
class MedicinalProductDefinitionCountryLanguageSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicinalProductDefinitionCountryLanguageSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicinalProductDefinitionCountryLanguageSerializer.propertyToSerializerMap) {
                if (MedicinalProductDefinitionCountryLanguageSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicinalProductDefinitionCountryLanguageSerializer.propertyToSerializerMap[propertyName](value, context);

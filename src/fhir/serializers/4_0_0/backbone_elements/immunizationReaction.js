...
class ImmunizationReactionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImmunizationReactionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImmunizationReactionSerializer.propertyToSerializerMap) {
                if (ImmunizationReactionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImmunizationReactionSerializer.propertyToSerializerMap[propertyName](value, context);

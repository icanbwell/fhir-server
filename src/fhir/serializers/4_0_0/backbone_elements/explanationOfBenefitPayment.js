...
class ExplanationOfBenefitPaymentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitPaymentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitPaymentSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitPaymentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitPaymentSerializer.propertyToSerializerMap[propertyName](value, context);

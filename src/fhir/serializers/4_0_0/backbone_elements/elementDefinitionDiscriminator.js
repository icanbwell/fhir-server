...
class ElementDefinitionDiscriminatorSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ElementDefinitionDiscriminatorSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ElementDefinitionDiscriminatorSerializer.propertyToSerializerMap) {
                if (ElementDefinitionDiscriminatorSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ElementDefinitionDiscriminatorSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ElementDefinitionDiscriminatorSerializer;

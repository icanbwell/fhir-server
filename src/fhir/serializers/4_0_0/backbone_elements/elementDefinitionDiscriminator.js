...
class ElementDefinitionDiscriminatorSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ElementDefinitionDiscriminatorSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ElementDefinitionDiscriminatorSerializer.propertyToSerializerMap) {
                if (ElementDefinitionDiscriminatorSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ElementDefinitionDiscriminatorSerializer.propertyToSerializerMap[propertyName](value);

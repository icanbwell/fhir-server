...
class MedicationKnowledgePackagingSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgePackagingSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgePackagingSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgePackagingSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgePackagingSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MedicationKnowledgePackagingSerializer;

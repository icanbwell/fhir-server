...
class SubstanceDefinitionOfficialSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubstanceDefinitionOfficialSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubstanceDefinitionOfficialSerializer.propertyToSerializerMap) {
                if (SubstanceDefinitionOfficialSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubstanceDefinitionOfficialSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ValueSetFilterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ValueSetFilterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ValueSetFilterSerializer.propertyToSerializerMap) {
                if (ValueSetFilterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ValueSetFilterSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ValueSetFilterSerializer;

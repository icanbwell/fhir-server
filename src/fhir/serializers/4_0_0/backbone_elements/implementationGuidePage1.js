...
class ImplementationGuidePage1Serializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImplementationGuidePage1Serializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImplementationGuidePage1Serializer.propertyToSerializerMap) {
                if (ImplementationGuidePage1Serializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImplementationGuidePage1Serializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ImplementationGuidePage1Serializer;

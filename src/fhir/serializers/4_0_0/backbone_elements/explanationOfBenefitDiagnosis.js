...
class ExplanationOfBenefitDiagnosisSerializer {
    static propertyToSerializerMap = {
        ...
        onAdmission: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        },
        packageCode: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitDiagnosisSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitDiagnosisSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitDiagnosisSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitDiagnosisSerializer.propertyToSerializerMap[propertyName](value, context);

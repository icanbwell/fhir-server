...
class DetectedIssueMitigationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DetectedIssueMitigationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DetectedIssueMitigationSerializer.propertyToSerializerMap) {
                if (DetectedIssueMitigationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DetectedIssueMitigationSerializer.propertyToSerializerMap[propertyName](value, context);

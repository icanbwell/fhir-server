...
class MedicationKnowledgeScheduleSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeScheduleSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeScheduleSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeScheduleSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeScheduleSerializer.propertyToSerializerMap[propertyName](value, context);

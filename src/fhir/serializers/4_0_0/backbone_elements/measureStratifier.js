...
/** @type {import('../backbone_elements/measureComponent.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MeasureComponent' && !MeasureComponentSerializer) {
        MeasureComponentSerializer = require('../backbone_elements/measureComponent.js');
        return MeasureComponentSerializer;
    }
}
...
class MeasureStratifierSerializer {
    static propertyToSerializerMap = {
        ...
        component: (value, context) => {
            initializeSerializers('MeasureComponent');
            return FhirResourceSerializer.serializeArray(value, MeasureComponentSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MeasureStratifierSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MeasureStratifierSerializer.propertyToSerializerMap) {
                if (MeasureStratifierSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MeasureStratifierSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MeasureStratifierSerializer;

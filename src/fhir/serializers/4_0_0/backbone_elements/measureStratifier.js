...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MeasureComponent' && !MeasureComponent) {
        MeasureComponent = require('../backbone_elements/measureComponent.js');
...
class MeasureStratifierSerializer {
    static propertyToSerializerMap = {
        ...
        component: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MeasureComponent);
        }
    };

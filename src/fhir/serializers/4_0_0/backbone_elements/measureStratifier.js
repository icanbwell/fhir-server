...
class MeasureStratifierSerializer {
    static propertyToSerializerMap = {
        ...
        component: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MeasureComponentSerializer);
        }
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MeasureStratifierSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MeasureStratifierSerializer.propertyToSerializerMap) {
                if (MeasureStratifierSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MeasureStratifierSerializer.propertyToSerializerMap[propertyName](value);

...
class ClaimSupportingInfoSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimSupportingInfoSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimSupportingInfoSerializer.propertyToSerializerMap) {
                if (ClaimSupportingInfoSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimSupportingInfoSerializer.propertyToSerializerMap[propertyName](value, context);

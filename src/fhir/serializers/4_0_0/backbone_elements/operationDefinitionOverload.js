...
class OperationDefinitionOverloadSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => OperationDefinitionOverloadSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in OperationDefinitionOverloadSerializer.propertyToSerializerMap) {
                if (OperationDefinitionOverloadSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = OperationDefinitionOverloadSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = OperationDefinitionOverloadSerializer;

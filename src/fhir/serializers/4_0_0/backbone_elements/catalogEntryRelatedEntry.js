...
class CatalogEntryRelatedEntrySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CatalogEntryRelatedEntrySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CatalogEntryRelatedEntrySerializer.propertyToSerializerMap) {
                if (CatalogEntryRelatedEntrySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CatalogEntryRelatedEntrySerializer.propertyToSerializerMap[propertyName](value, context);

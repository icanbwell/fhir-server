...
class ClinicalUseDefinitionUndesirableEffectSerializer {
    static propertyToSerializerMap = {
        ...
        symptomConditionEffect: (value, context) => {
        ...
        frequencyOfOccurrence: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClinicalUseDefinitionUndesirableEffectSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClinicalUseDefinitionUndesirableEffectSerializer.propertyToSerializerMap) {
                if (ClinicalUseDefinitionUndesirableEffectSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClinicalUseDefinitionUndesirableEffectSerializer.propertyToSerializerMap[propertyName](value, context);

...
class MedicationKnowledgeMonitoringProgramSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeMonitoringProgramSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeMonitoringProgramSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeMonitoringProgramSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeMonitoringProgramSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MedicationKnowledgeMonitoringProgramSerializer;

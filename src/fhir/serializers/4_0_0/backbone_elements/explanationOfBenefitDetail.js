...
let ExplanationOfBenefitSubDetail;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ExplanationOfBenefitSubDetail' && !ExplanationOfBenefitSubDetail) {
        ExplanationOfBenefitSubDetail = require('../backbone_elements/explanationOfBenefitSubDetail.js');
...
class ExplanationOfBenefitDetailSerializer {
    static propertyToSerializerMap = {
        ...
        subDetail: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ExplanationOfBenefitSubDetail);
        }
    };

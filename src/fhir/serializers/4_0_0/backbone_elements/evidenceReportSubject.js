...
let EvidenceReportCharacteristic;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'EvidenceReportCharacteristic' && !EvidenceReportCharacteristic) {
        EvidenceReportCharacteristic = require('../backbone_elements/evidenceReportCharacteristic.js');
...
class EvidenceReportSubjectSerializer {
    static propertyToSerializerMap = {
        ...
        characteristic: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, EvidenceReportCharacteristic);
        },
        note: (value) => {

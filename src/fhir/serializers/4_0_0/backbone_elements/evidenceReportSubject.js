...
const EvidenceReportCharacteristicSerializer = require('../backbone_elements/evidenceReportCharacteristic.js');
...
class EvidenceReportSubjectSerializer {
    static propertyToSerializerMap = {
        ...
        characteristic: (value) => EvidenceReportCharacteristicSerializer.serialize(value),

...
class MedicationKnowledgeDrugCharacteristicSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeDrugCharacteristicSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeDrugCharacteristicSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeDrugCharacteristicSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeDrugCharacteristicSerializer.propertyToSerializerMap[propertyName](value, context);

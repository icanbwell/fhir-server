...
class ContractFriendlySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ContractFriendlySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ContractFriendlySerializer.propertyToSerializerMap) {
                if (ContractFriendlySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ContractFriendlySerializer.propertyToSerializerMap[propertyName](value, context);

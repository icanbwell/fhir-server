...
class ExampleScenarioVersionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExampleScenarioVersionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExampleScenarioVersionSerializer.propertyToSerializerMap) {
                if (ExampleScenarioVersionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExampleScenarioVersionSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ExampleScenarioVersionSerializer;

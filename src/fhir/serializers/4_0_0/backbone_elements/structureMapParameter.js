...
class StructureMapParameterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => StructureMapParameterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in StructureMapParameterSerializer.propertyToSerializerMap) {
                if (StructureMapParameterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = StructureMapParameterSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = StructureMapParameterSerializer;

...
/** @type {import('../backbone_elements/claimSubDetail.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ClaimSubDetail' && !ClaimSubDetailSerializer) {
        ClaimSubDetailSerializer = require('../backbone_elements/claimSubDetail.js');
        return ClaimSubDetailSerializer;
    }
}
...
class ClaimDetailSerializer {
    static propertyToSerializerMap = {
        ...
        subDetail: (value, context) => {
            initializeSerializers('ClaimSubDetail');
            return FhirResourceSerializer.serializeArray(value, ClaimSubDetailSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimDetailSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimDetailSerializer.propertyToSerializerMap) {
                if (ClaimDetailSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimDetailSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ClaimSubDetail' && !ClaimSubDetail) {
        ClaimSubDetail = require('../backbone_elements/claimSubDetail.js');
...
class ClaimDetailSerializer {
    static propertyToSerializerMap = {
        ...
        subDetail: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ClaimSubDetail);
        }
    };

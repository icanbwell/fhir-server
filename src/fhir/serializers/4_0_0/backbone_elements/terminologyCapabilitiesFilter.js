...
class TerminologyCapabilitiesFilterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TerminologyCapabilitiesFilterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TerminologyCapabilitiesFilterSerializer.propertyToSerializerMap) {
                if (TerminologyCapabilitiesFilterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TerminologyCapabilitiesFilterSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = TerminologyCapabilitiesFilterSerializer;

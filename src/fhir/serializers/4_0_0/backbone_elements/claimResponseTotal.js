...
class ClaimResponseTotalSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimResponseTotalSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimResponseTotalSerializer.propertyToSerializerMap) {
                if (ClaimResponseTotalSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimResponseTotalSerializer.propertyToSerializerMap[propertyName](value);

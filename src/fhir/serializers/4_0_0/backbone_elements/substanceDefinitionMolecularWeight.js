...
class SubstanceDefinitionMolecularWeightSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubstanceDefinitionMolecularWeightSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubstanceDefinitionMolecularWeightSerializer.propertyToSerializerMap) {
                if (SubstanceDefinitionMolecularWeightSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubstanceDefinitionMolecularWeightSerializer.propertyToSerializerMap[propertyName](value, context);

...
class CitationRelatesToSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationRelatesToSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationRelatesToSerializer.propertyToSerializerMap) {
                if (CitationRelatesToSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationRelatesToSerializer.propertyToSerializerMap[propertyName](value, context);

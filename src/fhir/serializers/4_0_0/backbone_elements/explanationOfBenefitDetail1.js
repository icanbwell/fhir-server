...
let ExplanationOfBenefitSubDetail1;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ExplanationOfBenefitSubDetail1' && !ExplanationOfBenefitSubDetail1) {
        ExplanationOfBenefitSubDetail1 = require('../backbone_elements/explanationOfBenefitSubDetail1.js');
...
class ExplanationOfBenefitDetail1Serializer {
    static propertyToSerializerMap = {
        ...
        subDetail: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ExplanationOfBenefitSubDetail1);
        }
    };

...
class PlanDefinitionConditionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PlanDefinitionConditionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PlanDefinitionConditionSerializer.propertyToSerializerMap) {
                if (PlanDefinitionConditionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PlanDefinitionConditionSerializer.propertyToSerializerMap[propertyName](value, context);

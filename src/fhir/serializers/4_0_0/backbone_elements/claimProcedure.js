...
class ClaimProcedureSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimProcedureSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimProcedureSerializer.propertyToSerializerMap) {
                if (ClaimProcedureSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimProcedureSerializer.propertyToSerializerMap[propertyName](value, context);

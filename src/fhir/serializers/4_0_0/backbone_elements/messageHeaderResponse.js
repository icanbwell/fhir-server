...
class MessageHeaderResponseSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MessageHeaderResponseSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MessageHeaderResponseSerializer.propertyToSerializerMap) {
                if (MessageHeaderResponseSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MessageHeaderResponseSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ObservationDefinitionQuantitativeDetailsSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ObservationDefinitionQuantitativeDetailsSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ObservationDefinitionQuantitativeDetailsSerializer.propertyToSerializerMap) {
                if (ObservationDefinitionQuantitativeDetailsSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ObservationDefinitionQuantitativeDetailsSerializer.propertyToSerializerMap[propertyName](value, context);

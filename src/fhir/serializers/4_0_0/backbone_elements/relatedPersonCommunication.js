...
class RelatedPersonCommunicationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => RelatedPersonCommunicationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in RelatedPersonCommunicationSerializer.propertyToSerializerMap) {
                if (RelatedPersonCommunicationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = RelatedPersonCommunicationSerializer.propertyToSerializerMap[propertyName](value, context);

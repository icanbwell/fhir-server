...
class PackagedProductDefinitionContainedItemSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PackagedProductDefinitionContainedItemSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PackagedProductDefinitionContainedItemSerializer.propertyToSerializerMap) {
                if (PackagedProductDefinitionContainedItemSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PackagedProductDefinitionContainedItemSerializer.propertyToSerializerMap[propertyName](value, context);

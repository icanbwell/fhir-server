...
class TestScriptVariableSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestScriptVariableSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestScriptVariableSerializer.propertyToSerializerMap) {
                if (TestScriptVariableSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestScriptVariableSerializer.propertyToSerializerMap[propertyName](value);

...
class TestScriptVariableSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestScriptVariableSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestScriptVariableSerializer.propertyToSerializerMap) {
                if (TestScriptVariableSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestScriptVariableSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = TestScriptVariableSerializer;

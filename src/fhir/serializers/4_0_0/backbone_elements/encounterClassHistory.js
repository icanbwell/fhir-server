...
class EncounterClassHistorySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EncounterClassHistorySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EncounterClassHistorySerializer.propertyToSerializerMap) {
                if (EncounterClassHistorySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EncounterClassHistorySerializer.propertyToSerializerMap[propertyName](value, context);

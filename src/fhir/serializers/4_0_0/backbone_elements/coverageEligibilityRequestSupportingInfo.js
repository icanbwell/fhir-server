...
class CoverageEligibilityRequestSupportingInfoSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CoverageEligibilityRequestSupportingInfoSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CoverageEligibilityRequestSupportingInfoSerializer.propertyToSerializerMap) {
                if (CoverageEligibilityRequestSupportingInfoSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CoverageEligibilityRequestSupportingInfoSerializer.propertyToSerializerMap[propertyName](value, context);

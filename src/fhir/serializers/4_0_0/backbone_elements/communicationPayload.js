...
class CommunicationPayloadSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CommunicationPayloadSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CommunicationPayloadSerializer.propertyToSerializerMap) {
                if (CommunicationPayloadSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CommunicationPayloadSerializer.propertyToSerializerMap[propertyName](value, context);

...
class BundleLinkSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => BundleLinkSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in BundleLinkSerializer.propertyToSerializerMap) {
                if (BundleLinkSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = BundleLinkSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = BundleLinkSerializer;

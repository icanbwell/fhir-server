...
/** @type {import('../backbone_elements/immunizationRecommendationDateCriterion.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ImmunizationRecommendationDateCriterion' && !ImmunizationRecommendationDateCriterionSerializer) {
        ImmunizationRecommendationDateCriterionSerializer = require('../backbone_elements/immunizationRecommendationDateCriterion.js');
        return ImmunizationRecommendationDateCriterionSerializer;
    }
...
class ImmunizationRecommendationRecommendationSerializer {
    static propertyToSerializerMap = {
        ...
        contraindicatedVaccineCode: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConceptSerializer, context);
        },
        forecastStatus: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        },
        forecastReason: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConceptSerializer, context);
        },
        dateCriterion: (value, context) => {
            initializeSerializers('ImmunizationRecommendationDateCriterion');
            return FhirResourceSerializer.serializeArray(value, ImmunizationRecommendationDateCriterionSerializer, context);
        },
        description: null,
        series: null,
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImmunizationRecommendationRecommendationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImmunizationRecommendationRecommendationSerializer.propertyToSerializerMap) {
                if (ImmunizationRecommendationRecommendationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImmunizationRecommendationRecommendationSerializer.propertyToSerializerMap[propertyName](value, context);

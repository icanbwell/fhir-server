...
class MarketingStatusSerializer {
    static propertyToSerializerMap = {
        ...
        dateRange: (value) => PeriodSerializer.serialize(value),
        restoreDate: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MarketingStatusSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MarketingStatusSerializer.propertyToSerializerMap) {
                if (MarketingStatusSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MarketingStatusSerializer.propertyToSerializerMap[propertyName](value);

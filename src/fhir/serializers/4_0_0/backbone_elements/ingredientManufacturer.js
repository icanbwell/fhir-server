...
class IngredientManufacturerSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => IngredientManufacturerSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in IngredientManufacturerSerializer.propertyToSerializerMap) {
                if (IngredientManufacturerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = IngredientManufacturerSerializer.propertyToSerializerMap[propertyName](value);

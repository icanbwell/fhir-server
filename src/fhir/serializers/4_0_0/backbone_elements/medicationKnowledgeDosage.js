...
class MedicationKnowledgeDosageSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeDosageSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeDosageSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeDosageSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeDosageSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ExampleScenarioContainedInstanceSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExampleScenarioContainedInstanceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExampleScenarioContainedInstanceSerializer.propertyToSerializerMap) {
                if (ExampleScenarioContainedInstanceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExampleScenarioContainedInstanceSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ExampleScenarioContainedInstanceSerializer;

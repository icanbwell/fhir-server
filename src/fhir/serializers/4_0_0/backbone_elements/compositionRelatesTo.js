...
class CompositionRelatesToSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CompositionRelatesToSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CompositionRelatesToSerializer.propertyToSerializerMap) {
                if (CompositionRelatesToSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CompositionRelatesToSerializer.propertyToSerializerMap[propertyName](value, context);

...
class MedicationRequestSubstitutionSerializer {
    static propertyToSerializerMap = {
        ...
        allowedBoolean: null,
        allowedCodeableConcept: (value, context) => {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationRequestSubstitutionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationRequestSubstitutionSerializer.propertyToSerializerMap) {
                if (MedicationRequestSubstitutionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationRequestSubstitutionSerializer.propertyToSerializerMap[propertyName](value, context);

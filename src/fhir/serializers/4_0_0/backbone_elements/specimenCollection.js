...
class SpecimenCollectionSerializer {
    static propertyToSerializerMap = {
        ...
        fastingStatusCodeableConcept: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        },
        fastingStatusDuration: (value, context) => {
            initializeSerializers('Quantity');
            return FhirResourceSerializer.serialize(value, QuantitySerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SpecimenCollectionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SpecimenCollectionSerializer.propertyToSerializerMap) {
                if (SpecimenCollectionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SpecimenCollectionSerializer.propertyToSerializerMap[propertyName](value, context);

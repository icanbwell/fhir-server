...
class CitationContributionInstanceSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationContributionInstanceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationContributionInstanceSerializer.propertyToSerializerMap) {
                if (CitationContributionInstanceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationContributionInstanceSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CitationContributionInstanceSerializer;

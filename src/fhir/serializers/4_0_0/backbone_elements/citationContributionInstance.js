...
class CitationContributionInstanceSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationContributionInstanceSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationContributionInstanceSerializer.propertyToSerializerMap) {
                if (CitationContributionInstanceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationContributionInstanceSerializer.propertyToSerializerMap[propertyName](value);

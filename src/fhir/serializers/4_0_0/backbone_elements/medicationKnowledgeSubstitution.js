...
class MedicationKnowledgeSubstitutionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgeSubstitutionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgeSubstitutionSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgeSubstitutionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgeSubstitutionSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MedicationKnowledgeSubstitutionSerializer;

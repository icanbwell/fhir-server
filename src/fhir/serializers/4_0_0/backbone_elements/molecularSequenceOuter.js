...
class MolecularSequenceOuterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MolecularSequenceOuterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MolecularSequenceOuterSerializer.propertyToSerializerMap) {
                if (MolecularSequenceOuterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MolecularSequenceOuterSerializer.propertyToSerializerMap[propertyName](value, context);

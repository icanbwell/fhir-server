...
class ObservationReferenceRangeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ObservationReferenceRangeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ObservationReferenceRangeSerializer.propertyToSerializerMap) {
                if (ObservationReferenceRangeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ObservationReferenceRangeSerializer.propertyToSerializerMap[propertyName](value, context);

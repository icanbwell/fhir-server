...
class BundleResponseSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => BundleResponseSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in BundleResponseSerializer.propertyToSerializerMap) {
                if (BundleResponseSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = BundleResponseSerializer.propertyToSerializerMap[propertyName](value, context);

...
class StructureDefinitionContextSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => StructureDefinitionContextSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in StructureDefinitionContextSerializer.propertyToSerializerMap) {
                if (StructureDefinitionContextSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = StructureDefinitionContextSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = StructureDefinitionContextSerializer;

...
class StructureDefinitionContextSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => StructureDefinitionContextSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in StructureDefinitionContextSerializer.propertyToSerializerMap) {
                if (StructureDefinitionContextSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = StructureDefinitionContextSerializer.propertyToSerializerMap[propertyName](value);

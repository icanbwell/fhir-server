...
const IngredientStrengthSerializer = require('../backbone_elements/ingredientStrength.js');
...
class IngredientSubstanceSerializer {
    static propertyToSerializerMap = {
        ...
        code: (value) => CodeableReferenceSerializer.serialize(value),
        strength: (value) => IngredientStrengthSerializer.serialize(value)
    };

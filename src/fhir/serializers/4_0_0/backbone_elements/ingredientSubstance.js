...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'IngredientStrength' && !IngredientStrength) {
        IngredientStrength = require('../backbone_elements/ingredientStrength.js');
...
class IngredientSubstanceSerializer {
    static propertyToSerializerMap = {
        ...
        strength: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, IngredientStrength);
        }
    };

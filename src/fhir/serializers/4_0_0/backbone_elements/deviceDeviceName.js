...
class DeviceDeviceNameSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceDeviceNameSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceDeviceNameSerializer.propertyToSerializerMap) {
                if (DeviceDeviceNameSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceDeviceNameSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = DeviceDeviceNameSerializer;

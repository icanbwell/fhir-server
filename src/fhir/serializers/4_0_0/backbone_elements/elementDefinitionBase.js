...
class ElementDefinitionBaseSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ElementDefinitionBaseSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ElementDefinitionBaseSerializer.propertyToSerializerMap) {
                if (ElementDefinitionBaseSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ElementDefinitionBaseSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ElementDefinitionBaseSerializer;

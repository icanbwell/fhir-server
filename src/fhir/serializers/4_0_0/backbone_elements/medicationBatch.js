...
class MedicationBatchSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationBatchSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationBatchSerializer.propertyToSerializerMap) {
                if (MedicationBatchSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationBatchSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MedicationBatchSerializer;

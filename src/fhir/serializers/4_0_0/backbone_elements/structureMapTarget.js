...
let Extension;
/** @type {import('../backbone_elements/structureMapParameter.js')} */
let StructureMapParameter;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'StructureMapParameter' && !StructureMapParameter) {
        StructureMapParameter = require('../backbone_elements/structureMapParameter.js');
...
class StructureMapTargetSerializer {
    static propertyToSerializerMap = {
        ...
        parameter: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, StructureMapParameter);
        }
    };
...
module.exports = StructureMapTargetSerializer;

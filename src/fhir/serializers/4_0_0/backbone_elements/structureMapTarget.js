...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'StructureMapParameter' && !StructureMapParameterSerializer) {
        StructureMapParameterSerializer = require('../backbone_elements/structureMapParameter.js');
        return StructureMapParameterSerializer;
    }
}

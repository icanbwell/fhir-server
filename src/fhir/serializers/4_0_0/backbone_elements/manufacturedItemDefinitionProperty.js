...
class ManufacturedItemDefinitionPropertySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ManufacturedItemDefinitionPropertySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ManufacturedItemDefinitionPropertySerializer.propertyToSerializerMap) {
                if (ManufacturedItemDefinitionPropertySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ManufacturedItemDefinitionPropertySerializer.propertyToSerializerMap[propertyName](value, context);

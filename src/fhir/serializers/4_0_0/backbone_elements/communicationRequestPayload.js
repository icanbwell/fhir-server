...
class CommunicationRequestPayloadSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CommunicationRequestPayloadSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CommunicationRequestPayloadSerializer.propertyToSerializerMap) {
                if (CommunicationRequestPayloadSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CommunicationRequestPayloadSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ClaimResponseAddItemSerializer {
    static propertyToSerializerMap = {
        ...
        detail: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ClaimResponseDetail1Serializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimResponseAddItemSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimResponseAddItemSerializer.propertyToSerializerMap) {
                if (ClaimResponseAddItemSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimResponseAddItemSerializer.propertyToSerializerMap[propertyName](value, context);

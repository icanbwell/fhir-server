...
class CitationTitleSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationTitleSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationTitleSerializer.propertyToSerializerMap) {
                if (CitationTitleSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationTitleSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = CitationTitleSerializer;
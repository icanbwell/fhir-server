...
class CitationTitleSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationTitleSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationTitleSerializer.propertyToSerializerMap) {
                if (CitationTitleSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationTitleSerializer.propertyToSerializerMap[propertyName](value, context);

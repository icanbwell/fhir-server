...
class ImmunizationPerformerSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImmunizationPerformerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImmunizationPerformerSerializer.propertyToSerializerMap) {
                if (ImmunizationPerformerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImmunizationPerformerSerializer.propertyToSerializerMap[propertyName](value, context);

...
class DeviceDefinitionCapabilitySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceDefinitionCapabilitySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceDefinitionCapabilitySerializer.propertyToSerializerMap) {
                if (DeviceDefinitionCapabilitySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceDefinitionCapabilitySerializer.propertyToSerializerMap[propertyName](value, context);

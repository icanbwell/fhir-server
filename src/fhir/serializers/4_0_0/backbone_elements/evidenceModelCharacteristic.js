...
class EvidenceModelCharacteristicSerializer {
    static propertyToSerializerMap = {
        ...
        variable: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, EvidenceVariableSerializer);
        },
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EvidenceModelCharacteristicSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EvidenceModelCharacteristicSerializer.propertyToSerializerMap) {
                if (EvidenceModelCharacteristicSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EvidenceModelCharacteristicSerializer.propertyToSerializerMap[propertyName](value);

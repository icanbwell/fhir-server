...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'EvidenceVariable' && !EvidenceVariable) {
        EvidenceVariable = require('../backbone_elements/evidenceVariable.js');
...
class EvidenceModelCharacteristicSerializer {
    static propertyToSerializerMap = {
        ...
        variable: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, EvidenceVariable);
        },

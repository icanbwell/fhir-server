...
/** @type {import('../backbone_elements/evidenceVariable.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'EvidenceVariable' && !EvidenceVariableSerializer) {
        EvidenceVariableSerializer = require('../backbone_elements/evidenceVariable.js');
        return EvidenceVariableSerializer;
    }
...
class EvidenceModelCharacteristicSerializer {
    static propertyToSerializerMap = {
        ...
        variable: (value, context) => {
            initializeSerializers('EvidenceVariable');
            return FhirResourceSerializer.serializeArray(value, EvidenceVariableSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EvidenceModelCharacteristicSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EvidenceModelCharacteristicSerializer.propertyToSerializerMap) {
                if (EvidenceModelCharacteristicSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EvidenceModelCharacteristicSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = EvidenceModelCharacteristicSerializer;

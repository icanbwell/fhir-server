...
class CodeSystemFilterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CodeSystemFilterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CodeSystemFilterSerializer.propertyToSerializerMap) {
                if (CodeSystemFilterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CodeSystemFilterSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CodeSystemFilterSerializer;

...
class StructureMapInputSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => StructureMapInputSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in StructureMapInputSerializer.propertyToSerializerMap) {
                if (StructureMapInputSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = StructureMapInputSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = StructureMapInputSerializer;

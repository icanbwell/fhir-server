...
class CapabilityStatementOperationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CapabilityStatementOperationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CapabilityStatementOperationSerializer.propertyToSerializerMap) {
                if (CapabilityStatementOperationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CapabilityStatementOperationSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CapabilityStatementOperationSerializer;

...
class CodeSystemDesignationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CodeSystemDesignationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CodeSystemDesignationSerializer.propertyToSerializerMap) {
                if (CodeSystemDesignationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CodeSystemDesignationSerializer.propertyToSerializerMap[propertyName](value, context);

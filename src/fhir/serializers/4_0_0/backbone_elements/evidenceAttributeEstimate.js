...
class EvidenceAttributeEstimateSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EvidenceAttributeEstimateSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EvidenceAttributeEstimateSerializer.propertyToSerializerMap) {
                if (EvidenceAttributeEstimateSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EvidenceAttributeEstimateSerializer.propertyToSerializerMap[propertyName](value, context);

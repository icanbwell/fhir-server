...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ClaimResponseDetail' && !ClaimResponseDetailSerializer) {
        ClaimResponseDetailSerializer = require('../backbone_elements/claimResponseDetail.js');
        return ClaimResponseDetailSerializer;
    }
}

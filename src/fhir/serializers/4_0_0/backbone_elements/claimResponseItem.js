...
/** @type {import('../backbone_elements/claimResponseDetail.js')} */
let ClaimResponseDetail;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ClaimResponseDetail' && !ClaimResponseDetail) {
        ClaimResponseDetail = require('../backbone_elements/claimResponseDetail.js');
...
class ClaimResponseItemSerializer {
    static propertyToSerializerMap = {
        ...
        detail: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ClaimResponseDetail);
        }
    };

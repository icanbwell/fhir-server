...
class TaskRestrictionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TaskRestrictionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TaskRestrictionSerializer.propertyToSerializerMap) {
                if (TaskRestrictionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TaskRestrictionSerializer.propertyToSerializerMap[propertyName](value, context);

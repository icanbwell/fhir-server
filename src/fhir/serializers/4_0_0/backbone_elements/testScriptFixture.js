...
class TestScriptFixtureSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestScriptFixtureSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestScriptFixtureSerializer.propertyToSerializerMap) {
                if (TestScriptFixtureSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestScriptFixtureSerializer.propertyToSerializerMap[propertyName](value, context);

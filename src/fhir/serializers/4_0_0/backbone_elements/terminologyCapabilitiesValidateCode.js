...
class TerminologyCapabilitiesValidateCodeSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TerminologyCapabilitiesValidateCodeSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TerminologyCapabilitiesValidateCodeSerializer.propertyToSerializerMap) {
                if (TerminologyCapabilitiesValidateCodeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TerminologyCapabilitiesValidateCodeSerializer.propertyToSerializerMap[propertyName](value);

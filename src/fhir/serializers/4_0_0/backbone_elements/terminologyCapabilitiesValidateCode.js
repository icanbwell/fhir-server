...
class TerminologyCapabilitiesValidateCodeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TerminologyCapabilitiesValidateCodeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TerminologyCapabilitiesValidateCodeSerializer.propertyToSerializerMap) {
                if (TerminologyCapabilitiesValidateCodeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TerminologyCapabilitiesValidateCodeSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = TerminologyCapabilitiesValidateCodeSerializer;

...
/** @type {import('../backbone_elements/questionnaireResponseItem.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'QuestionnaireResponseItem' && !QuestionnaireResponseItemSerializer) {
        QuestionnaireResponseItemSerializer = require('../backbone_elements/questionnaireResponseItem.js');
        return QuestionnaireResponseItemSerializer;
    }
}
...
class QuestionnaireResponseAnswerSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => QuestionnaireResponseAnswerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in QuestionnaireResponseAnswerSerializer.propertyToSerializerMap) {
                if (QuestionnaireResponseAnswerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = QuestionnaireResponseAnswerSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = QuestionnaireResponseAnswerSerializer;

...
class TestReportParticipantSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestReportParticipantSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestReportParticipantSerializer.propertyToSerializerMap) {
                if (TestReportParticipantSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestReportParticipantSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = TestReportParticipantSerializer;

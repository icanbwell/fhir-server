...
class TestReportParticipantSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestReportParticipantSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestReportParticipantSerializer.propertyToSerializerMap) {
                if (TestReportParticipantSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestReportParticipantSerializer.propertyToSerializerMap[propertyName](value);

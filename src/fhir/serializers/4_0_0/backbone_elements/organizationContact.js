...
class OrganizationContactSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => OrganizationContactSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in OrganizationContactSerializer.propertyToSerializerMap) {
                if (OrganizationContactSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = OrganizationContactSerializer.propertyToSerializerMap[propertyName](value, context);

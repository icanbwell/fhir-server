...
class CapabilityStatementDocumentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CapabilityStatementDocumentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CapabilityStatementDocumentSerializer.propertyToSerializerMap) {
                if (CapabilityStatementDocumentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CapabilityStatementDocumentSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CapabilityStatementDocumentSerializer;

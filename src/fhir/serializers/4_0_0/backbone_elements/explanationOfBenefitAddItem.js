...
let ExplanationOfBenefitDetail1;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ExplanationOfBenefitDetail1' && !ExplanationOfBenefitDetail1) {
        ExplanationOfBenefitDetail1 = require('../backbone_elements/explanationOfBenefitDetail1.js');
...
class ExplanationOfBenefitAddItemSerializer {
    static propertyToSerializerMap = {
        ...
        detail: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ExplanationOfBenefitDetail1);
        }
    };

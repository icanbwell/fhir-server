...
class TerminologyCapabilitiesSoftwareSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TerminologyCapabilitiesSoftwareSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TerminologyCapabilitiesSoftwareSerializer.propertyToSerializerMap) {
                if (TerminologyCapabilitiesSoftwareSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TerminologyCapabilitiesSoftwareSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = TerminologyCapabilitiesSoftwareSerializer;

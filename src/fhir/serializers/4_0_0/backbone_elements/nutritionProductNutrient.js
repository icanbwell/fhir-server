...
class NutritionProductNutrientSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => NutritionProductNutrientSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in NutritionProductNutrientSerializer.propertyToSerializerMap) {
                if (NutritionProductNutrientSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = NutritionProductNutrientSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ExplanationOfBenefitCareTeamSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ExplanationOfBenefitCareTeamSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ExplanationOfBenefitCareTeamSerializer.propertyToSerializerMap) {
                if (ExplanationOfBenefitCareTeamSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ExplanationOfBenefitCareTeamSerializer.propertyToSerializerMap[propertyName](value, context);

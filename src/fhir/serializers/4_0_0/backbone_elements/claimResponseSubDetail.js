...
class ClaimResponseSubDetailSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimResponseSubDetailSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimResponseSubDetailSerializer.propertyToSerializerMap) {
                if (ClaimResponseSubDetailSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimResponseSubDetailSerializer.propertyToSerializerMap[propertyName](value, context);

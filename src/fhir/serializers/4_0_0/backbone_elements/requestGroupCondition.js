...
class RequestGroupConditionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => RequestGroupConditionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in RequestGroupConditionSerializer.propertyToSerializerMap) {
                if (RequestGroupConditionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = RequestGroupConditionSerializer.propertyToSerializerMap[propertyName](value, context);

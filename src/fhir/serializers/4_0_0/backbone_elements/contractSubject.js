...
class ContractSubjectSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ContractSubjectSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ContractSubjectSerializer.propertyToSerializerMap) {
                if (ContractSubjectSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ContractSubjectSerializer.propertyToSerializerMap[propertyName](value, context);

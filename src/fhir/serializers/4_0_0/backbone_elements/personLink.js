...
class PersonLinkSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PersonLinkSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PersonLinkSerializer.propertyToSerializerMap) {
                if (PersonLinkSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PersonLinkSerializer.propertyToSerializerMap[propertyName](value, context);

...
class EvidenceVariableCategorySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EvidenceVariableCategorySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EvidenceVariableCategorySerializer.propertyToSerializerMap) {
                if (EvidenceVariableCategorySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EvidenceVariableCategorySerializer.propertyToSerializerMap[propertyName](value, context);

...
class CitationPublishedInSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationPublishedInSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationPublishedInSerializer.propertyToSerializerMap) {
                if (CitationPublishedInSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationPublishedInSerializer.propertyToSerializerMap[propertyName](value, context);

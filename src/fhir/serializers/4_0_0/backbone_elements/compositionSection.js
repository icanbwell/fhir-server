...
class CompositionSectionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CompositionSectionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CompositionSectionSerializer.propertyToSerializerMap) {
                if (CompositionSectionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CompositionSectionSerializer.propertyToSerializerMap[propertyName](value, context);

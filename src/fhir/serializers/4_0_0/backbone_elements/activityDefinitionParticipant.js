...
class ActivityDefinitionParticipantSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ActivityDefinitionParticipantSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ActivityDefinitionParticipantSerializer.propertyToSerializerMap) {
                if (ActivityDefinitionParticipantSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ActivityDefinitionParticipantSerializer.propertyToSerializerMap[propertyName](value, context);

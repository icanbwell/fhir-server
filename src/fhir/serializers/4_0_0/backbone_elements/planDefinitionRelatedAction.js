...
class PlanDefinitionRelatedActionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PlanDefinitionRelatedActionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PlanDefinitionRelatedActionSerializer.propertyToSerializerMap) {
                if (PlanDefinitionRelatedActionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PlanDefinitionRelatedActionSerializer.propertyToSerializerMap[propertyName](value, context);

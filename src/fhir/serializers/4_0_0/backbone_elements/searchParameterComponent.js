...
class SearchParameterComponentSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SearchParameterComponentSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SearchParameterComponentSerializer.propertyToSerializerMap) {
                if (SearchParameterComponentSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SearchParameterComponentSerializer.propertyToSerializerMap[propertyName](value, context);

...
class SupplyRequestParameterSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SupplyRequestParameterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SupplyRequestParameterSerializer.propertyToSerializerMap) {
                if (SupplyRequestParameterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SupplyRequestParameterSerializer.propertyToSerializerMap[propertyName](value, context);

...
class NutritionOrderTextureSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => NutritionOrderTextureSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in NutritionOrderTextureSerializer.propertyToSerializerMap) {
                if (NutritionOrderTextureSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = NutritionOrderTextureSerializer.propertyToSerializerMap[propertyName](value, context);

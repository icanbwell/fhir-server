...
class CoverageEligibilityRequestInsuranceSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CoverageEligibilityRequestInsuranceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CoverageEligibilityRequestInsuranceSerializer.propertyToSerializerMap) {
                if (CoverageEligibilityRequestInsuranceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CoverageEligibilityRequestInsuranceSerializer.propertyToSerializerMap[propertyName](value, context);

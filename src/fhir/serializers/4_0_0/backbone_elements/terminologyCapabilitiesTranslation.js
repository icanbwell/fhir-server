...
class TerminologyCapabilitiesTranslationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TerminologyCapabilitiesTranslationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TerminologyCapabilitiesTranslationSerializer.propertyToSerializerMap) {
                if (TerminologyCapabilitiesTranslationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TerminologyCapabilitiesTranslationSerializer.propertyToSerializerMap[propertyName](value, context);

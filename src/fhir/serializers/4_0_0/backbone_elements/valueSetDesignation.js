...
class ValueSetDesignationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ValueSetDesignationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ValueSetDesignationSerializer.propertyToSerializerMap) {
                if (ValueSetDesignationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ValueSetDesignationSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'AdverseEventCausality' && !AdverseEventCausalitySerializer) {
        AdverseEventCausalitySerializer = require('../backbone_elements/adverseEventCausality.js');
        return AdverseEventCausalitySerializer;
    }
}
...
class AdverseEventSuspectEntitySerializer {
    static propertyToSerializerMap = {
        ...
        causality: (value, context) => {
            initializeSerializers('AdverseEventCausality');
            return FhirResourceSerializer.serializeArray(value, AdverseEventCausalitySerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AdverseEventSuspectEntitySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AdverseEventSuspectEntitySerializer.propertyToSerializerMap) {
                if (AdverseEventSuspectEntitySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AdverseEventSuspectEntitySerializer.propertyToSerializerMap[propertyName](value, context);

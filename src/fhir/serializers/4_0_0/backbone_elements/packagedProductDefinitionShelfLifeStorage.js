...
class PackagedProductDefinitionShelfLifeStorageSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PackagedProductDefinitionShelfLifeStorageSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PackagedProductDefinitionShelfLifeStorageSerializer.propertyToSerializerMap) {
                if (PackagedProductDefinitionShelfLifeStorageSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PackagedProductDefinitionShelfLifeStorageSerializer.propertyToSerializerMap[propertyName](value, context);

...
class HealthcareServiceEligibilitySerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => HealthcareServiceEligibilitySerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in HealthcareServiceEligibilitySerializer.propertyToSerializerMap) {
                if (HealthcareServiceEligibilitySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = HealthcareServiceEligibilitySerializer.propertyToSerializerMap[propertyName](value);

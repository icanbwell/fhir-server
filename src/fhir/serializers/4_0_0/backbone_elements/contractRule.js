...
class ContractRuleSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ContractRuleSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ContractRuleSerializer.propertyToSerializerMap) {
                if (ContractRuleSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ContractRuleSerializer.propertyToSerializerMap[propertyName](value, context);

...
class AdministrableProductDefinitionWithdrawalPeriodSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AdministrableProductDefinitionWithdrawalPeriodSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AdministrableProductDefinitionWithdrawalPeriodSerializer.propertyToSerializerMap) {
                if (AdministrableProductDefinitionWithdrawalPeriodSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AdministrableProductDefinitionWithdrawalPeriodSerializer.propertyToSerializerMap[propertyName](value, context);

...
class MedicinalProductDefinitionNamePartSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicinalProductDefinitionNamePartSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicinalProductDefinitionNamePartSerializer.propertyToSerializerMap) {
                if (MedicinalProductDefinitionNamePartSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicinalProductDefinitionNamePartSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MedicinalProductDefinitionNamePartSerializer;

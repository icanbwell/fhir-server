...
const AdministrableProductDefinitionWithdrawalPeriodSerializer = require('../backbone_elements/administrableProductDefinitionWithdrawalPeriod.js');
...
class AdministrableProductDefinitionTargetSpeciesSerializer {
    static propertyToSerializerMap = {
        ...
        withdrawalPeriod: (value) => AdministrableProductDefinitionWithdrawalPeriodSerializer.serialize(value)
    };

...
class QuestionnaireInitialSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => QuestionnaireInitialSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in QuestionnaireInitialSerializer.propertyToSerializerMap) {
                if (QuestionnaireInitialSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = QuestionnaireInitialSerializer.propertyToSerializerMap[propertyName](value, context);

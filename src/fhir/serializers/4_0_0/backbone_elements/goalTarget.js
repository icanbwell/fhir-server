...
class GoalTargetSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GoalTargetSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GoalTargetSerializer.propertyToSerializerMap) {
                if (GoalTargetSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GoalTargetSerializer.propertyToSerializerMap[propertyName](value, context);

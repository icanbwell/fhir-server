...
class DeviceUdiCarrierSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceUdiCarrierSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceUdiCarrierSerializer.propertyToSerializerMap) {
                if (DeviceUdiCarrierSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceUdiCarrierSerializer.propertyToSerializerMap[propertyName](value, context);

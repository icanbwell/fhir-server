...
class TestReportOperationSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestReportOperationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestReportOperationSerializer.propertyToSerializerMap) {
                if (TestReportOperationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestReportOperationSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = TestReportOperationSerializer;

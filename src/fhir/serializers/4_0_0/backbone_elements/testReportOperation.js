...
class TestReportOperationSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TestReportOperationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TestReportOperationSerializer.propertyToSerializerMap) {
                if (TestReportOperationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TestReportOperationSerializer.propertyToSerializerMap[propertyName](value);

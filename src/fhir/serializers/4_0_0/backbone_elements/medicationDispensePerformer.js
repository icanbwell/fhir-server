...
class MedicationDispensePerformerSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationDispensePerformerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationDispensePerformerSerializer.propertyToSerializerMap) {
                if (MedicationDispensePerformerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationDispensePerformerSerializer.propertyToSerializerMap[propertyName](value, context);

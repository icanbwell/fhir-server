...
let CoverageEligibilityResponseBenefit;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CoverageEligibilityResponseBenefit' && !CoverageEligibilityResponseBenefit) {
        CoverageEligibilityResponseBenefit = require('../backbone_elements/coverageEligibilityResponseBenefit.js');
...
class CoverageEligibilityResponseItemSerializer {
    static propertyToSerializerMap = {
        ...
        benefit: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CoverageEligibilityResponseBenefit);
        },

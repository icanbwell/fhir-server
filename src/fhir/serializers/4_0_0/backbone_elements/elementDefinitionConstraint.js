...
class ElementDefinitionConstraintSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ElementDefinitionConstraintSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ElementDefinitionConstraintSerializer.propertyToSerializerMap) {
                if (ElementDefinitionConstraintSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ElementDefinitionConstraintSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = ElementDefinitionConstraintSerializer;

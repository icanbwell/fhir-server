...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MeasureReportPopulation' && !MeasureReportPopulation) {
        MeasureReportPopulation = require('../backbone_elements/measureReportPopulation.js');
    ...
    if (serializerName === 'MeasureReportStratifier' && !MeasureReportStratifier) {
        MeasureReportStratifier = require('../backbone_elements/measureReportStratifier.js');
...
class MeasureReportGroupSerializer {
    static propertyToSerializerMap = {
        ...
        population: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MeasureReportPopulation);
        },
        measureScore: (value) => {
        ...
        stratifier: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MeasureReportStratifier);
        }
    };

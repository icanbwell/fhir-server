...
class EvidenceReportRelatesToSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EvidenceReportRelatesToSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EvidenceReportRelatesToSerializer.propertyToSerializerMap) {
                if (EvidenceReportRelatesToSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EvidenceReportRelatesToSerializer.propertyToSerializerMap[propertyName](value, context);

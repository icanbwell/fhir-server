...
class ClaimPayeeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ClaimPayeeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ClaimPayeeSerializer.propertyToSerializerMap) {
                if (ClaimPayeeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ClaimPayeeSerializer.propertyToSerializerMap[propertyName](value, context);

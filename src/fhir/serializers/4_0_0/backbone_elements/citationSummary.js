...
class CitationSummarySerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationSummarySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationSummarySerializer.propertyToSerializerMap) {
                if (CitationSummarySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationSummarySerializer.propertyToSerializerMap[propertyName](value, context);

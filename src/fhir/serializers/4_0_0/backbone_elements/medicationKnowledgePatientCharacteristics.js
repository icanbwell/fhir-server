...
class MedicationKnowledgePatientCharacteristicsSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationKnowledgePatientCharacteristicsSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationKnowledgePatientCharacteristicsSerializer.propertyToSerializerMap) {
                if (MedicationKnowledgePatientCharacteristicsSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationKnowledgePatientCharacteristicsSerializer.propertyToSerializerMap[propertyName](value, context);

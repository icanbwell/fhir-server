...
class ConsentActorSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ConsentActorSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ConsentActorSerializer.propertyToSerializerMap) {
                if (ConsentActorSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ConsentActorSerializer.propertyToSerializerMap[propertyName](value, context);

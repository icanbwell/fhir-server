...
class ResearchStudyArmSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ResearchStudyArmSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ResearchStudyArmSerializer.propertyToSerializerMap) {
                if (ResearchStudyArmSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ResearchStudyArmSerializer.propertyToSerializerMap[propertyName](value, context);

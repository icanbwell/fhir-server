...
let ExplanationOfBenefitDetail;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ExplanationOfBenefitDetail' && !ExplanationOfBenefitDetail) {
        ExplanationOfBenefitDetail = require('../backbone_elements/explanationOfBenefitDetail.js');
...
class ExplanationOfBenefitItemSerializer {
    static propertyToSerializerMap = {
        ...
        detail: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ExplanationOfBenefitDetail);
        }
    };

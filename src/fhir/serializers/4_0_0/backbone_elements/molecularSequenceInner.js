...
class MolecularSequenceInnerSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MolecularSequenceInnerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MolecularSequenceInnerSerializer.propertyToSerializerMap) {
                if (MolecularSequenceInnerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MolecularSequenceInnerSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = MolecularSequenceInnerSerializer;

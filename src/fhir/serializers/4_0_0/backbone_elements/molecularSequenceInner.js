...
class MolecularSequenceInnerSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MolecularSequenceInnerSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MolecularSequenceInnerSerializer.propertyToSerializerMap) {
                if (MolecularSequenceInnerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MolecularSequenceInnerSerializer.propertyToSerializerMap[propertyName](value);

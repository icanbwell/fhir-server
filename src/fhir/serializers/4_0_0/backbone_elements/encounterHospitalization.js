...
class EncounterHospitalizationSerializer {
    static propertyToSerializerMap = {
        ...
        preAdmissionIdentifier: (value, context) => {
        ...
        dischargeDisposition: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EncounterHospitalizationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EncounterHospitalizationSerializer.propertyToSerializerMap) {
                if (EncounterHospitalizationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EncounterHospitalizationSerializer.propertyToSerializerMap[propertyName](value, context);

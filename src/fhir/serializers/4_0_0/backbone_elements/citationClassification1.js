...
/** @type {import('../backbone_elements/citationWhoClassified.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CitationWhoClassified' && !CitationWhoClassifiedSerializer) {
        CitationWhoClassifiedSerializer = require('../backbone_elements/citationWhoClassified.js');
        return CitationWhoClassifiedSerializer;
    }
}
...
class CitationClassification1Serializer {
    static propertyToSerializerMap = {
        ...
        whoClassified: (value, context) => {
            initializeSerializers('CitationWhoClassified');
            return FhirResourceSerializer.serialize(value, CitationWhoClassifiedSerializer, context);
        }
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationClassification1Serializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationClassification1Serializer.propertyToSerializerMap) {
                if (CitationClassification1Serializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationClassification1Serializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = CitationClassification1Serializer;

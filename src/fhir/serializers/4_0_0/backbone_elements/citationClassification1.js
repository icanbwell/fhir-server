...
class CitationClassification1Serializer {
    static propertyToSerializerMap = {
        ...
        whoClassified: (value) => {
            ...
            return FhirResourceSerializer.serialize(value, CitationWhoClassifiedSerializer);
        }
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationClassification1Serializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationClassification1Serializer.propertyToSerializerMap) {
                if (CitationClassification1Serializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationClassification1Serializer.propertyToSerializerMap[propertyName](value);

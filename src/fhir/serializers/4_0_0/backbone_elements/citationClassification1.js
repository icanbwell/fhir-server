...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CitationWhoClassified' && !CitationWhoClassified) {
        CitationWhoClassified = require('../backbone_elements/citationWhoClassified.js');
...
class CitationClassification1Serializer {
    static propertyToSerializerMap = {
        ...
        whoClassified: (value) => {
            ...
            return FhirResourceSerializer.serialize(value, CitationWhoClassified);
        }
    };

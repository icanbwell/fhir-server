...
class SubstanceDefinitionCodeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubstanceDefinitionCodeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubstanceDefinitionCodeSerializer.propertyToSerializerMap) {
                if (SubstanceDefinitionCodeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubstanceDefinitionCodeSerializer.propertyToSerializerMap[propertyName](value, context);

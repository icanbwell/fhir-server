...
class MedicinalProductDefinitionCrossReferenceSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicinalProductDefinitionCrossReferenceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicinalProductDefinitionCrossReferenceSerializer.propertyToSerializerMap) {
                if (MedicinalProductDefinitionCrossReferenceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicinalProductDefinitionCrossReferenceSerializer.propertyToSerializerMap[propertyName](value, context);

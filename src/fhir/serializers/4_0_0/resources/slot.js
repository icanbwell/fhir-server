...
class SlotSerializer {
    static propertyToSerializerMap = {
        ...
        schedule: (value) => ReferenceSerializer.serialize(value),
        status: null,
        start: null,
        end: null,
        overbooked: null,
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SlotSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SlotSerializer.propertyToSerializerMap) {
                if (SlotSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SlotSerializer.propertyToSerializerMap[propertyName](value);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'AppointmentParticipant' && !AppointmentParticipant) {
        AppointmentParticipant = require('../backbone_elements/appointmentParticipant.js');
...
class AppointmentSerializer {
    static propertyToSerializerMap = {
        ...
        participant: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, AppointmentParticipant);
        },

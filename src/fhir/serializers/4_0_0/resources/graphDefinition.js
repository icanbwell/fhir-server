...
class GraphDefinitionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GraphDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GraphDefinitionSerializer.propertyToSerializerMap) {
                if (GraphDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GraphDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);
...
module.exports = GraphDefinitionSerializer;

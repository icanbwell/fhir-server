...
class MedicationAdministrationSerializer {
    static propertyToSerializerMap = {
        ...
        performer: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MedicationAdministrationPerformerSerializer, context);
        },
        ...
        dosage: (value, context) => {
            ...
            return FhirResourceSerializer.serialize(value, MedicationAdministrationDosageSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationAdministrationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationAdministrationSerializer.propertyToSerializerMap) {
                if (MedicationAdministrationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationAdministrationSerializer.propertyToSerializerMap[propertyName](value, context);

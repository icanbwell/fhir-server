...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MessageDefinitionFocus' && !MessageDefinitionFocus) {
        MessageDefinitionFocus = require('../backbone_elements/messageDefinitionFocus.js');
        return MessageDefinitionFocus;
    }
    if (serializerName === 'MessageDefinitionAllowedResponse' && !MessageDefinitionAllowedResponse) {
        MessageDefinitionAllowedResponse = require('../backbone_elements/messageDefinitionAllowedResponse.js');
...
class MessageDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        focus: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MessageDefinitionFocus);
        },
        responseRequired: null,
        allowedResponse: (value) => {
            initializeSerializers('MessageDefinitionAllowedResponse');
            return FhirResourceSerializer.serializeArray(value, MessageDefinitionAllowedResponse);
        },
        graph: null,
        resourceType: null
    };

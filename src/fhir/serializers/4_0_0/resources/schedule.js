...
class ScheduleSerializer {
    static propertyToSerializerMap = {
        ...
        planningHorizon: (value) => PeriodSerializer.serialize(value),
        comment: null,
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ScheduleSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ScheduleSerializer.propertyToSerializerMap) {
                if (ScheduleSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ScheduleSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = ScheduleSerializer;
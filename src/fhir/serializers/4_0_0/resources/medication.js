...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MedicationIngredient' && !MedicationIngredient) {
        MedicationIngredient = require('../backbone_elements/medicationIngredient.js');
        return MedicationIngredient;
    }
    if (serializerName === 'MedicationBatch' && !MedicationBatch) {
        MedicationBatch = require('../backbone_elements/medicationBatch.js');
...
class MedicationSerializer {
    static propertyToSerializerMap = {
        ...
        ingredient: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MedicationIngredient);
        },
        batch: (value) => {
            initializeSerializers('MedicationBatch');
            return FhirResourceSerializer.serialize(value, MedicationBatch);
        },
        resourceType: null
    };

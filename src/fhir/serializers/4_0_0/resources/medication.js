...
class MedicationSerializer {
    static propertyToSerializerMap = {
        ...
        ingredient: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MedicationIngredientSerializer, context);
        },
        batch: (value, context) => {
            initializeSerializers('MedicationBatch');
            return FhirResourceSerializer.serialize(value, MedicationBatchSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationSerializer.propertyToSerializerMap) {
                if (MedicationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationSerializer.propertyToSerializerMap[propertyName](value, context);

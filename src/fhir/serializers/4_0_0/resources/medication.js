...
let RatioSerializer;
/** @type {import('../backbone_elements/medicationIngredient.js')} */
let MedicationIngredientSerializer;
/** @type {import('../backbone_elements/medicationBatch.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MedicationIngredient' && !MedicationIngredientSerializer) {
        MedicationIngredientSerializer = require('../backbone_elements/medicationIngredient.js');
        return MedicationIngredientSerializer;
    }
    if (serializerName === 'MedicationBatch' && !MedicationBatchSerializer) {
        MedicationBatchSerializer = require('../backbone_elements/medicationBatch.js');
        return MedicationBatchSerializer;
    }
}
...
class MedicationSerializer {
    static propertyToSerializerMap = {
        ...
        ingredient: (value) => {
            initializeSerializers('MedicationIngredient');
            return FhirResourceSerializer.serializeArray(value, MedicationIngredientSerializer);
        },
        batch: (value) => {
            initializeSerializers('MedicationBatch');
            return FhirResourceSerializer.serialize(value, MedicationBatchSerializer);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MedicationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MedicationSerializer.propertyToSerializerMap) {
                if (MedicationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MedicationSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = MedicationSerializer;

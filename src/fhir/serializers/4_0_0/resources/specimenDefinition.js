...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SpecimenDefinitionTypeTested' && !SpecimenDefinitionTypeTested) {
        SpecimenDefinitionTypeTested = require('../backbone_elements/specimenDefinitionTypeTested.js');
...
class SpecimenDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        typeTested: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, SpecimenDefinitionTypeTested);
        },
        resourceType: null
    };

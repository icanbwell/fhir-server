...
class SpecimenDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        typeTested: (value, context) => {
            initializeSerializers('SpecimenDefinitionTypeTested');
            return FhirResourceSerializer.serializeArray(value, SpecimenDefinitionTypeTestedSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SpecimenDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SpecimenDefinitionSerializer.propertyToSerializerMap) {
                if (SpecimenDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SpecimenDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);

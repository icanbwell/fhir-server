...
const SpecimenDefinitionTypeTestedSerializer = require('../backbone_elements/specimenDefinitionTypeTested.js');
...
class SpecimenDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        typeCollected: (value) => CodeableConceptSerializer.serialize(value),
        patientPreparation: (value) => CodeableConceptSerializer.serialize(value),
        timeAspect: null,
        collection: (value) => CodeableConceptSerializer.serialize(value),
        typeTested: (value) => SpecimenDefinitionTypeTestedSerializer.serialize(value),
        resourceType: null
    };

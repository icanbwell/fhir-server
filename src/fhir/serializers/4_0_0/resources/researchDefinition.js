...
class ResearchDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        exposure: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serialize(value, ReferenceSerializer, context);
        },
        exposureAlternative: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serialize(value, ReferenceSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ResearchDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ResearchDefinitionSerializer.propertyToSerializerMap) {
                if (ResearchDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ResearchDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);

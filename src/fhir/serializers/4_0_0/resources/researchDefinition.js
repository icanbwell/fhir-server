...
class ResearchDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        exposure: (value) => ReferenceSerializer.serialize(value),
        exposureAlternative: (value) => ReferenceSerializer.serialize(value),
        outcome: (value) => ReferenceSerializer.serialize(value),
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ResearchDefinitionSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ResearchDefinitionSerializer.propertyToSerializerMap) {
                if (ResearchDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ResearchDefinitionSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = ResearchDefinitionSerializer;
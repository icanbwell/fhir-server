...
class PersonSerializer {
    static propertyToSerializerMap = {
        ...
        link: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, PersonLinkSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PersonSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PersonSerializer.propertyToSerializerMap) {
                if (PersonSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PersonSerializer.propertyToSerializerMap[propertyName](value, context);

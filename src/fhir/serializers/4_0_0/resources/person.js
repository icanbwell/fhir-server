...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'PersonLink' && !PersonLink) {
        PersonLink = require('../backbone_elements/personLink.js');
        return PersonLink;
    }
}
...
class PersonSerializer {
    static propertyToSerializerMap = {
        ...
        link: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, PersonLink);
        },
        resourceType: null
    };

...
let ContactPoint;
/** @type {import('../backbone_elements/subscriptionChannel.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SubscriptionChannel' && !SubscriptionChannel) {
        SubscriptionChannel = require('../backbone_elements/subscriptionChannel.js');
...
class SubscriptionSerializer {
    static propertyToSerializerMap = {
        ...
        channel: (value) => {
            ...
            return FhirResourceSerializer.serialize(value, SubscriptionChannel);
        },
        resourceType: null
    };

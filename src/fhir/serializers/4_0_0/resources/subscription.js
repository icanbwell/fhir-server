...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SubscriptionChannel' && !SubscriptionChannelSerializer) {
        SubscriptionChannelSerializer = require('../backbone_elements/subscriptionChannel.js');
        return SubscriptionChannelSerializer;
    }
}

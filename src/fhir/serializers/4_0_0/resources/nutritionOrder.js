...
class NutritionOrderSerializer {
    static propertyToSerializerMap = {
        ...
        dateTime: null,
        orderer: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serialize(value, ReferenceSerializer, context);
        },
        allergyIntolerance: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serializeArray(value, ReferenceSerializer, context);
        },
        foodPreferenceModifier: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConceptSerializer, context);
        },
        excludeFoodModifier: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConceptSerializer, context);
        },
        oralDiet: (value, context) => {
            initializeSerializers('NutritionOrderOralDiet');
            return FhirResourceSerializer.serialize(value, NutritionOrderOralDietSerializer, context);
        },
        supplement: (value, context) => {
            initializeSerializers('NutritionOrderSupplement');
            return FhirResourceSerializer.serializeArray(value, NutritionOrderSupplementSerializer, context);
        },
        enteralFormula: (value, context) => {
            initializeSerializers('NutritionOrderEnteralFormula');
            return FhirResourceSerializer.serialize(value, NutritionOrderEnteralFormulaSerializer, context);
        },
        note: (value, context) => {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => NutritionOrderSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in NutritionOrderSerializer.propertyToSerializerMap) {
                if (NutritionOrderSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = NutritionOrderSerializer.propertyToSerializerMap[propertyName](value, context);

...
/** @type {import('../backbone_elements/measureGroup.js')} */
let MeasureGroupSerializer;
/** @type {import('../backbone_elements/measureSupplementalData.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MeasureGroup' && !MeasureGroupSerializer) {
        MeasureGroupSerializer = require('../backbone_elements/measureGroup.js');
        return MeasureGroupSerializer;
    }
    if (serializerName === 'MeasureSupplementalData' && !MeasureSupplementalDataSerializer) {
        MeasureSupplementalDataSerializer = require('../backbone_elements/measureSupplementalData.js');
        return MeasureSupplementalDataSerializer;
    }
}
...
class MeasureSerializer {
    static propertyToSerializerMap = {
        ...
        compositeScoring: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        },
        type: (value, context) => {
        ...
        guidance: null,
        group: (value, context) => {
            initializeSerializers('MeasureGroup');
            return FhirResourceSerializer.serializeArray(value, MeasureGroupSerializer, context);
        },
        supplementalData: (value, context) => {
            initializeSerializers('MeasureSupplementalData');
            return FhirResourceSerializer.serializeArray(value, MeasureSupplementalDataSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MeasureSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MeasureSerializer.propertyToSerializerMap) {
                if (MeasureSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MeasureSerializer.propertyToSerializerMap[propertyName](value, context);

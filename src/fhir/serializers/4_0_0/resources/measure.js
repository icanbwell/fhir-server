...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MeasureGroup' && !MeasureGroup) {
        MeasureGroup = require('../backbone_elements/measureGroup.js');
        return MeasureGroup;
    }
    if (serializerName === 'MeasureSupplementalData' && !MeasureSupplementalData) {
        MeasureSupplementalData = require('../backbone_elements/measureSupplementalData.js');
...
class MeasureSerializer {
    static propertyToSerializerMap = {
        ...
        group: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MeasureGroup);
        },
        supplementalData: (value) => {
            initializeSerializers('MeasureSupplementalData');
            return FhirResourceSerializer.serializeArray(value, MeasureSupplementalData);
        },
        resourceType: null
    };

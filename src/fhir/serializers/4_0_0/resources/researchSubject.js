...
class ResearchSubjectSerializer {
    static propertyToSerializerMap = {
        ...
        assignedArm: null,
        actualArm: null,
        consent: (value) => ReferenceSerializer.serialize(value),
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ResearchSubjectSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ResearchSubjectSerializer.propertyToSerializerMap) {
                if (ResearchSubjectSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ResearchSubjectSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = ResearchSubjectSerializer;
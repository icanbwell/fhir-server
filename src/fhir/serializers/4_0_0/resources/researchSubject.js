...
class ResearchSubjectSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ResearchSubjectSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ResearchSubjectSerializer.propertyToSerializerMap) {
                if (ResearchSubjectSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ResearchSubjectSerializer.propertyToSerializerMap[propertyName](value, context);

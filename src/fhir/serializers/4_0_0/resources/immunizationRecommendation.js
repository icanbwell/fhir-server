...
/** @type {import('../backbone_elements/immunizationRecommendationRecommendation.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ImmunizationRecommendationRecommendation' && !ImmunizationRecommendationRecommendationSerializer) {
        ImmunizationRecommendationRecommendationSerializer = require('../backbone_elements/immunizationRecommendationRecommendation.js');
        return ImmunizationRecommendationRecommendationSerializer;
    }
}
...
class ImmunizationRecommendationSerializer {
    static propertyToSerializerMap = {
        ...
        recommendation: (value) => {
            initializeSerializers('ImmunizationRecommendationRecommendation');
            return FhirResourceSerializer.serializeArray(value, ImmunizationRecommendationRecommendationSerializer);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImmunizationRecommendationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImmunizationRecommendationSerializer.propertyToSerializerMap) {
                if (ImmunizationRecommendationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImmunizationRecommendationSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = ImmunizationRecommendationSerializer;

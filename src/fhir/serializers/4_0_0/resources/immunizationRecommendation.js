...
class ImmunizationRecommendationSerializer {
    static propertyToSerializerMap = {
        ...
        recommendation: (value, context) => {
            initializeSerializers('ImmunizationRecommendationRecommendation');
            return FhirResourceSerializer.serializeArray(value, ImmunizationRecommendationRecommendationSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImmunizationRecommendationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImmunizationRecommendationSerializer.propertyToSerializerMap) {
                if (ImmunizationRecommendationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImmunizationRecommendationSerializer.propertyToSerializerMap[propertyName](value, context);

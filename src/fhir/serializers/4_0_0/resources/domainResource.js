...
class DomainResourceSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DomainResourceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DomainResourceSerializer.propertyToSerializerMap) {
                if (DomainResourceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DomainResourceSerializer.propertyToSerializerMap[propertyName](value, context);

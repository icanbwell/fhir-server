...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CoverageEligibilityRequestSupportingInfo' && !CoverageEligibilityRequestSupportingInfo) {
        CoverageEligibilityRequestSupportingInfo = require('../backbone_elements/coverageEligibilityRequestSupportingInfo.js');
        return CoverageEligibilityRequestSupportingInfo;
    }
    if (serializerName === 'CoverageEligibilityRequestInsurance' && !CoverageEligibilityRequestInsurance) {
        CoverageEligibilityRequestInsurance = require('../backbone_elements/coverageEligibilityRequestInsurance.js');
        return CoverageEligibilityRequestInsurance;
    }
    if (serializerName === 'CoverageEligibilityRequestItem' && !CoverageEligibilityRequestItem) {
        CoverageEligibilityRequestItem = require('../backbone_elements/coverageEligibilityRequestItem.js');
...
class CoverageEligibilityRequestSerializer {
    static propertyToSerializerMap = {
        ...
        supportingInfo: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CoverageEligibilityRequestSupportingInfo);
        },
        insurance: (value) => {
            initializeSerializers('CoverageEligibilityRequestInsurance');
            return FhirResourceSerializer.serializeArray(value, CoverageEligibilityRequestInsurance);
        },
        item: (value) => {
            initializeSerializers('CoverageEligibilityRequestItem');
            return FhirResourceSerializer.serializeArray(value, CoverageEligibilityRequestItem);
        },
        resourceType: null
    };

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'RiskAssessmentPrediction' && !RiskAssessmentPrediction) {
        RiskAssessmentPrediction = require('../backbone_elements/riskAssessmentPrediction.js');
...
class RiskAssessmentSerializer {
    static propertyToSerializerMap = {
        ...
        prediction: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, RiskAssessmentPrediction);
        },
        mitigation: null,
        note: (value) => {

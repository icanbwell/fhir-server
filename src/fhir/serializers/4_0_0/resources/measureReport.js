...
/** @type {import('../backbone_elements/measureReportGroup.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MeasureReportGroup' && !MeasureReportGroupSerializer) {
        MeasureReportGroupSerializer = require('../backbone_elements/measureReportGroup.js');
        return MeasureReportGroupSerializer;
    }
}
...
module.exports = MeasureReportSerializer;

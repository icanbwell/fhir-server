...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'MeasureReportGroup' && !MeasureReportGroup) {
        MeasureReportGroup = require('../backbone_elements/measureReportGroup.js');
...
class MeasureReportSerializer {
    static propertyToSerializerMap = {
        ...
        group: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, MeasureReportGroup);
        },

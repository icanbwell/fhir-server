...
const MeasureReportGroupSerializer = require('../backbone_elements/measureReportGroup.js');
...
class MeasureReportSerializer {
    static propertyToSerializerMap = {
        ...
        date: null,
        reporter: (value) => ReferenceSerializer.serialize(value),
        period: (value) => PeriodSerializer.serialize(value),
        improvementNotation: (value) => CodeableConceptSerializer.serialize(value),
        group: (value) => MeasureReportGroupSerializer.serialize(value),
        evaluatedResource: (value) => ReferenceSerializer.serialize(value),
        resourceType: null
    };

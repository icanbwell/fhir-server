...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CareTeamParticipant' && !CareTeamParticipant) {
        CareTeamParticipant = require('../backbone_elements/careTeamParticipant.js');
...
class CareTeamSerializer {
    static propertyToSerializerMap = {
        ...
        participant: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CareTeamParticipant);
        },
        reasonCode: (value) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConcept);

...
class CareTeamSerializer {
    static propertyToSerializerMap = {
        ...
        participant: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CareTeamParticipantSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CareTeamSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CareTeamSerializer.propertyToSerializerMap) {
                if (CareTeamSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CareTeamSerializer.propertyToSerializerMap[propertyName](value, context);

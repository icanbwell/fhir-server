...
/** @type {import('../backbone_elements/careTeamParticipant.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CareTeamParticipant' && !CareTeamParticipantSerializer) {
        CareTeamParticipantSerializer = require('../backbone_elements/careTeamParticipant.js');
        return CareTeamParticipantSerializer;
    }
...
class CareTeamSerializer {
    static propertyToSerializerMap = {
        ...
        participant: (value) => {
            initializeSerializers('CareTeamParticipant');
            return FhirResourceSerializer.serializeArray(value, CareTeamParticipantSerializer);
        },
        reasonCode: (value) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConceptSerializer);
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CareTeamSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CareTeamSerializer.propertyToSerializerMap) {
                if (CareTeamSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CareTeamSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = CareTeamSerializer;

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SupplyRequestParameter' && !SupplyRequestParameter) {
        SupplyRequestParameter = require('../backbone_elements/supplyRequestParameter.js');
...
class SupplyRequestSerializer {
    static propertyToSerializerMap = {
        ...
        parameter: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, SupplyRequestParameter);
        },

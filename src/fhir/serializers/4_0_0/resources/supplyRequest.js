...
class SupplyRequestSerializer {
    static propertyToSerializerMap = {
        ...
        priority: null,
        itemCodeableConcept: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConceptSerializer, context);
        },
        itemReference: (value, context) => {
        ...
        parameter: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, SupplyRequestParameterSerializer, context);
        },
        ...
        deliverFrom: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serialize(value, ReferenceSerializer, context);
        },
        deliverTo: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serialize(value, ReferenceSerializer, context);
        },
        resourceType: null
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SupplyRequestSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SupplyRequestSerializer.propertyToSerializerMap) {
                if (SupplyRequestSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SupplyRequestSerializer.propertyToSerializerMap[propertyName](value, context);

...
const VisionPrescriptionLensSpecificationSerializer = require('../backbone_elements/visionPrescriptionLensSpecification.js');
...
class VisionPrescriptionSerializer {
    static propertyToSerializerMap = {
        ...
        dateWritten: null,
        prescriber: (value) => ReferenceSerializer.serialize(value),
        lensSpecification: (value) => VisionPrescriptionLensSpecificationSerializer.serialize(value),
        resourceType: null
    };

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'VisionPrescriptionLensSpecification' && !VisionPrescriptionLensSpecificationSerializer) {
        VisionPrescriptionLensSpecificationSerializer = require('../backbone_elements/visionPrescriptionLensSpecification.js');
        return VisionPrescriptionLensSpecificationSerializer;
    }
}
...
class VisionPrescriptionSerializer {
    static propertyToSerializerMap = {
        ...
        lensSpecification: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, VisionPrescriptionLensSpecificationSerializer);
        },
        resourceType: null
    };

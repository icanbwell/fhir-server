...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'StructureMapStructure' && !StructureMapStructureSerializer) {
        StructureMapStructureSerializer = require('../backbone_elements/structureMapStructure.js');
        return StructureMapStructureSerializer;
    }
    if (serializerName === 'StructureMapGroup' && !StructureMapGroupSerializer) {
        StructureMapGroupSerializer = require('../backbone_elements/structureMapGroup.js');
        return StructureMapGroupSerializer;
    }
}
...
class StructureMapSerializer {
    static propertyToSerializerMap = {
        ...
        structure: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, StructureMapStructureSerializer);
        },
        import: null,
        group: (value) => {
            initializeSerializers('StructureMapGroup');
            return FhirResourceSerializer.serializeArray(value, StructureMapGroupSerializer);
        },
        resourceType: null
    };

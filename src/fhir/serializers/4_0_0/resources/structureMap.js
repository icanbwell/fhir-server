...
class StructureMapSerializer {
    static propertyToSerializerMap = {
        ...
        structure: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, StructureMapStructureSerializer, context);
        },
        import: null,
        group: (value, context) => {
            initializeSerializers('StructureMapGroup');
            return FhirResourceSerializer.serializeArray(value, StructureMapGroupSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => StructureMapSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in StructureMapSerializer.propertyToSerializerMap) {
                if (StructureMapSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = StructureMapSerializer.propertyToSerializerMap[propertyName](value, context);

...
class ValueSetSerializer {
    static propertyToSerializerMap = {
        ...
        purpose: null,
        copyright: null,
        compose: (value, context) => {
            initializeSerializers('ValueSetCompose');
            return FhirResourceSerializer.serialize(value, ValueSetComposeSerializer, context);
        },
        expansion: (value, context) => {
            initializeSerializers('ValueSetExpansion');
            return FhirResourceSerializer.serialize(value, ValueSetExpansionSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ValueSetSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ValueSetSerializer.propertyToSerializerMap) {
                if (ValueSetSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ValueSetSerializer.propertyToSerializerMap[propertyName](value, context);

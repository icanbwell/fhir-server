...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ValueSetCompose' && !ValueSetCompose) {
        ValueSetCompose = require('../backbone_elements/valueSetCompose.js');
        return ValueSetCompose;
    }
    if (serializerName === 'ValueSetExpansion' && !ValueSetExpansion) {
        ValueSetExpansion = require('../backbone_elements/valueSetExpansion.js');
...
class ValueSetSerializer {
    static propertyToSerializerMap = {
        ...
        compose: (value) => {
            ...
            return FhirResourceSerializer.serialize(value, ValueSetCompose);
        },
        expansion: (value) => {
            initializeSerializers('ValueSetExpansion');
            return FhirResourceSerializer.serialize(value, ValueSetExpansion);
        },
        resourceType: null
    };

...
class EnrollmentResponseSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EnrollmentResponseSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EnrollmentResponseSerializer.propertyToSerializerMap) {
                if (EnrollmentResponseSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EnrollmentResponseSerializer.propertyToSerializerMap[propertyName](value, context);

...
class EnrollmentResponseSerializer {
    static propertyToSerializerMap = {
        ...
        requestProvider: (value) => ReferenceSerializer.serialize(value),
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EnrollmentResponseSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EnrollmentResponseSerializer.propertyToSerializerMap) {
                if (EnrollmentResponseSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EnrollmentResponseSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = EnrollmentResponseSerializer;
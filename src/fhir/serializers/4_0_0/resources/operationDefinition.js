...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'OperationDefinitionParameter' && !OperationDefinitionParameter) {
        OperationDefinitionParameter = require('../backbone_elements/operationDefinitionParameter.js');
        return OperationDefinitionParameter;
    }
    if (serializerName === 'OperationDefinitionOverload' && !OperationDefinitionOverload) {
        OperationDefinitionOverload = require('../backbone_elements/operationDefinitionOverload.js');
...
class OperationDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        overload: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, OperationDefinitionOverload);
        },
        resourceType: null
    };

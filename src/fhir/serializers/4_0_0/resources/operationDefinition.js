...
/** @type {import('../backbone_elements/operationDefinitionParameter.js')} */
let OperationDefinitionParameterSerializer;
/** @type {import('../backbone_elements/operationDefinitionOverload.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'OperationDefinitionParameter' && !OperationDefinitionParameterSerializer) {
        OperationDefinitionParameterSerializer = require('../backbone_elements/operationDefinitionParameter.js');
        return OperationDefinitionParameterSerializer;
    }
    if (serializerName === 'OperationDefinitionOverload' && !OperationDefinitionOverloadSerializer) {
        OperationDefinitionOverloadSerializer = require('../backbone_elements/operationDefinitionOverload.js');
        return OperationDefinitionOverloadSerializer;
    }
}

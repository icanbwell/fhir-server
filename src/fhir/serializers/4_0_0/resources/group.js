...
class GroupSerializer {
    static propertyToSerializerMap = {
        ...
        characteristic: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, GroupCharacteristicSerializer, context);
        },
        member: (value, context) => {
            initializeSerializers('GroupMember');
            return FhirResourceSerializer.serializeArray(value, GroupMemberSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GroupSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GroupSerializer.propertyToSerializerMap) {
                if (GroupSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GroupSerializer.propertyToSerializerMap[propertyName](value, context);

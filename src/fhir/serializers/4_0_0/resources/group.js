...
/** @type {import('../backbone_elements/groupCharacteristic.js')} */
let GroupCharacteristicSerializer;
/** @type {import('../backbone_elements/groupMember.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'GroupCharacteristic' && !GroupCharacteristicSerializer) {
        GroupCharacteristicSerializer = require('../backbone_elements/groupCharacteristic.js');
        return GroupCharacteristicSerializer;
    }
    if (serializerName === 'GroupMember' && !GroupMemberSerializer) {
        GroupMemberSerializer = require('../backbone_elements/groupMember.js');
...
class GroupSerializer {
    static propertyToSerializerMap = {
        ...
        characteristic: (value) => {
            initializeSerializers('GroupCharacteristic');
            return FhirResourceSerializer.serializeArray(value, GroupCharacteristicSerializer);
        },
        member: (value) => {
            initializeSerializers('GroupMember');
            return FhirResourceSerializer.serializeArray(value, GroupMemberSerializer);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GroupSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GroupSerializer.propertyToSerializerMap) {
                if (GroupSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GroupSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = GroupSerializer;

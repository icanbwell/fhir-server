...
const GroupCharacteristicSerializer = require('../backbone_elements/groupCharacteristic.js');
const GroupMemberSerializer = require('../backbone_elements/groupMember.js');
...
class GroupSerializer {
    static propertyToSerializerMap = {
        ...
        name: null,
        quantity: null,
        managingEntity: (value) => ReferenceSerializer.serialize(value),
        characteristic: (value) => GroupCharacteristicSerializer.serialize(value),
        member: (value) => GroupMemberSerializer.serialize(value),
        resourceType: null
    };

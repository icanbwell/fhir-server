...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'GroupCharacteristic' && !GroupCharacteristic) {
        GroupCharacteristic = require('../backbone_elements/groupCharacteristic.js');
        return GroupCharacteristic;
    }
    if (serializerName === 'GroupMember' && !GroupMember) {
        GroupMember = require('../backbone_elements/groupMember.js');
        return GroupMember;
    }
}
...
class GroupSerializer {
    static propertyToSerializerMap = {
        ...
        characteristic: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, GroupCharacteristic);
        },
        member: (value) => {
            initializeSerializers('GroupMember');
            return FhirResourceSerializer.serializeArray(value, GroupMember);
        },
        resourceType: null
    };

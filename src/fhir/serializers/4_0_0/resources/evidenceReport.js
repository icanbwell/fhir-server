...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'EvidenceReportSubject' && !EvidenceReportSubject) {
        EvidenceReportSubject = require('../backbone_elements/evidenceReportSubject.js');
    ...
    if (serializerName === 'EvidenceReportRelatesTo' && !EvidenceReportRelatesTo) {
        EvidenceReportRelatesTo = require('../backbone_elements/evidenceReportRelatesTo.js');
        return EvidenceReportRelatesTo;
    }
    if (serializerName === 'EvidenceReportSection' && !EvidenceReportSection) {
        EvidenceReportSection = require('../backbone_elements/evidenceReportSection.js');
...
class EvidenceReportSerializer {
    static propertyToSerializerMap = {
        ...
        subject: (value) => {
            ...
            return FhirResourceSerializer.serialize(value, EvidenceReportSubject);
        },
        publisher: null,
        contact: (value) => {
        ...
        relatesTo: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, EvidenceReportRelatesTo);
        },
        section: (value) => {

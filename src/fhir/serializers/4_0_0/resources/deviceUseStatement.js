...
class DeviceUseStatementSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceUseStatementSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceUseStatementSerializer.propertyToSerializerMap) {
                if (DeviceUseStatementSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceUseStatementSerializer.propertyToSerializerMap[propertyName](value, context);

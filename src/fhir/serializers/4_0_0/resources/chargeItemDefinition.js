...
class ChargeItemDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        propertyGroup: (value, context) => {
            initializeSerializers('ChargeItemDefinitionPropertyGroup');
            return FhirResourceSerializer.serializeArray(value, ChargeItemDefinitionPropertyGroupSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ChargeItemDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ChargeItemDefinitionSerializer.propertyToSerializerMap) {
                if (ChargeItemDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ChargeItemDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);

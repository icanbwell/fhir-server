...
/** @type {import('../backbone_elements/chargeItemDefinitionPropertyGroup.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ChargeItemDefinitionPropertyGroup' && !ChargeItemDefinitionPropertyGroupSerializer) {
        ChargeItemDefinitionPropertyGroupSerializer = require('../backbone_elements/chargeItemDefinitionPropertyGroup.js');
        return ChargeItemDefinitionPropertyGroupSerializer;
    }
}
...
class ChargeItemDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        applicability: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ChargeItemDefinitionApplicabilitySerializer);
        },
        propertyGroup: (value) => {
            initializeSerializers('ChargeItemDefinitionPropertyGroup');
            return FhirResourceSerializer.serializeArray(value, ChargeItemDefinitionPropertyGroupSerializer);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ChargeItemDefinitionSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ChargeItemDefinitionSerializer.propertyToSerializerMap) {
                if (ChargeItemDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ChargeItemDefinitionSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = ChargeItemDefinitionSerializer;

...
const ChargeItemDefinitionPropertyGroupSerializer = require('../backbone_elements/chargeItemDefinitionPropertyGroup.js');
...
class ChargeItemDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        instance: (value) => ReferenceSerializer.serialize(value),
        applicability: (value) => ChargeItemDefinitionApplicabilitySerializer.serialize(value),
        propertyGroup: (value) => ChargeItemDefinitionPropertyGroupSerializer.serialize(value),
        resourceType: null
    };

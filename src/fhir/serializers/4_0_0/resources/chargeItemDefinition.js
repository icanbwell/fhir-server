...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ChargeItemDefinitionPropertyGroup' && !ChargeItemDefinitionPropertyGroup) {
        ChargeItemDefinitionPropertyGroup = require('../backbone_elements/chargeItemDefinitionPropertyGroup.js');
...
class ChargeItemDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        propertyGroup: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ChargeItemDefinitionPropertyGroup);
        },
        resourceType: null
    };

...
class QuestionnaireSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => QuestionnaireSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in QuestionnaireSerializer.propertyToSerializerMap) {
                if (QuestionnaireSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = QuestionnaireSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'OrganizationContact' && !OrganizationContact) {
        OrganizationContact = require('../backbone_elements/organizationContact.js');
...
class OrganizationSerializer {
    static propertyToSerializerMap = {
        ...
        contact: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, OrganizationContact);
        },
        endpoint: (value) => {
            initializeSerializers('Reference');

...
const SubstanceInstanceSerializer = require('../backbone_elements/substanceInstance.js');
const SubstanceIngredientSerializer = require('../backbone_elements/substanceIngredient.js');
...
class SubstanceSerializer {
    static propertyToSerializerMap = {
        ...
        description: null,
        instance: (value) => SubstanceInstanceSerializer.serialize(value),
        ingredient: (value) => SubstanceIngredientSerializer.serialize(value),
        resourceType: null
    };

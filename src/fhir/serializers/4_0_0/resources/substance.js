...
class SubstanceSerializer {
    static propertyToSerializerMap = {
        ...
        instance: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, SubstanceInstanceSerializer, context);
        },
        ingredient: (value, context) => {
            initializeSerializers('SubstanceIngredient');
            return FhirResourceSerializer.serializeArray(value, SubstanceIngredientSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubstanceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubstanceSerializer.propertyToSerializerMap) {
                if (SubstanceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubstanceSerializer.propertyToSerializerMap[propertyName](value, context);

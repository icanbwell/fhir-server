...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SubstanceInstance' && !SubstanceInstance) {
        SubstanceInstance = require('../backbone_elements/substanceInstance.js');
        return SubstanceInstance;
    }
    if (serializerName === 'SubstanceIngredient' && !SubstanceIngredient) {
        SubstanceIngredient = require('../backbone_elements/substanceIngredient.js');
...
class SubstanceSerializer {
    static propertyToSerializerMap = {
        ...
        instance: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, SubstanceInstance);
        },
        ingredient: (value) => {
            initializeSerializers('SubstanceIngredient');
            return FhirResourceSerializer.serializeArray(value, SubstanceIngredient);
        },
        resourceType: null
    };

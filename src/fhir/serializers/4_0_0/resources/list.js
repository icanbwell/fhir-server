...
class ListSerializer {
    static propertyToSerializerMap = {
        ...
        entry: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ListEntrySerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ListSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ListSerializer.propertyToSerializerMap) {
                if (ListSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ListSerializer.propertyToSerializerMap[propertyName](value, context);

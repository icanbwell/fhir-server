...
class CitationSerializer {
    static propertyToSerializerMap = {
        ...
        summary: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CitationSummarySerializer, context);
        },
        classification: (value, context) => {
            initializeSerializers('CitationClassification');
            return FhirResourceSerializer.serializeArray(value, CitationClassificationSerializer, context);
        },
        note: (value, context) => {
        ...
        statusDate: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CitationStatusDateSerializer, context);
        },
        relatesTo: (value, context) => {
            initializeSerializers('CitationRelatesTo');
            return FhirResourceSerializer.serializeArray(value, CitationRelatesToSerializer, context);
        },
        citedArtifact: (value, context) => {
            initializeSerializers('CitationCitedArtifact');
            return FhirResourceSerializer.serialize(value, CitationCitedArtifactSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CitationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CitationSerializer.propertyToSerializerMap) {
                if (CitationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CitationSerializer.propertyToSerializerMap[propertyName](value, context);

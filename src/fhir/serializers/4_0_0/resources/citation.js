...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CitationSummary' && !CitationSummary) {
        CitationSummary = require('../backbone_elements/citationSummary.js');
        return CitationSummary;
    }
    if (serializerName === 'CitationClassification' && !CitationClassification) {
        CitationClassification = require('../backbone_elements/citationClassification.js');
    ...
    if (serializerName === 'CitationStatusDate' && !CitationStatusDate) {
        CitationStatusDate = require('../backbone_elements/citationStatusDate.js');
        return CitationStatusDate;
    }
    if (serializerName === 'CitationRelatesTo' && !CitationRelatesTo) {
        CitationRelatesTo = require('../backbone_elements/citationRelatesTo.js');
        return CitationRelatesTo;
    }
    if (serializerName === 'CitationCitedArtifact' && !CitationCitedArtifact) {
        CitationCitedArtifact = require('../backbone_elements/citationCitedArtifact.js');
...
class CitationSerializer {
    static propertyToSerializerMap = {
        ...
        summary: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CitationSummary);
        },
        classification: (value) => {
            initializeSerializers('CitationClassification');
            return FhirResourceSerializer.serializeArray(value, CitationClassification);
        },
        note: (value) => {
        ...
        statusDate: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CitationStatusDate);
        },
        relatesTo: (value) => {
            initializeSerializers('CitationRelatesTo');
            return FhirResourceSerializer.serializeArray(value, CitationRelatesTo);
        },
        citedArtifact: (value) => {
            initializeSerializers('CitationCitedArtifact');
            return FhirResourceSerializer.serialize(value, CitationCitedArtifact);
        },
        resourceType: null
    };

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'DocumentReferenceRelatesTo' && !DocumentReferenceRelatesTo) {
        DocumentReferenceRelatesTo = require('../backbone_elements/documentReferenceRelatesTo.js');
        return DocumentReferenceRelatesTo;
    }
    if (serializerName === 'DocumentReferenceContent' && !DocumentReferenceContent) {
        DocumentReferenceContent = require('../backbone_elements/documentReferenceContent.js');
        return DocumentReferenceContent;
    }
    if (serializerName === 'DocumentReferenceContext' && !DocumentReferenceContext) {
        DocumentReferenceContext = require('../backbone_elements/documentReferenceContext.js');
...
class DocumentReferenceSerializer {
    static propertyToSerializerMap = {
        ...
        relatesTo: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, DocumentReferenceRelatesTo);
        },
        description: null,
        securityLabel: (value) => {
            initializeSerializers('CodeableConcept');
        ...
        content: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, DocumentReferenceContent);
        },
        context: (value) => {
            initializeSerializers('DocumentReferenceContext');
            return FhirResourceSerializer.serialize(value, DocumentReferenceContext);
        },
        resourceType: null
    };

...
class AppointmentResponseSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AppointmentResponseSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AppointmentResponseSerializer.propertyToSerializerMap) {
                if (AppointmentResponseSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AppointmentResponseSerializer.propertyToSerializerMap[propertyName](value, context);

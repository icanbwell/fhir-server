...
class AppointmentResponseSerializer {
    static propertyToSerializerMap = {
        ...
        participantType: (value) => CodeableConceptSerializer.serialize(value),
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AppointmentResponseSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AppointmentResponseSerializer.propertyToSerializerMap) {
                if (AppointmentResponseSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AppointmentResponseSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = AppointmentResponseSerializer;
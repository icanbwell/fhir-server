...
class LibrarySerializer {
    static propertyToSerializerMap = {
        ...
        parameter: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ParameterDefinitionSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => LibrarySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in LibrarySerializer.propertyToSerializerMap) {
                if (LibrarySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = LibrarySerializer.propertyToSerializerMap[propertyName](value, context);

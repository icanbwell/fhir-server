...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'IngredientManufacturer' && !IngredientManufacturer) {
        IngredientManufacturer = require('../backbone_elements/ingredientManufacturer.js');
        return IngredientManufacturer;
    }
    if (serializerName === 'IngredientSubstance' && !IngredientSubstance) {
        IngredientSubstance = require('../backbone_elements/ingredientSubstance.js');
...
class IngredientSerializer {
    static propertyToSerializerMap = {
        ...
        manufacturer: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, IngredientManufacturer);
        },
        substance: (value) => {
            initializeSerializers('IngredientSubstance');
            return FhirResourceSerializer.serialize(value, IngredientSubstance);
        },
        resourceType: null
    };

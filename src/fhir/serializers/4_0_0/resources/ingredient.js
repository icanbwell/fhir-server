...
/** @type {import('../backbone_elements/ingredientManufacturer.js')} */
let IngredientManufacturerSerializer;
/** @type {import('../backbone_elements/ingredientSubstance.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'IngredientManufacturer' && !IngredientManufacturerSerializer) {
        IngredientManufacturerSerializer = require('../backbone_elements/ingredientManufacturer.js');
        return IngredientManufacturerSerializer;
    }
    if (serializerName === 'IngredientSubstance' && !IngredientSubstanceSerializer) {
        IngredientSubstanceSerializer = require('../backbone_elements/ingredientSubstance.js');
        return IngredientSubstanceSerializer;
    }
}
...
class IngredientSerializer {
    static propertyToSerializerMap = {
        ...
        manufacturer: (value, context) => {
            initializeSerializers('IngredientManufacturer');
            return FhirResourceSerializer.serializeArray(value, IngredientManufacturerSerializer, context);
        },
        substance: (value, context) => {
            initializeSerializers('IngredientSubstance');
            return FhirResourceSerializer.serialize(value, IngredientSubstanceSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => IngredientSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in IngredientSerializer.propertyToSerializerMap) {
                if (IngredientSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = IngredientSerializer.propertyToSerializerMap[propertyName](value, context);

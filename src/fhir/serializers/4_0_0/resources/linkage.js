...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'LinkageItem' && !LinkageItem) {
        LinkageItem = require('../backbone_elements/linkageItem.js');
        return LinkageItem;
    }
}
...
class LinkageSerializer {
    static propertyToSerializerMap = {
        ...
        item: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, LinkageItem);
        },
        resourceType: null
    };

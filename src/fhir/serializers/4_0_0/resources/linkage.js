...
class LinkageSerializer {
    static propertyToSerializerMap = {
        ...
        item: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, LinkageItemSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => LinkageSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in LinkageSerializer.propertyToSerializerMap) {
                if (LinkageSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = LinkageSerializer.propertyToSerializerMap[propertyName](value, context);

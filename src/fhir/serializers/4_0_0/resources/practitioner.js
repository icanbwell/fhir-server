...
class PractitionerSerializer {
    static propertyToSerializerMap = {
        ...
        qualification: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, PractitionerQualificationSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PractitionerSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PractitionerSerializer.propertyToSerializerMap) {
                if (PractitionerSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PractitionerSerializer.propertyToSerializerMap[propertyName](value, context);

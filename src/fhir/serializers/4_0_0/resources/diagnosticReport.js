...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'DiagnosticReportMedia' && !DiagnosticReportMedia) {
        DiagnosticReportMedia = require('../backbone_elements/diagnosticReportMedia.js');
...
class DiagnosticReportSerializer {
    static propertyToSerializerMap = {
        ...
        media: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, DiagnosticReportMedia);
        },
        conclusion: null,

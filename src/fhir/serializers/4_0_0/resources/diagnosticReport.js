...
class DiagnosticReportSerializer {
    static propertyToSerializerMap = {
        ...
        resultsInterpreter: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serializeArray(value, ReferenceSerializer, context);
        },
        ...
        imagingStudy: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serializeArray(value, ReferenceSerializer, context);
        },
        media: (value, context) => {
            initializeSerializers('DiagnosticReportMedia');
            return FhirResourceSerializer.serializeArray(value, DiagnosticReportMediaSerializer, context);
        },
        conclusion: null,
        conclusionCode: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConceptSerializer, context);
        },
        presentedForm: (value, context) => {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DiagnosticReportSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DiagnosticReportSerializer.propertyToSerializerMap) {
                if (DiagnosticReportSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DiagnosticReportSerializer.propertyToSerializerMap[propertyName](value, context);

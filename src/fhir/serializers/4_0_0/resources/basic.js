...
class BasicSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => BasicSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in BasicSerializer.propertyToSerializerMap) {
                if (BasicSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = BasicSerializer.propertyToSerializerMap[propertyName](value, context);

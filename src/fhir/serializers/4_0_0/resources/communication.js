...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CommunicationPayload' && !CommunicationPayload) {
        CommunicationPayload = require('../backbone_elements/communicationPayload.js');
...
class CommunicationSerializer {
    static propertyToSerializerMap = {
        ...
        payload: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CommunicationPayload);
        },
        note: (value) => {

...
/** @type {import('../backbone_elements/communicationPayload.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CommunicationPayload' && !CommunicationPayloadSerializer) {
        CommunicationPayloadSerializer = require('../backbone_elements/communicationPayload.js');
        return CommunicationPayloadSerializer;
    }
...
class CommunicationSerializer {
    static propertyToSerializerMap = {
        ...
        payload: (value, context) => {
            initializeSerializers('CommunicationPayload');
            return FhirResourceSerializer.serializeArray(value, CommunicationPayloadSerializer, context);
        },
        note: (value, context) => {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CommunicationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CommunicationSerializer.propertyToSerializerMap) {
                if (CommunicationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CommunicationSerializer.propertyToSerializerMap[propertyName](value, context);

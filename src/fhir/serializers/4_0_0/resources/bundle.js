...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'BundleEntry' && !BundleEntry) {
        BundleEntry = require('../backbone_elements/bundleEntry.js');
        return BundleEntry;
    }
...
class BundleSerializer {
    static propertyToSerializerMap = {
        ...
        entry: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, BundleEntry);
        },
        signature: (value) => {

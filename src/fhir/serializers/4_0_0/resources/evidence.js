...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'EvidenceVariableDefinition' && !EvidenceVariableDefinition) {
        EvidenceVariableDefinition = require('../backbone_elements/evidenceVariableDefinition.js');
    ...
    if (serializerName === 'EvidenceStatistic' && !EvidenceStatistic) {
        EvidenceStatistic = require('../backbone_elements/evidenceStatistic.js');
        return EvidenceStatistic;
    }
    if (serializerName === 'EvidenceCertainty' && !EvidenceCertainty) {
        EvidenceCertainty = require('../backbone_elements/evidenceCertainty.js');
...
class EvidenceSerializer {
    static propertyToSerializerMap = {
        ...
        variableDefinition: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, EvidenceVariableDefinition);
        },
        synthesisType: (value) => {
        ...
        statistic: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, EvidenceStatistic);
        },
        certainty: (value) => {
            initializeSerializers('EvidenceCertainty');
            return FhirResourceSerializer.serializeArray(value, EvidenceCertainty);
        },
        resourceType: null
    };

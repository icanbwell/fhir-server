...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'AdverseEventSuspectEntity' && !AdverseEventSuspectEntity) {
        AdverseEventSuspectEntity = require('../backbone_elements/adverseEventSuspectEntity.js');
...
class AdverseEventSerializer {
    static propertyToSerializerMap = {
        ...
        suspectEntity: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, AdverseEventSuspectEntity);
        },

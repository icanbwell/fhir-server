...
class ImagingStudySerializer {
    static propertyToSerializerMap = {
        ...
        description: null,
        series: (value, context) => {
            initializeSerializers('ImagingStudySeries');
            return FhirResourceSerializer.serializeArray(value, ImagingStudySeriesSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ImagingStudySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ImagingStudySerializer.propertyToSerializerMap) {
                if (ImagingStudySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ImagingStudySerializer.propertyToSerializerMap[propertyName](value, context);

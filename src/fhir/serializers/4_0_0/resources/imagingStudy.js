...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ImagingStudySeries' && !ImagingStudySeries) {
        ImagingStudySeries = require('../backbone_elements/imagingStudySeries.js');
...
class ImagingStudySerializer {
    static propertyToSerializerMap = {
        ...
        series: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ImagingStudySeries);
        },
        resourceType: null
    };

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'DeviceRequestParameter' && !DeviceRequestParameterSerializer) {
        DeviceRequestParameterSerializer = require('../backbone_elements/deviceRequestParameter.js');
        return DeviceRequestParameterSerializer;
    }
...
class DeviceRequestSerializer {
    static propertyToSerializerMap = {
        ...
        parameter: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, DeviceRequestParameterSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceRequestSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceRequestSerializer.propertyToSerializerMap) {
                if (DeviceRequestSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceRequestSerializer.propertyToSerializerMap[propertyName](value, context);

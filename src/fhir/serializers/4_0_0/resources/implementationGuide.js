...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ImplementationGuideDependsOn' && !ImplementationGuideDependsOn) {
        ImplementationGuideDependsOn = require('../backbone_elements/implementationGuideDependsOn.js');
        return ImplementationGuideDependsOn;
    }
    if (serializerName === 'ImplementationGuideGlobal' && !ImplementationGuideGlobal) {
        ImplementationGuideGlobal = require('../backbone_elements/implementationGuideGlobal.js');
        return ImplementationGuideGlobal;
    }
    if (serializerName === 'ImplementationGuideDefinition' && !ImplementationGuideDefinition) {
        ImplementationGuideDefinition = require('../backbone_elements/implementationGuideDefinition.js');
        return ImplementationGuideDefinition;
    }
    if (serializerName === 'ImplementationGuideManifest' && !ImplementationGuideManifest) {
        ImplementationGuideManifest = require('../backbone_elements/implementationGuideManifest.js');
...
class ImplementationGuideSerializer {
    static propertyToSerializerMap = {
        ...
        dependsOn: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ImplementationGuideDependsOn);
        },
        global: (value) => {
            initializeSerializers('ImplementationGuideGlobal');
            return FhirResourceSerializer.serializeArray(value, ImplementationGuideGlobal);
        },
        definition: (value) => {
            initializeSerializers('ImplementationGuideDefinition');
            return FhirResourceSerializer.serialize(value, ImplementationGuideDefinition);
        },
        manifest: (value) => {
            initializeSerializers('ImplementationGuideManifest');
            return FhirResourceSerializer.serialize(value, ImplementationGuideManifest);
        },
        resourceType: null
    };

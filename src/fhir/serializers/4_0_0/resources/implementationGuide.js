...
const ImplementationGuideDependsOnSerializer = require('../backbone_elements/implementationGuideDependsOn.js');
const ImplementationGuideGlobalSerializer = require('../backbone_elements/implementationGuideGlobal.js');
const ImplementationGuideDefinitionSerializer = require('../backbone_elements/implementationGuideDefinition.js');
const ImplementationGuideManifestSerializer = require('../backbone_elements/implementationGuideManifest.js');
...
class ImplementationGuideSerializer {
    static propertyToSerializerMap = {
        ...
        license: null,
        fhirVersion: null,
        dependsOn: (value) => ImplementationGuideDependsOnSerializer.serialize(value),
        global: (value) => ImplementationGuideGlobalSerializer.serialize(value),
        definition: (value) => ImplementationGuideDefinitionSerializer.serialize(value),
        manifest: (value) => ImplementationGuideManifestSerializer.serialize(value),
        resourceType: null
    };

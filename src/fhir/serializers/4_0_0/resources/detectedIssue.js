...
/** @type {import('../backbone_elements/detectedIssueEvidence.js')} */
let DetectedIssueEvidenceSerializer;
/** @type {import('../backbone_elements/detectedIssueMitigation.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'DetectedIssueEvidence' && !DetectedIssueEvidenceSerializer) {
        DetectedIssueEvidenceSerializer = require('../backbone_elements/detectedIssueEvidence.js');
        return DetectedIssueEvidenceSerializer;
    }
    if (serializerName === 'DetectedIssueMitigation' && !DetectedIssueMitigationSerializer) {
        DetectedIssueMitigationSerializer = require('../backbone_elements/detectedIssueMitigation.js');
        return DetectedIssueMitigationSerializer;
    }
}
...
class DetectedIssueSerializer {
    static propertyToSerializerMap = {
        ...
        evidence: (value) => {
            initializeSerializers('DetectedIssueEvidence');
            return FhirResourceSerializer.serializeArray(value, DetectedIssueEvidenceSerializer);
        },
        detail: null,
        reference: null,
        mitigation: (value) => {
            initializeSerializers('DetectedIssueMitigation');
            return FhirResourceSerializer.serializeArray(value, DetectedIssueMitigationSerializer);
        },
        resourceType: null
    };

...
class DetectedIssueSerializer {
    static propertyToSerializerMap = {
        ...
        identifiedPeriod: (value, context) => {
        ...
        evidence: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, DetectedIssueEvidenceSerializer, context);
        },
        detail: null,
        reference: null,
        mitigation: (value, context) => {
            initializeSerializers('DetectedIssueMitigation');
            return FhirResourceSerializer.serializeArray(value, DetectedIssueMitigationSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DetectedIssueSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DetectedIssueSerializer.propertyToSerializerMap) {
                if (DetectedIssueSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DetectedIssueSerializer.propertyToSerializerMap[propertyName](value, context);

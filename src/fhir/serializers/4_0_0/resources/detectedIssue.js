...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'DetectedIssueEvidence' && !DetectedIssueEvidence) {
        DetectedIssueEvidence = require('../backbone_elements/detectedIssueEvidence.js');
        return DetectedIssueEvidence;
    }
    if (serializerName === 'DetectedIssueMitigation' && !DetectedIssueMitigation) {
        DetectedIssueMitigation = require('../backbone_elements/detectedIssueMitigation.js');
...
class DetectedIssueSerializer {
    static propertyToSerializerMap = {
        ...
        evidence: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, DetectedIssueEvidence);
        },
        detail: null,
        reference: null,
        mitigation: (value) => {
            initializeSerializers('DetectedIssueMitigation');
            return FhirResourceSerializer.serializeArray(value, DetectedIssueMitigation);
        },
        resourceType: null
    };

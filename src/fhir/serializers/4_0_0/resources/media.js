...
class MediaSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MediaSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MediaSerializer.propertyToSerializerMap) {
                if (MediaSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MediaSerializer.propertyToSerializerMap[propertyName](value, context);

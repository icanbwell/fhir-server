...
class MediaSerializer {
    static propertyToSerializerMap = {
        ...
        modality: (value) => CodeableConceptSerializer.serialize(value),
        view: (value) => CodeableConceptSerializer.serialize(value),
        subject: (value) => ReferenceSerializer.serialize(value),
        encounter: (value) => ReferenceSerializer.serialize(value),
        createdDateTime: null,
        createdPeriod: (value) => PeriodSerializer.serialize(value),
        issued: null,
        operator: (value) => ReferenceSerializer.serialize(value),
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => MediaSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in MediaSerializer.propertyToSerializerMap) {
                if (MediaSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = MediaSerializer.propertyToSerializerMap[propertyName](value);

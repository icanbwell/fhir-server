...
class RegulatedAuthorizationSerializer {
    static propertyToSerializerMap = {
        ...
        regulator: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serialize(value, ReferenceSerializer, context);
        },
        case: (value, context) => {
            initializeSerializers('RegulatedAuthorizationCase');
            return FhirResourceSerializer.serialize(value, RegulatedAuthorizationCaseSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => RegulatedAuthorizationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in RegulatedAuthorizationSerializer.propertyToSerializerMap) {
                if (RegulatedAuthorizationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = RegulatedAuthorizationSerializer.propertyToSerializerMap[propertyName](value, context);

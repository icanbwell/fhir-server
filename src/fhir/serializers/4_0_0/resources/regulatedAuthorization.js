...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'RegulatedAuthorizationCase' && !RegulatedAuthorizationCase) {
        RegulatedAuthorizationCase = require('../backbone_elements/regulatedAuthorizationCase.js');
...
class RegulatedAuthorizationSerializer {
    static propertyToSerializerMap = {
        ...
        case: (value) => {
            ...
            return FhirResourceSerializer.serialize(value, RegulatedAuthorizationCase);
        },
        resourceType: null
    };

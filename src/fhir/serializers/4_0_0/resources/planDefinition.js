...
class PlanDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        goal: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, PlanDefinitionGoalSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PlanDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PlanDefinitionSerializer.propertyToSerializerMap) {
                if (PlanDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PlanDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'PlanDefinitionGoal' && !PlanDefinitionGoal) {
        PlanDefinitionGoal = require('../backbone_elements/planDefinitionGoal.js');
        return PlanDefinitionGoal;
    }
    if (serializerName === 'PlanDefinitionAction' && !PlanDefinitionAction) {
        PlanDefinitionAction = require('../backbone_elements/planDefinitionAction.js');
...
class PlanDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        goal: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, PlanDefinitionGoal);
        },
        action: (value) => {

...
const PlanDefinitionGoalSerializer = require('../backbone_elements/planDefinitionGoal.js');
const PlanDefinitionActionSerializer = require('../backbone_elements/planDefinitionAction.js');
...
class PlanDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        library: null,
        goal: (value) => PlanDefinitionGoalSerializer.serialize(value),

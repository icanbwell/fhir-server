...
/** @type {import('../backbone_elements/planDefinitionGoal.js')} */
let PlanDefinitionGoalSerializer;
/** @type {import('../backbone_elements/planDefinitionAction.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'PlanDefinitionGoal' && !PlanDefinitionGoalSerializer) {
        PlanDefinitionGoalSerializer = require('../backbone_elements/planDefinitionGoal.js');
        return PlanDefinitionGoalSerializer;
    }
    if (serializerName === 'PlanDefinitionAction' && !PlanDefinitionActionSerializer) {
        PlanDefinitionActionSerializer = require('../backbone_elements/planDefinitionAction.js');
        return PlanDefinitionActionSerializer;
    }
}
...
class PlanDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        library: null,
        goal: (value) => {
            initializeSerializers('PlanDefinitionGoal');
            return FhirResourceSerializer.serializeArray(value, PlanDefinitionGoalSerializer);
        },
        action: (value) => {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PlanDefinitionSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PlanDefinitionSerializer.propertyToSerializerMap) {
                if (PlanDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PlanDefinitionSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = PlanDefinitionSerializer;

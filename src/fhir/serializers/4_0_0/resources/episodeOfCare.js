...
class EpisodeOfCareSerializer {
    static propertyToSerializerMap = {
        ...
        statusHistory: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, EpisodeOfCareStatusHistorySerializer, context);
        },
        type: (value, context) => {
        ...
        diagnosis: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, EpisodeOfCareDiagnosisSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EpisodeOfCareSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EpisodeOfCareSerializer.propertyToSerializerMap) {
                if (EpisodeOfCareSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EpisodeOfCareSerializer.propertyToSerializerMap[propertyName](value, context);

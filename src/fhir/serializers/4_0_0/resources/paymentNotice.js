...
class PaymentNoticeSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PaymentNoticeSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PaymentNoticeSerializer.propertyToSerializerMap) {
                if (PaymentNoticeSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PaymentNoticeSerializer.propertyToSerializerMap[propertyName](value, context);

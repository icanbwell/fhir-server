...
/** @type {import('../backbone_elements/catalogEntryRelatedEntry.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CatalogEntryRelatedEntry' && !CatalogEntryRelatedEntrySerializer) {
        CatalogEntryRelatedEntrySerializer = require('../backbone_elements/catalogEntryRelatedEntry.js');
        return CatalogEntryRelatedEntrySerializer;
    }
}
...
class CatalogEntrySerializer {
    static propertyToSerializerMap = {
        ...
        validTo: null,
        lastUpdated: null,
        additionalCharacteristic: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConceptSerializer, context);
        },
        additionalClassification: (value, context) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serializeArray(value, CodeableConceptSerializer, context);
        },
        relatedEntry: (value, context) => {
            initializeSerializers('CatalogEntryRelatedEntry');
            return FhirResourceSerializer.serializeArray(value, CatalogEntryRelatedEntrySerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CatalogEntrySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CatalogEntrySerializer.propertyToSerializerMap) {
                if (CatalogEntrySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CatalogEntrySerializer.propertyToSerializerMap[propertyName](value, context);

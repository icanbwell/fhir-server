...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CatalogEntryRelatedEntry' && !CatalogEntryRelatedEntry) {
        CatalogEntryRelatedEntry = require('../backbone_elements/catalogEntryRelatedEntry.js');
...
class CatalogEntrySerializer {
    static propertyToSerializerMap = {
        ...
        relatedEntry: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CatalogEntryRelatedEntry);
        },
        resourceType: null
    };

...
class FlagSerializer {
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => FlagSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in FlagSerializer.propertyToSerializerMap) {
                if (FlagSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = FlagSerializer.propertyToSerializerMap[propertyName](value);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ConceptMapGroup' && !ConceptMapGroup) {
        ConceptMapGroup = require('../backbone_elements/conceptMapGroup.js');
...
class ConceptMapSerializer {
    static propertyToSerializerMap = {
        ...
        group: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ConceptMapGroup);
        },
        resourceType: null
    };

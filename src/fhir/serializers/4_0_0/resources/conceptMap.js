...
class ConceptMapSerializer {
    static propertyToSerializerMap = {
        ...
        group: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ConceptMapGroupSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ConceptMapSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ConceptMapSerializer.propertyToSerializerMap) {
                if (ConceptMapSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ConceptMapSerializer.propertyToSerializerMap[propertyName](value, context);

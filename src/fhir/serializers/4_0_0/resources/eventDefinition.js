...
class EventDefinitionSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EventDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EventDefinitionSerializer.propertyToSerializerMap) {
                if (EventDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EventDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);

...
class EvidenceVariableSerializer {
    static propertyToSerializerMap = {
        ...
        characteristic: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, EvidenceVariableCharacteristicSerializer, context);
        },
        handling: null,
        category: (value, context) => {
            initializeSerializers('EvidenceVariableCategory');
            return FhirResourceSerializer.serializeArray(value, EvidenceVariableCategorySerializer, context);
        },
        resourceType: null
    };

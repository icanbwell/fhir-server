...
/** @type {import('../backbone_elements/practitionerRoleAvailableTime.js')} */
let PractitionerRoleAvailableTimeSerializer;
/** @type {import('../backbone_elements/practitionerRoleNotAvailable.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'PractitionerRoleAvailableTime' && !PractitionerRoleAvailableTimeSerializer) {
        PractitionerRoleAvailableTimeSerializer = require('../backbone_elements/practitionerRoleAvailableTime.js');
        return PractitionerRoleAvailableTimeSerializer;
    }
    if (serializerName === 'PractitionerRoleNotAvailable' && !PractitionerRoleNotAvailableSerializer) {
        PractitionerRoleNotAvailableSerializer = require('../backbone_elements/practitionerRoleNotAvailable.js');
        return PractitionerRoleNotAvailableSerializer;
    }
}
...
class PractitionerRoleSerializer {
    static propertyToSerializerMap = {
        ...
        availableTime: (value) => {
            initializeSerializers('PractitionerRoleAvailableTime');
            return FhirResourceSerializer.serializeArray(value, PractitionerRoleAvailableTimeSerializer);
        },
        notAvailable: (value) => {
            initializeSerializers('PractitionerRoleNotAvailable');
            return FhirResourceSerializer.serializeArray(value, PractitionerRoleNotAvailableSerializer);
        },

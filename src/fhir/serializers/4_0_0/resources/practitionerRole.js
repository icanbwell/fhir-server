...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'PractitionerRoleAvailableTime' && !PractitionerRoleAvailableTime) {
        PractitionerRoleAvailableTime = require('../backbone_elements/practitionerRoleAvailableTime.js');
        return PractitionerRoleAvailableTime;
    }
    if (serializerName === 'PractitionerRoleNotAvailable' && !PractitionerRoleNotAvailable) {
        PractitionerRoleNotAvailable = require('../backbone_elements/practitionerRoleNotAvailable.js');
...
class PractitionerRoleSerializer {
    static propertyToSerializerMap = {
        ...
        availableTime: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, PractitionerRoleAvailableTime);
        },
        notAvailable: (value) => {
            initializeSerializers('PractitionerRoleNotAvailable');
            return FhirResourceSerializer.serializeArray(value, PractitionerRoleNotAvailable);
        },

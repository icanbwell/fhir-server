...
class PractitionerRoleSerializer {
    static propertyToSerializerMap = {
        ...
        healthcareService: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serializeArray(value, ReferenceSerializer, context);
        },
        ...
        availableTime: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, PractitionerRoleAvailableTimeSerializer, context);
        },
        notAvailable: (value, context) => {
            initializeSerializers('PractitionerRoleNotAvailable');
            return FhirResourceSerializer.serializeArray(value, PractitionerRoleNotAvailableSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => PractitionerRoleSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in PractitionerRoleSerializer.propertyToSerializerMap) {
                if (PractitionerRoleSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = PractitionerRoleSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'AdministrableProductDefinitionProperty' && !AdministrableProductDefinitionPropertySerializer) {
        AdministrableProductDefinitionPropertySerializer = require('../backbone_elements/administrableProductDefinitionProperty.js');
        return AdministrableProductDefinitionPropertySerializer;
    }
    if (serializerName === 'AdministrableProductDefinitionRouteOfAdministration' && !AdministrableProductDefinitionRouteOfAdministrationSerializer) {
        AdministrableProductDefinitionRouteOfAdministrationSerializer = require('../backbone_elements/administrableProductDefinitionRouteOfAdministration.js');
        return AdministrableProductDefinitionRouteOfAdministrationSerializer;
    }
}
...
class AdministrableProductDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        property: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, AdministrableProductDefinitionPropertySerializer, context);
        },
        routeOfAdministration: (value, context) => {
            initializeSerializers('AdministrableProductDefinitionRouteOfAdministration');
            return FhirResourceSerializer.serializeArray(value, AdministrableProductDefinitionRouteOfAdministrationSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AdministrableProductDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AdministrableProductDefinitionSerializer.propertyToSerializerMap) {
                if (AdministrableProductDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AdministrableProductDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);

...
class CoverageEligibilityResponseSerializer {
    static propertyToSerializerMap = {
        ...
        insurance: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CoverageEligibilityResponseInsuranceSerializer, context);
        },
        preAuthRef: null,
        form: (value, context) => {
        ...
        error: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CoverageEligibilityResponseErrorSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => CoverageEligibilityResponseSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in CoverageEligibilityResponseSerializer.propertyToSerializerMap) {
                if (CoverageEligibilityResponseSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = CoverageEligibilityResponseSerializer.propertyToSerializerMap[propertyName](value, context);

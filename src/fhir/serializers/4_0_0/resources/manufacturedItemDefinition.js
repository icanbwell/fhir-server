...
class ManufacturedItemDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        status: null,
        manufacturedDoseForm: (value, context) => {
        ...
        property: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ManufacturedItemDefinitionPropertySerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ManufacturedItemDefinitionSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ManufacturedItemDefinitionSerializer.propertyToSerializerMap) {
                if (ManufacturedItemDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ManufacturedItemDefinitionSerializer.propertyToSerializerMap[propertyName](value, context);

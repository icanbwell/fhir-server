...
/** @type {import('../backbone_elements/manufacturedItemDefinitionProperty.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ManufacturedItemDefinitionProperty' && !ManufacturedItemDefinitionPropertySerializer) {
        ManufacturedItemDefinitionPropertySerializer = require('../backbone_elements/manufacturedItemDefinitionProperty.js');
        return ManufacturedItemDefinitionPropertySerializer;
    }
}
...
class ManufacturedItemDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        property: (value) => {
            initializeSerializers('ManufacturedItemDefinitionProperty');
            return FhirResourceSerializer.serializeArray(value, ManufacturedItemDefinitionPropertySerializer);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => ManufacturedItemDefinitionSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in ManufacturedItemDefinitionSerializer.propertyToSerializerMap) {
                if (ManufacturedItemDefinitionSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = ManufacturedItemDefinitionSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = ManufacturedItemDefinitionSerializer;

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'AccountCoverage' && !AccountCoverage) {
        AccountCoverage = require('../backbone_elements/accountCoverage.js');
        return AccountCoverage;
    }
    if (serializerName === 'AccountGuarantor' && !AccountGuarantor) {
        AccountGuarantor = require('../backbone_elements/accountGuarantor.js');
...
class AccountSerializer {
    static propertyToSerializerMap = {
        ...
        coverage: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, AccountCoverage);
        },
        owner: (value) => {
            initializeSerializers('Reference');
        ...
        guarantor: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, AccountGuarantor);
        },
        partOf: (value) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serialize(value, Reference);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SubscriptionStatusNotificationEvent' && !SubscriptionStatusNotificationEvent) {
        SubscriptionStatusNotificationEvent = require('../backbone_elements/subscriptionStatusNotificationEvent.js');
...
class SubscriptionStatusSerializer {
    static propertyToSerializerMap = {
        ...
        notificationEvent: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, SubscriptionStatusNotificationEvent);
        },
        subscription: (value) => {

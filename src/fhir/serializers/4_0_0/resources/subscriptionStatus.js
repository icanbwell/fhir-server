...
const SubscriptionStatusNotificationEventSerializer = require('../backbone_elements/subscriptionStatusNotificationEvent.js');
...
class SubscriptionStatusSerializer {
    static propertyToSerializerMap = {
        ...
        notificationEvent: (value) => SubscriptionStatusNotificationEventSerializer.serialize(value),
        subscription: (value) => ReferenceSerializer.serialize(value),
        topic: null,
        error: (value) => CodeableConceptSerializer.serialize(value),
        resourceType: null
    };

...
class SubscriptionStatusSerializer {
    static propertyToSerializerMap = {
        ...
        notificationEvent: (value, context) => {
            initializeSerializers('SubscriptionStatusNotificationEvent');
            return FhirResourceSerializer.serializeArray(value, SubscriptionStatusNotificationEventSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubscriptionStatusSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubscriptionStatusSerializer.propertyToSerializerMap) {
                if (SubscriptionStatusSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubscriptionStatusSerializer.propertyToSerializerMap[propertyName](value, context);

...
const GoalTargetSerializer = require('../backbone_elements/goalTarget.js');
...
class GoalSerializer {
    static propertyToSerializerMap = {
        ...
        achievementStatus: (value) => CodeableConceptSerializer.serialize(value),
        ...
        startDate: null,
        startCodeableConcept: (value) => CodeableConceptSerializer.serialize(value),
        target: (value) => GoalTargetSerializer.serialize(value),
        statusDate: null,
        statusReason: null,
        expressedBy: (value) => ReferenceSerializer.serialize(value),
        addresses: (value) => ReferenceSerializer.serialize(value),
        note: (value) => AnnotationSerializer.serialize(value),
        outcomeCode: (value) => CodeableConceptSerializer.serialize(value),
        outcomeReference: (value) => ReferenceSerializer.serialize(value),
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => GoalSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in GoalSerializer.propertyToSerializerMap) {
                if (GoalSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = GoalSerializer.propertyToSerializerMap[propertyName](value);

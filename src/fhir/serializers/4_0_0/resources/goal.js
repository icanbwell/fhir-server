...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'GoalTarget' && !GoalTarget) {
        GoalTarget = require('../backbone_elements/goalTarget.js');
        return GoalTarget;
    }
...
class GoalSerializer {
    static propertyToSerializerMap = {
        ...
        target: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, GoalTarget);
        },
        statusDate: null,
        statusReason: null,
        expressedBy: (value) => {

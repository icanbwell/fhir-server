...
class OrganizationAffiliationSerializer {
    static propertyToSerializerMap = {
        ...
        participatingOrganization: (value) => ReferenceSerializer.serialize(value),
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => OrganizationAffiliationSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in OrganizationAffiliationSerializer.propertyToSerializerMap) {
                if (OrganizationAffiliationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = OrganizationAffiliationSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = OrganizationAffiliationSerializer;
...
class OrganizationAffiliationSerializer {
    static propertyToSerializerMap = {
        ...
        participatingOrganization: (value, context) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serialize(value, ReferenceSerializer, context);
        },
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => OrganizationAffiliationSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in OrganizationAffiliationSerializer.propertyToSerializerMap) {
                if (OrganizationAffiliationSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = OrganizationAffiliationSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CompartmentDefinitionResource' && !CompartmentDefinitionResource) {
        CompartmentDefinitionResource = require('../backbone_elements/compartmentDefinitionResource.js');
...
class CompartmentDefinitionSerializer {
    static propertyToSerializerMap = {
        ...
        resource: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CompartmentDefinitionResource);
        },
        resourceType: null
    };

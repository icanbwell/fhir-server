...
/** @type {import('../backbone_elements/compartmentDefinitionResource.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CompartmentDefinitionResource' && !CompartmentDefinitionResourceSerializer) {
        CompartmentDefinitionResourceSerializer = require('../backbone_elements/compartmentDefinitionResource.js');
        return CompartmentDefinitionResourceSerializer;
    }
}
...
module.exports = CompartmentDefinitionSerializer;

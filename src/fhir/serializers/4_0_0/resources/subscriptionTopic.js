...
class SubscriptionTopicSerializer {
    static propertyToSerializerMap = {
        ...
        resourceTrigger: (value, context) => {
            initializeSerializers('SubscriptionTopicResourceTrigger');
            return FhirResourceSerializer.serializeArray(value, SubscriptionTopicResourceTriggerSerializer, context);
        },
        eventTrigger: (value, context) => {
            initializeSerializers('SubscriptionTopicEventTrigger');
            return FhirResourceSerializer.serializeArray(value, SubscriptionTopicEventTriggerSerializer, context);
        },
        canFilterBy: (value, context) => {
            initializeSerializers('SubscriptionTopicCanFilterBy');
            return FhirResourceSerializer.serializeArray(value, SubscriptionTopicCanFilterBySerializer, context);
        },
        notificationShape: (value, context) => {
            initializeSerializers('SubscriptionTopicNotificationShape');
            return FhirResourceSerializer.serializeArray(value, SubscriptionTopicNotificationShapeSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SubscriptionTopicSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SubscriptionTopicSerializer.propertyToSerializerMap) {
                if (SubscriptionTopicSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SubscriptionTopicSerializer.propertyToSerializerMap[propertyName](value, context);

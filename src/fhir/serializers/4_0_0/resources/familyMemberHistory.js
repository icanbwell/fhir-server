...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'FamilyMemberHistoryCondition' && !FamilyMemberHistoryConditionSerializer) {
        FamilyMemberHistoryConditionSerializer = require('../backbone_elements/familyMemberHistoryCondition.js');
        return FamilyMemberHistoryConditionSerializer;
    }
}
...
class FamilyMemberHistorySerializer {
    static propertyToSerializerMap = {
        ...
        deceasedAge: (value, context) => {
            initializeSerializers('Quantity');
            return FhirResourceSerializer.serialize(value, QuantitySerializer, context);
        },
        deceasedRange: (value, context) => {
            initializeSerializers('Range');
            return FhirResourceSerializer.serialize(value, RangeSerializer, context);
        },
        deceasedDate: null,
        ...
        condition: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, FamilyMemberHistoryConditionSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => FamilyMemberHistorySerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in FamilyMemberHistorySerializer.propertyToSerializerMap) {
                if (FamilyMemberHistorySerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = FamilyMemberHistorySerializer.propertyToSerializerMap[propertyName](value, context);

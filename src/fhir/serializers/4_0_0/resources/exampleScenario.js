...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ExampleScenarioActor' && !ExampleScenarioActor) {
        ExampleScenarioActor = require('../backbone_elements/exampleScenarioActor.js');
        return ExampleScenarioActor;
    }
    if (serializerName === 'ExampleScenarioInstance' && !ExampleScenarioInstance) {
        ExampleScenarioInstance = require('../backbone_elements/exampleScenarioInstance.js');
...
class ExampleScenarioSerializer {
    static propertyToSerializerMap = {
        ...
        actor: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ExampleScenarioActor);
        },
        instance: (value) => {
            initializeSerializers('ExampleScenarioInstance');
            return FhirResourceSerializer.serializeArray(value, ExampleScenarioInstance);
        },
        process: (value) => {

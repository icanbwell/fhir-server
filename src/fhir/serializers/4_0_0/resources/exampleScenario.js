...
/** @type {import('../backbone_elements/exampleScenarioActor.js')} */
let ExampleScenarioActorSerializer;
/** @type {import('../backbone_elements/exampleScenarioInstance.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ExampleScenarioActor' && !ExampleScenarioActorSerializer) {
        ExampleScenarioActorSerializer = require('../backbone_elements/exampleScenarioActor.js');
        return ExampleScenarioActorSerializer;
    }
    if (serializerName === 'ExampleScenarioInstance' && !ExampleScenarioInstanceSerializer) {
        ExampleScenarioInstanceSerializer = require('../backbone_elements/exampleScenarioInstance.js');
        return ExampleScenarioInstanceSerializer;
    }

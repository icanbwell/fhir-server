...
class BodyStructureSerializer {
    static propertyToSerializerMap = {
        ...
        locationQualifier: (value, context) => {
            initializeSerializers('CodeableConcept');
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => BodyStructureSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in BodyStructureSerializer.propertyToSerializerMap) {
                if (BodyStructureSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = BodyStructureSerializer.propertyToSerializerMap[propertyName](value, context);

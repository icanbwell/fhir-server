...
class BodyStructureSerializer {
    static propertyToSerializerMap = {
        ...
        active: null,
        morphology: (value) => CodeableConceptSerializer.serialize(value),
        location: (value) => CodeableConceptSerializer.serialize(value),
        locationQualifier: (value) => CodeableConceptSerializer.serialize(value),
        description: null,
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => BodyStructureSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in BodyStructureSerializer.propertyToSerializerMap) {
                if (BodyStructureSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = BodyStructureSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = BodyStructureSerializer;
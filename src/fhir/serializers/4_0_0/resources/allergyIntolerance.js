...
/** @type {import('../backbone_elements/allergyIntoleranceReaction.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'AllergyIntoleranceReaction' && !AllergyIntoleranceReactionSerializer) {
        AllergyIntoleranceReactionSerializer = require('../backbone_elements/allergyIntoleranceReaction.js');
        return AllergyIntoleranceReactionSerializer;
    }
}
...
class AllergyIntoleranceSerializer {
    static propertyToSerializerMap = {
        ...
        reaction: (value, context) => {
            initializeSerializers('AllergyIntoleranceReaction');
            return FhirResourceSerializer.serializeArray(value, AllergyIntoleranceReactionSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => AllergyIntoleranceSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in AllergyIntoleranceSerializer.propertyToSerializerMap) {
                if (AllergyIntoleranceSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = AllergyIntoleranceSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'AllergyIntoleranceReaction' && !AllergyIntoleranceReaction) {
        AllergyIntoleranceReaction = require('../backbone_elements/allergyIntoleranceReaction.js');
...
class AllergyIntoleranceSerializer {
    static propertyToSerializerMap = {
        ...
        reaction: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, AllergyIntoleranceReaction);
        },
        resourceType: null
    };

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'DeviceMetricCalibration' && !DeviceMetricCalibration) {
        DeviceMetricCalibration = require('../backbone_elements/deviceMetricCalibration.js');
...
class DeviceMetricSerializer {
    static propertyToSerializerMap = {
        ...
        calibration: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, DeviceMetricCalibration);
        },
        resourceType: null
    };

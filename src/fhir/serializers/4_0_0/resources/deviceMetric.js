...
class DeviceMetricSerializer {
    static propertyToSerializerMap = {
        ...
        color: null,
        category: null,
        measurementPeriod: (value, context) => {
            initializeSerializers('Timing');
            return FhirResourceSerializer.serialize(value, TimingSerializer, context);
        },
        calibration: (value, context) => {
            initializeSerializers('DeviceMetricCalibration');
            return FhirResourceSerializer.serializeArray(value, DeviceMetricCalibrationSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceMetricSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceMetricSerializer.propertyToSerializerMap) {
                if (DeviceMetricSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceMetricSerializer.propertyToSerializerMap[propertyName](value, context);

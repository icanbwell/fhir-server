...
const DeviceMetricCalibrationSerializer = require('../backbone_elements/deviceMetricCalibration.js');
...
class DeviceMetricSerializer {
    static propertyToSerializerMap = {
        ...
        color: null,
        category: null,
        measurementPeriod: (value) => TimingSerializer.serialize(value),
        calibration: (value) => DeviceMetricCalibrationSerializer.serialize(value),
        resourceType: null
    };

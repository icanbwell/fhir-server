...
/** @type {import('../backbone_elements/deviceMetricCalibration.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'DeviceMetricCalibration' && !DeviceMetricCalibrationSerializer) {
        DeviceMetricCalibrationSerializer = require('../backbone_elements/deviceMetricCalibration.js');
        return DeviceMetricCalibrationSerializer;
    }
}
...
class DeviceMetricSerializer {
    static propertyToSerializerMap = {
        ...
        calibration: (value) => {
            initializeSerializers('DeviceMetricCalibration');
            return FhirResourceSerializer.serializeArray(value, DeviceMetricCalibrationSerializer);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => DeviceMetricSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in DeviceMetricSerializer.propertyToSerializerMap) {
                if (DeviceMetricSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = DeviceMetricSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = DeviceMetricSerializer;

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CodeSystemFilter' && !CodeSystemFilterSerializer) {
        CodeSystemFilterSerializer = require('../backbone_elements/codeSystemFilter.js');
        return CodeSystemFilterSerializer;
    }
    if (serializerName === 'CodeSystemProperty' && !CodeSystemPropertySerializer) {
        CodeSystemPropertySerializer = require('../backbone_elements/codeSystemProperty.js');
        return CodeSystemPropertySerializer;
    }
    if (serializerName === 'CodeSystemConcept' && !CodeSystemConceptSerializer) {
        CodeSystemConceptSerializer = require('../backbone_elements/codeSystemConcept.js');
        return CodeSystemConceptSerializer;
    }
}
...
class CodeSystemSerializer {
    static propertyToSerializerMap = {
        ...
        filter: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CodeSystemFilterSerializer);
        },
        property: (value) => {
            initializeSerializers('CodeSystemProperty');
            return FhirResourceSerializer.serializeArray(value, CodeSystemPropertySerializer);
        },
        concept: (value) => {

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'ConsentPolicy' && !ConsentPolicy) {
        ConsentPolicy = require('../backbone_elements/consentPolicy.js');
        return ConsentPolicy;
    }
    if (serializerName === 'ConsentVerification' && !ConsentVerification) {
        ConsentVerification = require('../backbone_elements/consentVerification.js');
        return ConsentVerification;
    }
    if (serializerName === 'ConsentProvision' && !ConsentProvision) {
        ConsentProvision = require('../backbone_elements/consentProvision.js');
...
class ConsentSerializer {
    static propertyToSerializerMap = {
        ...
        policy: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ConsentPolicy);
        },
        policyRule: (value) => {
            initializeSerializers('CodeableConcept');
            return FhirResourceSerializer.serialize(value, CodeableConcept);
        ...
        verification: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, ConsentVerification);
        },
        provision: (value) => {
            initializeSerializers('ConsentProvision');
            return FhirResourceSerializer.serialize(value, ConsentProvision);
        },
        resourceType: null
    };

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'InsurancePlanContact' && !InsurancePlanContactSerializer) {
        InsurancePlanContactSerializer = require('../backbone_elements/insurancePlanContact.js');
        return InsurancePlanContactSerializer;
    }
    if (serializerName === 'InsurancePlanCoverage' && !InsurancePlanCoverageSerializer) {
        InsurancePlanCoverageSerializer = require('../backbone_elements/insurancePlanCoverage.js');
        return InsurancePlanCoverageSerializer;
    }
    if (serializerName === 'InsurancePlanPlan' && !InsurancePlanPlanSerializer) {
        InsurancePlanPlanSerializer = require('../backbone_elements/insurancePlanPlan.js');
        return InsurancePlanPlanSerializer;
    }
}
...
class InsurancePlanSerializer {
    static propertyToSerializerMap = {
        ...
        contact: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanContactSerializer);
        },
        endpoint: (value) => {
            initializeSerializers('Reference');
            return FhirResourceSerializer.serializeArray(value, ReferenceSerializer);
        ...
        coverage: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanCoverageSerializer);
        },
        plan: (value) => {
            initializeSerializers('InsurancePlanPlan');
            return FhirResourceSerializer.serializeArray(value, InsurancePlanPlanSerializer);
        },
        resourceType: null
    };

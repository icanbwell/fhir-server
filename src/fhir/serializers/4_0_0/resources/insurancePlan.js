...
class InsurancePlanSerializer {
    static propertyToSerializerMap = {
        ...
        contact: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanContactSerializer, context);
        },
        ...
        coverage: (value, context) => {
            ...
            return FhirResourceSerializer.serializeArray(value, InsurancePlanCoverageSerializer, context);
        },
        plan: (value, context) => {
            initializeSerializers('InsurancePlanPlan');
            return FhirResourceSerializer.serializeArray(value, InsurancePlanPlanSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => InsurancePlanSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in InsurancePlanSerializer.propertyToSerializerMap) {
                if (InsurancePlanSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = InsurancePlanSerializer.propertyToSerializerMap[propertyName](value, context);

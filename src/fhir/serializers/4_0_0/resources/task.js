...
class TaskSerializer {
    static propertyToSerializerMap = {
        ...
        restriction: (value, context) => {
            initializeSerializers('TaskRestriction');
            return FhirResourceSerializer.serialize(value, TaskRestrictionSerializer, context);
        },
        input: (value, context) => {
            initializeSerializers('TaskInput');
            return FhirResourceSerializer.serializeArray(value, TaskInputSerializer, context);
        },
        output: (value, context) => {
            initializeSerializers('TaskOutput');
            return FhirResourceSerializer.serializeArray(value, TaskOutputSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => TaskSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in TaskSerializer.propertyToSerializerMap) {
                if (TaskSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = TaskSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'TaskRestriction' && !TaskRestriction) {
        TaskRestriction = require('../backbone_elements/taskRestriction.js');
        return TaskRestriction;
    }
    if (serializerName === 'TaskInput' && !TaskInput) {
        TaskInput = require('../backbone_elements/taskInput.js');
        return TaskInput;
    }
    if (serializerName === 'TaskOutput' && !TaskOutput) {
        TaskOutput = require('../backbone_elements/taskOutput.js');
        return TaskOutput;
    }
}
...
class TaskSerializer {
    static propertyToSerializerMap = {
        ...
        restriction: (value) => {
            ...
            return FhirResourceSerializer.serialize(value, TaskRestriction);
        },
        input: (value) => {
            initializeSerializers('TaskInput');
            return FhirResourceSerializer.serializeArray(value, TaskInput);
        },
        output: (value) => {
            initializeSerializers('TaskOutput');
            return FhirResourceSerializer.serializeArray(value, TaskOutput);
        },
        resourceType: null
    };

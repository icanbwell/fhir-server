...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SearchParameterComponent' && !SearchParameterComponent) {
        SearchParameterComponent = require('../backbone_elements/searchParameterComponent.js');
...
class SearchParameterSerializer {
    static propertyToSerializerMap = {
        ...
        component: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, SearchParameterComponent);
        },
        resourceType: null
    };

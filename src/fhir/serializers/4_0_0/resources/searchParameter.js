...
/** @type {import('../backbone_elements/searchParameterComponent.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'SearchParameterComponent' && !SearchParameterComponentSerializer) {
        SearchParameterComponentSerializer = require('../backbone_elements/searchParameterComponent.js');
        return SearchParameterComponentSerializer;
    }
}
...
class SearchParameterSerializer {
    static propertyToSerializerMap = {
        ...
        component: (value, context) => {
            initializeSerializers('SearchParameterComponent');
            return FhirResourceSerializer.serializeArray(value, SearchParameterComponentSerializer, context);
        },
        resourceType: null
    };
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => SearchParameterSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in SearchParameterSerializer.propertyToSerializerMap) {
                if (SearchParameterSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = SearchParameterSerializer.propertyToSerializerMap[propertyName](value, context);

...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'NamingSystemUniqueId' && !NamingSystemUniqueId) {
        NamingSystemUniqueId = require('../backbone_elements/namingSystemUniqueId.js');
...
class NamingSystemSerializer {
    static propertyToSerializerMap = {
        ...
        uniqueId: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, NamingSystemUniqueId);
        },
        resourceType: null
    };

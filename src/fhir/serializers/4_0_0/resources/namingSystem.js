...
/** @type {import('../backbone_elements/namingSystemUniqueId.js')} */
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'NamingSystemUniqueId' && !NamingSystemUniqueIdSerializer) {
        NamingSystemUniqueIdSerializer = require('../backbone_elements/namingSystemUniqueId.js');
        return NamingSystemUniqueIdSerializer;
    }
}
...
module.exports = NamingSystemSerializer;

...
class EndpointSerializer {
    ...
    static serialize(rawJson, context = {}) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EndpointSerializer.serialize(item, context));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EndpointSerializer.propertyToSerializerMap) {
                if (EndpointSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EndpointSerializer.propertyToSerializerMap[propertyName](value, context);

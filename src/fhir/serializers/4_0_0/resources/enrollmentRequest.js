...
class EnrollmentRequestSerializer {
    static propertyToSerializerMap = {
        ...
        candidate: (value) => ReferenceSerializer.serialize(value),
    ...
    static serialize(rawJson) {
        ...
        if (Array.isArray(rawJson)) {
            return rawJson.map(item => EnrollmentRequestSerializer.serialize(item));
        }
        ...
        Object.keys(rawJson).forEach(propertyName => {
            ...
            if (propertyName in EnrollmentRequestSerializer.propertyToSerializerMap) {
                if (EnrollmentRequestSerializer.propertyToSerializerMap[propertyName]) {
                    const serializedValue = EnrollmentRequestSerializer.propertyToSerializerMap[propertyName](value);
...
module.exports = EnrollmentRequestSerializer;
...
function initializeSerializers(serializerName) {
    ...
    if (serializerName === 'CommunicationRequestPayload' && !CommunicationRequestPayload) {
        CommunicationRequestPayload = require('../backbone_elements/communicationRequestPayload.js');
...
class CommunicationRequestSerializer {
    static propertyToSerializerMap = {
        ...
        payload: (value) => {
            ...
            return FhirResourceSerializer.serializeArray(value, CommunicationRequestPayload);
        },

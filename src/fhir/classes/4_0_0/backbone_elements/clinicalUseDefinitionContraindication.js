...
*/
class ClinicalUseDefinitionContraindication extends Element {
    /**
    ...
    */
    ...
    itself).
        ...
        */
        ...
        /**
         * @description The status of the disease or symptom for the contraindication, for example
        ...
        */
        Object.defineProperty(this, 'indication', {
            ...
            set: valueProvided => {
                ...
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.indication = FhirResourceCreator.createArray(valueProvided, Reference);
            }
        });
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.indication) {await async.each(this.indication, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
...
module.exports = ClinicalUseDefinitionContraindication;

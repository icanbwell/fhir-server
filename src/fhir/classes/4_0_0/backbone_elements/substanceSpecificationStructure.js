...
class SubstanceSpecificationStructure extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.isotope) { async.each(this.isotope, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.representation) { async.each(this.representation, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

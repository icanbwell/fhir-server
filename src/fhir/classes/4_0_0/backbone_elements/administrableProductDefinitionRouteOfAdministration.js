...
AdministrableProductDefinition.RouteOfAdministration
    ...
    performed).
*/
class AdministrableProductDefinitionRouteOfAdministration extends Element {
    /**
     ...
     * @param {AdministrableProductDefinitionTargetSpecies[]|undefined} [targetSpecies],
    */
    constructor (
        {
            id,
    ...
    using a numerical value and its unit of measurement.
        ...
        */
        ...
        /**
         * @description The maximum single dose that can be administered, specified using a numerical
    ...
    24-h period) that can be administered.
        ...
        */
         ...
         * @property {AdministrableProductDefinitionTargetSpecies[]|undefined}
        */
        Object.defineProperty(this, 'targetSpecies', {
            ...
            set: valueProvided => {
                ...
                const AdministrableProductDefinitionTargetSpecies = require('../backbone_elements/administrableProductDefinitionTargetSpecies.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.targetSpecies = FhirResourceCreator.createArray(valueProvided, AdministrableProductDefinitionTargetSpecies);
            }
        });
...
module.exports = AdministrableProductDefinitionRouteOfAdministration;

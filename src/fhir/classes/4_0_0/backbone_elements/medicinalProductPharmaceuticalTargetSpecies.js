        ...
        */
        Object.defineProperty(this, 'withdrawalPeriod', {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.withdrawalPeriod = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof MedicinalProductPharmaceuticalWithdrawalPeriod ?
                                v : new MedicinalProductPharmaceuticalWithdrawalPeriod(v)
                            );
                } else {
                    if (valueProvided instanceof MedicinalProductPharmaceuticalWithdrawalPeriod) {
                        this.__data.withdrawalPeriod = valueProvided;
                    } else {
                        this.__data.withdrawalPeriod = [new MedicinalProductPharmaceuticalWithdrawalPeriod(valueProvided)];
                    }
                }
            }
        });

...
*/
class TestReportSetup extends Resource {
    /**
        ...
        */
        Object.defineProperty(this, 'action', {
            ...
            set: valueProvided => {
                ...
                this.__data.action = Array.isArray(valueProvided) ? valueProvided.map(v => new TestReportAction(v)) : [new TestReportAction(valueProvided)];
            }
        });

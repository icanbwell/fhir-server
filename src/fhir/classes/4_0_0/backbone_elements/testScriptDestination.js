...
*/
class TestScriptDestination extends Element {
    /**
    ...
    */
    ...
    itself).
        ...
        */
        ...
        /**
         * @description Abstract name given to a destination server in this test script.  The name is
        ...
        */
        Object.defineProperty(this, 'profile', {
            ...
            set: valueProvided => {
                ...
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.profile = FhirResourceCreator.create(valueProvided, Coding);
            }
        });
    ...
    async updateReferencesAsync ({fnUpdateReferenceAsync}) {
            ...
            if (this.profile) { await this.profile.updateReferencesAsync({fnUpdateReferenceAsync}); }
    }

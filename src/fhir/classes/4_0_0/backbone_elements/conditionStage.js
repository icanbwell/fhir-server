...
class ConditionStage extends Element {
    ...
    */
        ...
        */
        Object.defineProperty(this, 'assessment', {
            ...
            set: valueProvided => {
                ...
                this.__data.assessment = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new Reference(v)) : [new Reference(valueProvided)];
            }
        });
    ...
    updateReferences(fnUpdateReference) {
            ...
            if (this.summary) {this.summary.updateReferences(fnUpdateReference);}
            if (this.assessment) {this.assessment.forEach(v => v.updateReferences(fnUpdateReference));}

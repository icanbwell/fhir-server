...
class ConsentProvision extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.purpose) { async.each(this.purpose, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.data) { async.each(this.data, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.provision) { async.each(this.provision, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

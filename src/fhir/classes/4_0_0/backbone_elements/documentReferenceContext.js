        ...
        */
        Object.defineProperty(this, 'facilityType', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (valueProvided instanceof CodeableConcept){
                    this.__data.facilityType = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'practiceSetting', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (valueProvided instanceof CodeableConcept){
                    this.__data.practiceSetting = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'sourcePatientInfo', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.sourcePatientInfo = valueProvided;
                } else {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    ...
                    if (valueProvided instanceof Reference) {
                        ...
                        this.__data.related = [new Reference(valueProvided)];
                    }
                }
            }
        });

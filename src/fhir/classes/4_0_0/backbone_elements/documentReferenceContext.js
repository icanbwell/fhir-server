...
*/
class DocumentReferenceContext extends Resource {
    /**
        ...
        */
        Object.defineProperty(this, 'related', {
            ...
            set: valueProvided => {
                ...
                let Reference = require('../complex_types/reference.js');
                this.__data.related = Array.isArray(valueProvided) ? valueProvided.map(v => new Reference(v)) : [new Reference(valueProvided)];
            }
        });

...
class ValueSetCompose extends Element {
    ...
    */
    ...
    updateReferences({fnUpdateReference}) {
            ...
            if (this.include) {this.include.forEach(v => v.updateReferences({fnUpdateReference}));}
            if (this.exclude) {this.exclude.forEach(v => v.updateReferences({fnUpdateReference}));}
    }

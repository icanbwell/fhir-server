...
*/
class MedicationKnowledgeSubstitution extends Element {
    /**
    ...
    itself).
        ...
        */
        Object.defineProperty(this, 'allowed', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.allowed = undefined;
                    return;
                }
                this.__data.allowed = valueProvided;
            }
        });
...
module.exports = MedicationKnowledgeSubstitution;

...
class ConsentVerification extends Element {
    ...
    */
    ...
    itself).
        ...
        */
        Object.defineProperty(this, 'verified', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.verified = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'verifiedWith', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.verifiedWith = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.verifiedWith = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'verificationDate', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.verificationDate = undefined;
                    return;
                }
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.verifiedWith) {await this.verifiedWith.updateReferencesAsync({fnUpdateReferenceAsync});}
    }

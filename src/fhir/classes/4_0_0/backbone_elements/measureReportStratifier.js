...
class MeasureReportStratifier extends Element {
    ...
    */
    ...
    strata, one for each possible gender value.
        ...
        */
        Object.defineProperty(this, 'stratum', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.stratum = undefined;
                    return;
                }
                const MeasureReportStratum = require('../backbone_elements/measureReportStratum.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.stratum = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof MeasureReportStratum ?
                                v : new MeasureReportStratum(v)
                            );
                } else {
                    if (valueProvided instanceof MeasureReportStratum) {
                        this.__data.stratum = valueProvided;
                    } else {
                        this.__data.stratum = [new MeasureReportStratum(valueProvided)];
                    }
                }
            }
        });
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.stratum) {await async.each(this.stratum, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

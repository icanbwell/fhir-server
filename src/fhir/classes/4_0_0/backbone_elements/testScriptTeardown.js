            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.action = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof TestScriptAction2 ?
                                v : new TestScriptAction2(v)
                            );
                } else {
                    if (valueProvided instanceof TestScriptAction2) {
                        this.__data.action = valueProvided;
                    } else {
                        this.__data.action = [new TestScriptAction2(valueProvided)];
                    }
                }
            }
        });

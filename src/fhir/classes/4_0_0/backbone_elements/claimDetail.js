            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.subDetail = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof ClaimSubDetail ?
                                v : new ClaimSubDetail(v)
                            );
                } else {
                    if (valueProvided instanceof ClaimSubDetail) {
                        this.__data.subDetail = valueProvided;
                    } else {
                        this.__data.subDetail = [new ClaimSubDetail(valueProvided)];
                    }
                }
            }
        });

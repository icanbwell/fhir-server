...
*/
class NutritionProductNutrient extends Element {
    /**
     * @param {String|undefined} [id],
     * @param {Extension[]|undefined} [extension],
     * @param {Extension[]|undefined} [modifierExtension],
     * @param {CodeableReference|undefined} [item],
    ...
    */
    ...
    itself).
        ...
        */
        ...
        /**
         * @description The amount of nutrient expressed in one or more units: X per pack / per
    serving / per dose.
        ...
        */
        Object.defineProperty(this, 'amount', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.amount = FhirResourceCreator.createArray(valueProvided, Ratio);
            }
        });
    ...
    toJSON () {
        ...
        return removeNull({
            ...
            amount: this.amount && this.amount.map(v => v.toJSON())
        });
    }
    ...
    async updateReferencesAsync ({ fnUpdateReferenceAsync }) {
            ...
            if (this.amount) { await async.each(this.amount, async v => await v.updateReferencesAsync({ fnUpdateReferenceAsync })); }
    }
    ...
    toJSONInternal () {
        ...
        const json = {
            ...
            amount: this.amount && this.amount.map(v => v.toJSONInternal())
        };
...
module.exports = NutritionProductNutrient;

...
class SpecimenDefinitionTypeTested extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.rejectionCriterion) { async.each(this.rejectionCriterion, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.handling) { async.each(this.handling, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

...
Citation.Summary1
    ...
    resources.
*/
class CitationSummary1 extends Element {
    /**
     * @param {String|undefined} [id],
     * @param {Extension[]|undefined} [extension],
     * @param {Extension[]|undefined} [modifierExtension],
     * @param {CodeableConcept|undefined} [type],
     * @param {CodeableConcept|undefined} [style],
     * @param {CodeableConcept|undefined} [source],
    ...
    */
    ...
    itself).
        ...
        */
        Object.defineProperty(this, 'style', {
            ...
            enumerable: true,
            configurable: true,
            get: () => this.__data.style,
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.style = undefined;
                    return;
                }
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.style = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });
        ...
        */
        Object.defineProperty(this, 'source', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.source = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });

        /**
         * @description The display string for the author list, contributor list, or contributorship
    statement.
         * @property {markdown}
        */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.style) {await this.style.updateReferencesAsync({fnUpdateReferenceAsync});}
...
module.exports = CitationSummary1;

            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.detail = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof ExplanationOfBenefitDetail1 ?
                                v : new ExplanationOfBenefitDetail1(v)
                            );
                } else {
                    if (valueProvided instanceof ExplanationOfBenefitDetail1) {
                        this.__data.detail = valueProvided;
                    } else {
                        this.__data.detail = [new ExplanationOfBenefitDetail1(valueProvided)];
                    }
                }
            }
        });

...
*/
class InsurancePlanCoverage extends Element {
    /**
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.benefit = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof InsurancePlanBenefit ?
                                v : new InsurancePlanBenefit(v)
                            );
                } else {
                    if (valueProvided instanceof InsurancePlanBenefit) {
                        this.__data.benefit = valueProvided;
                    } else {
                        this.__data.benefit = [new InsurancePlanBenefit(valueProvided)];
                    }
                }
            }
        });

...
*/
class ProductShelfLife extends Resource {
    /**
        ...
        */
        Object.defineProperty(this, 'specialPrecautionsForStorage', {
            ...
            set: valueProvided => {
                ...
                let CodeableConcept = require('../complex_types/codeableConcept.js');
                this.__data.specialPrecautionsForStorage = Array.isArray(valueProvided) ? valueProvided.map(v => new CodeableConcept(v)) : [new CodeableConcept(valueProvided)];
            }
        });

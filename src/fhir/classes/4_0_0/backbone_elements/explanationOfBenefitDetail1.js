            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.subDetail = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof ExplanationOfBenefitSubDetail1 ?
                                v : new ExplanationOfBenefitSubDetail1(v)
                            );
                } else {
                    if (valueProvided instanceof ExplanationOfBenefitSubDetail1) {
                        this.__data.subDetail = valueProvided;
                    } else {
                        this.__data.subDetail = [new ExplanationOfBenefitSubDetail1(valueProvided)];
                    }
                }
            }
        });

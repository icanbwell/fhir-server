        ...
        */
        Object.defineProperty(this, 'rating', {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.rating = valueProvided
                            .filter(v => v)
                    ...
                    if (valueProvided instanceof CodeableConcept) {
                        ...
                        this.__data.rating = [new CodeableConcept(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'certaintySubcomponent', {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.certaintySubcomponent = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof EffectEvidenceSynthesisCertaintySubcomponent ?
                                v : new EffectEvidenceSynthesisCertaintySubcomponent(v)
                            );
                } else {
                    if (valueProvided instanceof EffectEvidenceSynthesisCertaintySubcomponent) {
                        this.__data.certaintySubcomponent = valueProvided;
                    } else {
                        this.__data.certaintySubcomponent = [new EffectEvidenceSynthesisCertaintySubcomponent(valueProvided)];
                    }
                }
            }
        });

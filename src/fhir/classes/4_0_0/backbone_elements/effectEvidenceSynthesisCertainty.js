        ...
        */
        Object.defineProperty(this, 'certaintySubcomponent', {
            ...
            set: value => {
                ...
                this.__data.certaintySubcomponent = Array.isArray(value) ? value.map(v => new EffectEvidenceSynthesisCertaintySubcomponent(v)) : [new EffectEvidenceSynthesisCertaintySubcomponent(value)];
            }
        });

...
class ImmunizationProtocolApplied extends Element {
    ...
    */
        ...
        */
        Object.defineProperty(this, 'targetDisease', {
            ...
            set: valueProvided => {
                ...
                this.__data.targetDisease = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new CodeableConcept(v)) : [new CodeableConcept(valueProvided)];
            }
        });
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.targetDisease) {await async.each(this.targetDisease, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

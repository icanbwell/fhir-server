...
class ContractOffer extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.party) { async.each(this.party, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.decisionMode) { async.each(this.decisionMode, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

        ...
        */
        Object.defineProperty(this, 'certaintySubcomponent', {
            ...
            set: value => {
                ...
                this.__data.certaintySubcomponent = Array.isArray(value) ? value.map(v => new RiskEvidenceSynthesisCertaintySubcomponent(v)) : [new RiskEvidenceSynthesisCertaintySubcomponent(value)];
            }
        });

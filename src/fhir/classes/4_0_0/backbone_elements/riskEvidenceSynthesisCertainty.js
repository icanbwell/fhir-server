            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.certaintySubcomponent = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof RiskEvidenceSynthesisCertaintySubcomponent ?
                                v : new RiskEvidenceSynthesisCertaintySubcomponent(v)
                            );
                } else {
                    if (valueProvided instanceof RiskEvidenceSynthesisCertaintySubcomponent) {
                        this.__data.certaintySubcomponent = valueProvided;
                    } else {
                        this.__data.certaintySubcomponent = [new RiskEvidenceSynthesisCertaintySubcomponent(valueProvided)];
                    }
                }
            }
        });

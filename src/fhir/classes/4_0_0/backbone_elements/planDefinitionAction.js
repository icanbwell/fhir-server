...
class PlanDefinitionAction extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.documentation) { async.each(this.documentation, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.trigger) { async.each(this.trigger, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.relatedAction) { async.each(this.relatedAction, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

...
*/
class MedicinalProductDefinitionName extends Element {
    /**
     ...
     * @param {MedicinalProductDefinitionNamePart[]|undefined} [namePart],
     * @param {MedicinalProductDefinitionCountryLanguage[]|undefined} [countryLanguage],
    */
    constructor (
        {
            id,
    ...
    itself).
        ...
        */
         ...
         * @property {MedicinalProductDefinitionNamePart[]|undefined}
        */
        Object.defineProperty(this, 'namePart', {
            ...
            set: valueProvided => {
                ...
                const MedicinalProductDefinitionNamePart = require('../backbone_elements/medicinalProductDefinitionNamePart.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.namePart = FhirResourceCreator.createArray(valueProvided, MedicinalProductDefinitionNamePart);
            }
        });

        /**
         * @description Country and jurisdiction where the name applies, and associated language.
         * @property {MedicinalProductDefinitionCountryLanguage[]|undefined}
        */
        Object.defineProperty(this, 'countryLanguage', {
            ...
            set: valueProvided => {
                ...
                const MedicinalProductDefinitionCountryLanguage = require('../backbone_elements/medicinalProductDefinitionCountryLanguage.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.countryLanguage = FhirResourceCreator.createArray(valueProvided, MedicinalProductDefinitionCountryLanguage);
            }
        });
    ...
    async updateReferencesAsync ({ fnUpdateReferenceAsync }) {
            ...
            if (this.namePart) { await async.each(this.namePart, async v => await v.updateReferencesAsync({ fnUpdateReferenceAsync })); }
            if (this.countryLanguage) { await async.each(this.countryLanguage, async v => await v.updateReferencesAsync({ fnUpdateReferenceAsync })); }
    }
...
module.exports = MedicinalProductDefinitionName;

...
*/
class GraphDefinitionLink extends Resource {
    /**
        ...
        */
        Object.defineProperty(this, 'target', {
            ...
            set: valueProvided => {
                ...
                this.__data.target = Array.isArray(valueProvided) ? valueProvided.map(v => new GraphDefinitionTarget(v)) : [new GraphDefinitionTarget(valueProvided)];
            }
        });

    ...
    Substance ID.
        ...
        */
        Object.defineProperty(this, 'nTerminalModificationId', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.nTerminalModificationId = null;
                    return;
                }
    ...
    shall be specified.
        ...
        */
        Object.defineProperty(this, 'nTerminalModification', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.nTerminalModification = null;
                    return;
                }
    ...
    Substance ID.
        ...
        */
        Object.defineProperty(this, 'cTerminalModificationId', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.cTerminalModificationId = null;
                    return;
                }
                let Identifier = require('../complex_types/identifier.js');
        ...
        */
        Object.defineProperty(this, 'cTerminalModification', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.cTerminalModification = null;
                    return;
                }

...
*/
class MedicinalProductAuthorizationProcedure extends Resource {
    /**
        ...
        */
        Object.defineProperty(this, 'application', {
            ...
            set: valueProvided => {
                ...
                this.__data.application = Array.isArray(valueProvided) ? valueProvided.map(v => new MedicinalProductAuthorizationProcedure(v)) : [new MedicinalProductAuthorizationProcedure(valueProvided)];
            }
        });

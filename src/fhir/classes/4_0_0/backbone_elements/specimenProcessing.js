...
class SpecimenProcessing extends Element {
    ...
    */
        ...
        */
        Object.defineProperty(this, 'additive', {
            ...
            set: valueProvided => {
                ...
                this.__data.additive = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new Reference(v)) : [new Reference(valueProvided)];
            }
        });
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.additive) { async.each(this.additive, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

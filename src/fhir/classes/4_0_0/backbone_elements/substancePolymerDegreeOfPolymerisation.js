...
SubstancePolymer.DegreeOfPolymerisation
    Todo.
*/
class SubstancePolymerDegreeOfPolymerisation extends Element {
    /**
    ...
    */
        ...
        */
        Object.defineProperty(this, 'degree', {
            ...
            set: valueProvided => {
                ...
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.degree = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });
    ...
    async updateReferencesAsync ({fnUpdateReferenceAsync}) {
            ...
            if (this.degree) { await this.degree.updateReferencesAsync({fnUpdateReferenceAsync}); }

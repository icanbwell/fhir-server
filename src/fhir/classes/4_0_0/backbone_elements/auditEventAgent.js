...
class AuditEventAgent extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.role) { async.each(this.role, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.purposeOfUse) { async.each(this.purposeOfUse, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

...
*/
class InsurancePlanCost extends Resource {
    /**
        ...
        */
        Object.defineProperty(this, 'qualifiers', {
            ...
            set: valueProvided => {
                ...
                let CodeableConcept = require('../complex_types/codeableConcept.js');
                this.__data.qualifiers = Array.isArray(valueProvided) ? valueProvided.map(v => new CodeableConcept(v)) : [new CodeableConcept(valueProvided)];
            }
        });

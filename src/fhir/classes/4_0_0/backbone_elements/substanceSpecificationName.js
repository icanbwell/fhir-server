...
class SubstanceSpecificationName extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.language) { async.each(this.language, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.synonym) { async.each(this.synonym, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.translation) { async.each(this.translation, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.official) { async.each(this.official, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

...
class MedicationDispenseSubstitution extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.reason) { async.each(this.reason, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.responsibleParty) { async.each(this.responsibleParty, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

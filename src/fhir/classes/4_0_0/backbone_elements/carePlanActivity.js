...
class CarePlanActivity extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.outcomeCodeableConcept) { async.each(this.outcomeCodeableConcept, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.outcomeReference) { async.each(this.outcomeReference, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.progress) { async.each(this.progress, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

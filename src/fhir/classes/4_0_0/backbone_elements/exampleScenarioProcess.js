        ...
        */
        Object.defineProperty(this, 'step', {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.step = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof ExampleScenarioStep ?
                                v : new ExampleScenarioStep(v)
                            );
                } else {
                    if (valueProvided instanceof ExampleScenarioStep) {
                        this.__data.step = valueProvided;
                    } else {
                        this.__data.step = [new ExampleScenarioStep(valueProvided)];
                    }
                }
            }
        });

        ...
        */
        Object.defineProperty(this, 'validationStatus', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (valueProvided instanceof CodeableConcept){
                    this.__data.validationStatus = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'canPushUpdates', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (valueProvided instanceof CodeableConcept){
                    this.__data.canPushUpdates = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'pushTypeAvailable', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.pushTypeAvailable = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof CodeableConcept ?
                                v : new CodeableConcept(v)
                            );
                    ...
                    if (valueProvided instanceof CodeableConcept) {
                        ...
                        this.__data.pushTypeAvailable = [new CodeableConcept(valueProvided)];
                    }
                }
            }
        });

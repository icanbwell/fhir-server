...
*/
class InsurancePlanBenefit extends Element {
    /**
    ...
    */
        ...
        */
        Object.defineProperty(this, 'limit', {
            ...
            set: valueProvided => {
                ...
                const InsurancePlanLimit = require('../backbone_elements/insurancePlanLimit.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.limit = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof InsurancePlanLimit ?
                                v : new InsurancePlanLimit(v)
                            );
                } else {
                    if (valueProvided instanceof InsurancePlanLimit) {
                        this.__data.limit = valueProvided;
                    } else {
                        this.__data.limit = [new InsurancePlanLimit(valueProvided)];
                    }
                }
            }
        });
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.limit) {await async.each(this.limit, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

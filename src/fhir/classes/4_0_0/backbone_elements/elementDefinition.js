...
class ElementDefinition extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.example) { async.each(this.example, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.constraint) { async.each(this.constraint, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.binding) {await this.binding.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.mapping) { async.each(this.mapping, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

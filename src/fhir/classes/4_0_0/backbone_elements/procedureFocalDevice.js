...
class ProcedureFocalDevice extends Element {
    ...
    */
    ...
    itself).
        ...
        */
        Object.defineProperty(this, 'action', {
            ...
            set: valueProvided => {
                ...
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.action = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });
        ...
        */
        Object.defineProperty(this, 'manipulated', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.manipulated = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.manipulated = FhirResourceCreator.create(valueProvided, Reference);
            }
        });
    ...
    async updateReferencesAsync ({fnUpdateReferenceAsync}) {
            ...
            if (this.action) { await this.action.updateReferencesAsync({fnUpdateReferenceAsync}); }
            if (this.manipulated) { await this.manipulated.updateReferencesAsync({fnUpdateReferenceAsync}); }
    }

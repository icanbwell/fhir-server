...
*/
class TestReportTeardown extends Resource {
    /**
        ...
        */
        Object.defineProperty(this, 'action', {
            ...
            set: valueProvided => {
                ...
                this.__data.action = Array.isArray(valueProvided) ? valueProvided.map(v => new TestReportAction2(v)) : [new TestReportAction2(valueProvided)];
            }
        });

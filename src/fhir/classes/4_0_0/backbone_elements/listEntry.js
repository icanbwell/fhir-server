...
class ListEntry extends Element {
    ...
    */
    ...
    updateReferences(fnUpdateReference) {
            ...
            if (this.flag) {this.flag.updateReferences(fnUpdateReference);}
            if (this.item) {this.item.updateReferences(fnUpdateReference);}
    }

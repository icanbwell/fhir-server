...
class Dosage extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.additionalInstruction) { async.each(this.additionalInstruction, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.doseAndRate) { async.each(this.doseAndRate, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

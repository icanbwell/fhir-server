...
*/
class IngredientSubstance extends Element {
    /**
     * @param {String|undefined} [id],
     * @param {Extension[]|undefined} [extension],
     * @param {Extension[]|undefined} [modifierExtension],
     * @param {CodeableReference} code,
     * @param {IngredientStrength[]|undefined} [strength],
    */
    constructor (
        {
            id,
        ...
        */
        Object.defineProperty(this, 'code', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.code = FhirResourceCreator.create(valueProvided, CodeableReference);
            }
        });
    ...
    representations - mathematically equivalent - of a single strength.
         * @property {IngredientStrength[]|undefined}
        */
        Object.defineProperty(this, 'strength', {
            ...
            set: valueProvided => {
                ...
                const IngredientStrength = require('../backbone_elements/ingredientStrength.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.strength = FhirResourceCreator.createArray(valueProvided, IngredientStrength);
            }
        });
...
module.exports = IngredientSubstance;

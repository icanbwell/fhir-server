...
class InsurancePlanPlan extends Element {
    ...
    */
    ...
    updateReferences(fnUpdateReference) {
            ...
            if (this.generalCost) {this.generalCost.forEach(v => v.updateReferences(fnUpdateReference));}
            if (this.specificCost) {this.specificCost.forEach(v => v.updateReferences(fnUpdateReference));}
    }

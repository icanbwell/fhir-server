        ...
        Object.defineProperty(this, 'studyEffectivePeriod', {
            ...
            set: valueProvided => {
                ...
                if (valueProvided instanceof Period){
                    this.__data.studyEffectivePeriod = valueProvided;
                } else {
        ...
        Object.defineProperty(this, 'studyEffectiveDuration', {
            ...
            set: valueProvided => {
                ...
                if (valueProvided instanceof Quantity){
                    this.__data.studyEffectiveDuration = valueProvided;
                } else {
        ...
        Object.defineProperty(this, 'studyEffectiveTiming', {
            ...
            set: valueProvided => {
                ...
                if (valueProvided instanceof Timing){
                    this.__data.studyEffectiveTiming = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'studyEffectiveTimeFromStart', {
            ...
            set: valueProvided => {
                ...
                const Quantity = require('../complex_types/quantity.js');
                if (valueProvided instanceof Quantity){
                    this.__data.studyEffectiveTimeFromStart = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'participantEffectiveTimeFromStart', {
            ...
            set: valueProvided => {
                ...
                const Quantity = require('../complex_types/quantity.js');
                if (valueProvided instanceof Quantity){
                    this.__data.participantEffectiveTimeFromStart = valueProvided;
                } else {

...
*/
class TerminologyCapabilitiesTranslation extends Element {
    /**
    ...
    itself).
        ...
        */
        Object.defineProperty(this, 'needsMap', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.needsMap = undefined;
                    return;
                }
                this.__data.needsMap = valueProvided;
            }
        });
...
module.exports = TerminologyCapabilitiesTranslation;

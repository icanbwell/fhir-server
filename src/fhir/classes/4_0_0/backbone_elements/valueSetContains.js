...
class ValueSetContains extends Element {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.designation) { async.each(this.designation, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.contains) { async.each(this.contains, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

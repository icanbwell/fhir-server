...
class MeasureReportPopulation extends Element {
    ...
    */
    ...
    for each subject in this population.
        ...
        */
        Object.defineProperty(this, 'subjectResults', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.subjectResults = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.subjectResults = valueProvided;
                } else {
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.subjectResults) {await this.subjectResults.updateReferencesAsync({fnUpdateReferenceAsync});}
    }

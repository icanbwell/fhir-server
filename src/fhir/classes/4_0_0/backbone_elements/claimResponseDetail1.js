            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.subDetail = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof ClaimResponseSubDetail1 ?
                                v : new ClaimResponseSubDetail1(v)
                            );
                } else {
                    if (valueProvided instanceof ClaimResponseSubDetail1) {
                        this.__data.subDetail = valueProvided;
                    } else {
                        this.__data.subDetail = [new ClaimResponseSubDetail1(valueProvided)];
                    }
                }
            }
        });

            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.action = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof TestReportAction1 ?
                                v : new TestReportAction1(v)
                            );
                } else {
                    if (valueProvided instanceof TestReportAction1) {
                        this.__data.action = valueProvided;
                    } else {
                        this.__data.action = [new TestReportAction1(valueProvided)];
                    }
                }
            }
        });

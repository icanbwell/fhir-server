...
*/
class TestReportTest extends Resource {
    /**
        ...
        */
        Object.defineProperty(this, 'action', {
            ...
            set: valueProvided => {
                ...
                this.__data.action = Array.isArray(valueProvided) ? valueProvided.map(v => new TestReportAction1(v)) : [new TestReportAction1(valueProvided)];
            }
        });

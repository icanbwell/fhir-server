...
class Appointment extends Resource {
    ...
    required, or specific fees apply.
        ...
        */
        Object.defineProperty(this, 'cancelationReason', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.cancelationReason = undefined;
                    return;
                }
    ...
    service type).
        ...
        */
        Object.defineProperty(this, 'appointmentType', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.appointmentType = undefined;
                    return;
                }
                const CodeableConcept = require('../complex_types/codeableConcept.js');
    ...
    minutes less than the difference between the start and end.
        ...
        */
        Object.defineProperty(this, 'minutesDuration', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.minutesDuration = undefined;
                    return;
                }
    ...
    appointment.
        ...
        */
        Object.defineProperty(this, 'slot', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.slot = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
                this.__data.slot = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new Reference(v)) : [new Reference(valueProvided)];
            }
        });
        ...
        */
        Object.defineProperty(this, 'participant', {
            ...
            set: valueProvided => {
                ...
                const AppointmentParticipant = require('../backbone_elements/appointmentParticipant.js');
                this.__data.participant = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new AppointmentParticipant(v)) : [new AppointmentParticipant(valueProvided)];
            }
        });
    ...
    calculated by the scheduling system.
        ...
        */
        Object.defineProperty(this, 'requestedPeriod', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.requestedPeriod = undefined;
                    return;
                }
                const Period = require('../complex_types/period.js');
                this.__data.requestedPeriod = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new Period(v)) : [new Period(valueProvided)];
            }
        });
    ...
    */
    ...
    updateReferences({fnUpdateReference}) {
            ...
            if (this.cancelationReason) {this.cancelationReason.updateReferences({fnUpdateReference});}
            ...
            if (this.slot) {this.slot.forEach(v => v.updateReferences({fnUpdateReference}));}
            ...
            if (this.requestedPeriod) {this.requestedPeriod.forEach(v => v.updateReferences({fnUpdateReference}));}
    }
    ...
    toJSONInternal() {
        ...
        const json = {
            ...
            status: this.status,
            cancelationReason: this.cancelationReason && this.cancelationReason.toJSONInternal(),
            ...
            minutesDuration: this.minutesDuration,
            slot: this.slot && this.slot.map(v => v.toJSONInternal()),
            created: this.created,
            comment: this.comment,
            patientInstruction: this.patientInstruction,

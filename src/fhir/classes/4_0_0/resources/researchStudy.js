    ...
    classification of the intent of the study.
        ...
        */
        Object.defineProperty(this, 'primaryPurposeType', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.primaryPurposeType = null;
                    return;
                }
    ...
    interpretation and presentation.
        ...
        */
        Object.defineProperty(this, 'principalInvestigator', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.principalInvestigator = null;
                    return;
                }
                let Reference = require('../complex_types/reference.js');
        ...
        */
        Object.defineProperty(this, 'reasonStopped', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.reasonStopped = null;
                    return;
                }
                let CodeableConcept = require('../complex_types/codeableConcept.js');

            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.communication = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof RelatedPersonCommunication ?
                                v : new RelatedPersonCommunication(v)
                            );
                } else {
                    if (valueProvided instanceof RelatedPersonCommunication) {
                        this.__data.communication = valueProvided;
                    } else {
                        this.__data.communication = [new RelatedPersonCommunication(valueProvided)];
                    }
                }
            }
        });

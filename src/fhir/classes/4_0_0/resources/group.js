...
class Group extends Resource {
     ...
     * @param {boolean|undefined} [_extended]
    */
    constructor (
        {
            id,
        ...
        */
        Object.defineProperty(this, 'managingEntity', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.managingEntity = FhirResourceCreator.create(valueProvided, Reference);
            }
        });
        ...
        */
        Object.defineProperty(this, 'characteristic', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.characteristic = FhirResourceCreator.createArray(valueProvided, GroupCharacteristic);
            }
        });
        ...
        */
        Object.defineProperty(this, 'member', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.member = FhirResourceCreator.createArray(valueProvided, GroupMember);
            }
        });
        ...
        /**
         * @description _extended
         * @property {boolean|undefined}
         */
        Object.defineProperty(this, '_extended', {
            // https://www.w3schools.com/js/js_object_es5.asp
            enumerable: true,
            configurable: true,
            get: () => this.__data._extended,
            set: valueProvided => {
                this.__data._extended = valueProvided;
            }
        });
    ...
    */
    ...
    async updateReferencesAsync ({ fnUpdateReferenceAsync }) {
            ...
            if (this.managingEntity) { await this.managingEntity.updateReferencesAsync({ fnUpdateReferenceAsync }); }
            if (this.characteristic) { await async.each(this.characteristic, async v => await v.updateReferencesAsync({ fnUpdateReferenceAsync })); }
            if (this.member) { await async.each(this.member, async v => await v.updateReferencesAsync({ fnUpdateReferenceAsync })); }
    }

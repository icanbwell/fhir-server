...
class Encounter extends Resource {
        ...
        */
        Object.defineProperty(this, 'statusHistory', {
            ...
            set: valueProvided => {
                ...
                const EncounterStatusHistory = require('../backbone_elements/encounterStatusHistory.js');
        ...
        */
        Object.defineProperty(this, 'classHistory', {
            ...
            set: valueProvided => {
                ...
                const EncounterClassHistory = require('../backbone_elements/encounterClassHistory.js');
        ...
        */
        Object.defineProperty(this, 'participant', {
            ...
            set: valueProvided => {
                ...
                const EncounterParticipant = require('../backbone_elements/encounterParticipant.js');
        ...
        */
        Object.defineProperty(this, 'diagnosis', {
            ...
            set: valueProvided => {
                ...
                const EncounterDiagnosis = require('../backbone_elements/encounterDiagnosis.js');
        ...
        */
        Object.defineProperty(this, 'hospitalization', {
            ...
            set: valueProvided => {
                ...
                const EncounterHospitalization = require('../backbone_elements/encounterHospitalization.js');
        ...
        */
        Object.defineProperty(this, 'location', {
            ...
            set: valueProvided => {
                ...
                const EncounterLocation = require('../backbone_elements/encounterLocation.js');
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.statusHistory) { async.each(this.statusHistory, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.class) {await this.class.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.classHistory) { async.each(this.classHistory, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.type) { async.each(this.type, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.serviceType) {await this.serviceType.updateReferencesAsync({fnUpdateReferenceAsync});}
            ...
            if (this.episodeOfCare) { async.each(this.episodeOfCare, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.appointment) { async.each(this.appointment, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.period) {await this.period.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.length) {await this.length.updateReferencesAsync({fnUpdateReferenceAsync});}
            ...
            if (this.account) { async.each(this.account, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.hospitalization) {await this.hospitalization.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.location) { async.each(this.location, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.serviceProvider) {await this.serviceProvider.updateReferencesAsync({fnUpdateReferenceAsync});}

...
class Encounter extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.statusHistory) { async.each(this.statusHistory, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.class) {await this.class.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.classHistory) { async.each(this.classHistory, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            ...
            if (this.episodeOfCare) { async.each(this.episodeOfCare, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            ...
            if (this.appointment) { async.each(this.appointment, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}

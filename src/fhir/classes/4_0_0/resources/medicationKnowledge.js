...
class MedicationKnowledge extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.relatedMedicationKnowledge) { async.each(this.relatedMedicationKnowledge, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.associatedMedication) { async.each(this.associatedMedication, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.productType) { async.each(this.productType, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.monograph) { async.each(this.monograph, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.ingredient) { async.each(this.ingredient, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.intendedRoute) { async.each(this.intendedRoute, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.cost) { async.each(this.cost, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.monitoringProgram) { async.each(this.monitoringProgram, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.administrationGuidelines) { async.each(this.administrationGuidelines, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.medicineClassification) { async.each(this.medicineClassification, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.packaging) {await this.packaging.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.drugCharacteristic) { async.each(this.drugCharacteristic, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.contraindication) { async.each(this.contraindication, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.regulatory) { async.each(this.regulatory, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.kinetics) { async.each(this.kinetics, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

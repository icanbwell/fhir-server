...
class ImagingStudy extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.modality) { async.each(this.modality, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.interpreter) { async.each(this.interpreter, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.procedureCode) { async.each(this.procedureCode, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.series) { async.each(this.series, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

...
class ImplementationGuide extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.dependsOn) { async.each(this.dependsOn, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.global) { async.each(this.global, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

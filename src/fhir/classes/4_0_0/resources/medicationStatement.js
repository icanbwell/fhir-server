        ...
        */
        Object.defineProperty(this, 'informationSource', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.informationSource = FhirResourceCreator.create(valueProvided, Reference);
            }
        });
    ...
    */
    ...
    toJSONInternal() {
        ...
        const json = {
            ...
            dateAsserted: this.dateAsserted,
            informationSource: this.informationSource && this.informationSource.toJSONInternal(),

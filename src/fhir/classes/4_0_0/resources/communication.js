...
class Communication extends Resource {
    ...
    Communication.
        ...
        */
        Object.defineProperty(this, 'inResponseTo', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.inResponseTo = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
                this.__data.inResponseTo = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new Reference(v)) : [new Reference(valueProvided)];
            }
        });
    ...
    creation of this record is tightly associated.
        ...
        */
        Object.defineProperty(this, 'received', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.received = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'payload', {
            ...
            set: valueProvided => {
                ...
                const CommunicationPayload = require('../backbone_elements/communicationPayload.js');
                this.__data.payload = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new CommunicationPayload(v)) : [new CommunicationPayload(valueProvided)];
            }
        });
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.inResponseTo) { async.each(this.inResponseTo, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.medium) { async.each(this.medium, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.about) { async.each(this.about, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.encounter) {await this.encounter.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.recipient) { async.each(this.recipient, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.payload) { async.each(this.payload, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    ...
    toJSONInternal() {
        ...
        const json = {
            ...
            inResponseTo: this.inResponseTo && this.inResponseTo.map(v => v.toJSONInternal()),
            status: this.status,

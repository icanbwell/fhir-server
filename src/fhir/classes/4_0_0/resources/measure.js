...
class Measure extends Resource {
    ...
    intellectual property (such as code systems) referenced by the measure.
        ...
        */
        Object.defineProperty(this, 'disclaimer', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.disclaimer = undefined;
                    return;
                }
    ...
    component measures to determine the composite score.
        ...
        */
        Object.defineProperty(this, 'compositeScoring', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.compositeScoring = undefined;
                    return;
                }
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.compositeScoring = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });
    ...
    reporting measure results.
        ...
        */
        Object.defineProperty(this, 'riskAdjustment', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.riskAdjustment = undefined;
                    return;
                }
    ...
    several populations, into one summarized result.
        ...
        */
        Object.defineProperty(this, 'rateAggregation', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.rateAggregation = undefined;
                    return;
                }
    ...
    recommendations supporting the measure.
        ...
        */
        Object.defineProperty(this, 'clinicalRecommendationStatement', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.clinicalRecommendationStatement = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'improvementNotation', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.improvementNotation = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });
    ...
    context, and the intent of the measure.
        ...
        */
        Object.defineProperty(this, 'guidance', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.guidance = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'group', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.group = FhirResourceCreator.createArray(valueProvided, MeasureGroup);
            }
        });
    ...
    Resource Path.
        ...
        */
        Object.defineProperty(this, 'supplementalData', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.supplementalData = undefined;
                    return;
                }
                const MeasureSupplementalData = require('../backbone_elements/measureSupplementalData.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.supplementalData = FhirResourceCreator.createArray(valueProvided, MeasureSupplementalData);
            }
        });
    ...
    */
    ...
    async updateReferencesAsync ({ fnUpdateReferenceAsync }) {
            ...
            if (this.compositeScoring) { await this.compositeScoring.updateReferencesAsync({ fnUpdateReferenceAsync }); }
            ...
            if (this.supplementalData) { await async.each(this.supplementalData, async v => await v.updateReferencesAsync({ fnUpdateReferenceAsync })); }
    }
    ...
    toJSONInternal () {
        ...
        const json = {
            ...
            compositeScoring: this.compositeScoring && this.compositeScoring.toJSONInternal(),

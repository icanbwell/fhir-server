    ...
    questionnaire.
        ...
        */
        Object.defineProperty(this, 'subjectType', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.subjectType = undefined;
                    return;
                }
                this.__data.subjectType = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => v) : [valueProvided];
            }
        });
        ...
        */
        Object.defineProperty(this, 'item', {
            ...
            set: valueProvided => {
                ...
                const QuestionnaireItem = require('../backbone_elements/questionnaireItem.js');

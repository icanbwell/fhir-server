...
class BodyStructure extends Resource {
    ...
    morphologies.
        ...
        */
        Object.defineProperty(this, 'morphology', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.morphology = undefined;
                    return;
                }
    ...
    laterality, relative location, directionality, number, and plane.
        ...
        */
        Object.defineProperty(this, 'locationQualifier', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.locationQualifier = undefined;
                    return;
                }
                const CodeableConcept = require('../complex_types/codeableConcept.js');
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.morphology) {await this.morphology.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.location) {await this.location.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.locationQualifier) { async.each(this.locationQualifier, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.image) { async.each(this.image, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

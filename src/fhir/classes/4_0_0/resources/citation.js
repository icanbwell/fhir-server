...
class Citation extends Resource {
     ...
     * @param {CitationSummary[]|undefined} [summary],
     * @param {CitationClassification[]|undefined} [classification],
     * @param {Annotation[]|undefined} [note],
     * @param {CodeableConcept[]|undefined} [currentState],
     * @param {CitationStatusDate[]|undefined} [statusDate],
     * @param {CitationRelatesTo[]|undefined} [relatesTo],
     * @param {CitationCitedArtifact|undefined} [citedArtifact],
    ...
    */
    ...
    itself).
        ...
        */
        ...
        /**
         * @description An absolute URI that is used to identify this citation when it is referenced
    ...
    or an instance.
        ...
        */
        ...
        /**
         * @description The identifier that is used to identify this version of the citation when it
    ...
    can be placed in a lexicographical sequence.
        ...
        */
        ...
        /**
         * @description A natural language name identifying the citation. This name should be usable
    ...
    code generation.
        ...
        */
        ...
        /**
         * @description A Boolean value to indicate that this citation is authored for testing
    ...
    for genuine usage.
        ...
        */
        ...
        /**
         * @description The date  (and optionally time) when the citation was published. The date must
    ...
    instances.
        ...
        */
        ...
        /**
         * @description Explanation of why this citation is needed and why it has been designed as it
    has.
         * @property {markdown|undefined}
        */
        ...
        /**
         * @description Use and/or publishing restrictions for the Citation, not for the cited
    artifact.
         * @property {markdown|undefined}
        */
    ...
    periodically after approval but does not change the original approval date.
        ...
        */
        ...
        /**
         * @description The period during which the citation content was or is planned to be in active
    use.
        ...
        */
         ...
         * @property {CitationSummary[]|undefined}
        */
        Object.defineProperty(this, 'summary', {
            ...
            set: valueProvided => {
                ...
                const CitationSummary = require('../backbone_elements/citationSummary.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.summary = FhirResourceCreator.createArray(valueProvided, CitationSummary);
            }
        });

        /**
         * @description The assignment to an organizing scheme.
         * @property {CitationClassification[]|undefined}
        */
        Object.defineProperty(this, 'classification', {
            ...
            set: valueProvided => {
                ...
                const CitationClassification = require('../backbone_elements/citationClassification.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.classification = FhirResourceCreator.createArray(valueProvided, CitationClassification);
            }
        });
        ...
        */
         ...
         * @property {CitationStatusDate[]|undefined}
        */
        Object.defineProperty(this, 'statusDate', {
            ...
            set: valueProvided => {
                ...
                const CitationStatusDate = require('../backbone_elements/citationStatusDate.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.statusDate = FhirResourceCreator.createArray(valueProvided, CitationStatusDate);
            }
        });

        /**
         * @description Artifact related to the Citation Resource.
         * @property {CitationRelatesTo[]|undefined}
        */
        Object.defineProperty(this, 'relatesTo', {
            ...
            set: valueProvided => {
                ...
                const CitationRelatesTo = require('../backbone_elements/citationRelatesTo.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.relatesTo = FhirResourceCreator.createArray(valueProvided, CitationRelatesTo);
            }
        });

        /**
         * @description The article or artifact being described.
         * @property {CitationCitedArtifact|undefined}
        */
        Object.defineProperty(this, 'citedArtifact', {
            // https://www.w3schools.com/js/js_object_es5.asp
            enumerable: true,
            configurable: true,
            get: () => this.__data.citedArtifact,
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.citedArtifact = undefined;
                    return;
                }
                const CitationCitedArtifact = require('../backbone_elements/citationCitedArtifact.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.citedArtifact = FhirResourceCreator.create(valueProvided, CitationCitedArtifact);
            }
        });
    ...
    */
    clone() {
        return new Citation(this.toJSONInternal());
    }
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.citedArtifact) {await this.citedArtifact.updateReferencesAsync({fnUpdateReferenceAsync});}
    }

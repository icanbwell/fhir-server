...
class SubstanceSpecification extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.moiety) { async.each(this.moiety, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.molecularWeight) { async.each(this.molecularWeight, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

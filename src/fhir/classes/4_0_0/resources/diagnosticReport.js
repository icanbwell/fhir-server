    ...
    conclusions and interpretations.
        ...
        */
        Object.defineProperty(this, 'resultsInterpreter', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.resultsInterpreter = null;
                    return;
                }
                let Reference = require('../complex_types/reference.js');
    ...
    (interpretation/impression) of the diagnostic report.
        ...
        */
        Object.defineProperty(this, 'conclusionCode', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.conclusionCode = null;
                    return;
                }
                let CodeableConcept = require('../complex_types/codeableConcept.js');
    ...
    equivalent.
        ...
        */
        Object.defineProperty(this, 'presentedForm', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.presentedForm = null;
                    return;
                }

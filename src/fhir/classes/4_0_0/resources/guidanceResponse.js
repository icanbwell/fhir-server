        ...
        Object.defineProperty(this, 'requestIdentifier', {
            ...
            set: valueProvided => {
                ...
                if (valueProvided instanceof Identifier){
                    this.__data.requestIdentifier = valueProvided;
                } else {
        ...
        Object.defineProperty(this, 'moduleCodeableConcept', {
            ...
            set: valueProvided => {
                ...
                if (valueProvided instanceof CodeableConcept){
                    this.__data.moduleCodeableConcept = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'evaluationMessage', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.evaluationMessage = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof Reference ?
                                v : new Reference(v)
                            );
                    ...
                    if (valueProvided instanceof Reference) {
                        ...
                        this.__data.evaluationMessage = [new Reference(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'outputParameters', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.outputParameters = valueProvided;
                } else {

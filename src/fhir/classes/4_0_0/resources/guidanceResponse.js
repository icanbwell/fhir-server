        ...
        */
        Object.defineProperty(this, 'requestIdentifier', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.requestIdentifier = FhirResourceCreator.create(valueProvided, Identifier);
            }
        });
        ...
        */
        Object.defineProperty(this, 'moduleCodeableConcept', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.moduleCodeableConcept = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });
        ...
        */
        Object.defineProperty(this, 'evaluationMessage', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.evaluationMessage = FhirResourceCreator.createArray(valueProvided, Reference);
            }
        });
        ...
        */
        Object.defineProperty(this, 'outputParameters', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.outputParameters = FhirResourceCreator.create(valueProvided, Reference);
            }
        });
        ...
        */
        Object.defineProperty(this, 'result', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.result = FhirResourceCreator.create(valueProvided, Reference);
            }
        });

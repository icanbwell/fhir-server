...
class GuidanceResponse extends Resource {
    ...
    requester to more easily identify the response in a multi-request scenario.
        ...
        */
        Object.defineProperty(this, 'requestIdentifier', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.requestIdentifier = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'moduleUri', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.moduleUri = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'moduleCanonical', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.moduleCanonical = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'moduleCodeableConcept', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.moduleCodeableConcept = undefined;
                    return;
                }
    ...
    messages. These messages will be provided by this element.
        ...
        */
        Object.defineProperty(this, 'evaluationMessage', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.evaluationMessage = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
    ...
    these would be returned in this element.
        ...
        */
        Object.defineProperty(this, 'outputParameters', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.outputParameters = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
    ...
    */
    ...
    updateReferences({fnUpdateReference}) {
            ...
            if (this.requestIdentifier) {this.requestIdentifier.updateReferences({fnUpdateReference});}
            if (this.identifier) {this.identifier.forEach(v => v.updateReferences({fnUpdateReference}));}
            if (this.moduleCodeableConcept) {this.moduleCodeableConcept.updateReferences({fnUpdateReference});}
            ...
            if (this.evaluationMessage) {this.evaluationMessage.forEach(v => v.updateReferences({fnUpdateReference}));}
            if (this.outputParameters) {this.outputParameters.updateReferences({fnUpdateReference});}
            if (this.result) {this.result.updateReferences({fnUpdateReference});}
    ...
    toJSONInternal() {
        ...
        const json = {
            ...
            requestIdentifier: this.requestIdentifier && this.requestIdentifier.toJSONInternal(),
            identifier: this.identifier && this.identifier.map(v => v.toJSONInternal()),
            moduleUri: this.moduleUri,
            moduleCanonical: this.moduleCanonical,
            moduleCodeableConcept: this.moduleCodeableConcept && this.moduleCodeableConcept.toJSONInternal(),
            status: this.status,

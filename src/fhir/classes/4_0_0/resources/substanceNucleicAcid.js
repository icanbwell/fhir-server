...
class SubstanceNucleicAcid extends Resource {
        ...
        */
        Object.defineProperty(this, 'sequenceType', {
            ...
            set: valueProvided => {
                ...
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.sequenceType = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });
    ...
    specified in the reference source, the assumption is that there is 1 subunit.
        ...
        */
        Object.defineProperty(this, 'numberOfSubunits', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.numberOfSubunits = undefined;
                    return;
                }
    ...
    underscore “” shall be used as separator as follows: “Subunitnumber Residue”.
        ...
        */
        Object.defineProperty(this, 'areaOfHybridisation', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.areaOfHybridisation = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'oligoNucleotideType', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.oligoNucleotideType = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });
        ...
        */
        Object.defineProperty(this, 'subunit', {
            ...
            set: valueProvided => {
                ...
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.subunit = FhirResourceCreator.createArray(valueProvided, SubstanceNucleicAcidSubunit);
            }
        });
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.sequenceType) {await this.sequenceType.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.oligoNucleotideType) {await this.oligoNucleotideType.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.subunit) {await async.each(this.subunit, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

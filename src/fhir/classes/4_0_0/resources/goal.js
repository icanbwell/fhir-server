...
class Goal extends Resource {
    ...
    server.
        ...
        */
        Object.defineProperty(this, 'lifecycleStatus', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.lifecycleStatus = undefined;
                    return;
                }
    ...
    target.
        ...
        */
        Object.defineProperty(this, 'achievementStatus', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.achievementStatus = undefined;
                    return;
                }
    ...
    established.
        ...
        */
        Object.defineProperty(this, 'startDate', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.startDate = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'startCodeableConcept', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.startCodeableConcept = undefined;
                    return;
                }
                const CodeableConcept = require('../complex_types/codeableConcept.js');
        ...
        */
        Object.defineProperty(this, 'target', {
            ...
            set: valueProvided => {
                ...
                const GoalTarget = require('../backbone_elements/goalTarget.js');
    ...
    achieved, when cancelled, etc.
        ...
        */
        Object.defineProperty(this, 'expressedBy', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.expressedBy = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
    ...
    goal is assessed.
        ...
        */
        Object.defineProperty(this, 'outcomeCode', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.outcomeCode = undefined;
                    return;
                }
                const CodeableConcept = require('../complex_types/codeableConcept.js');
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.achievementStatus) {await this.achievementStatus.updateReferencesAsync({fnUpdateReferenceAsync});}
            ...
            if (this.startCodeableConcept) {await this.startCodeableConcept.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.target) { async.each(this.target, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.expressedBy) {await this.expressedBy.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.addresses) { async.each(this.addresses, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.note) { async.each(this.note, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.outcomeCode) { async.each(this.outcomeCode, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.outcomeReference) { async.each(this.outcomeReference, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }
    ...
    toJSONInternal() {
        ...
        const json = {
            ...
            lifecycleStatus: this.lifecycleStatus,
            achievementStatus: this.achievementStatus && this.achievementStatus.toJSONInternal(),
            ...
            startDate: this.startDate,
            startCodeableConcept: this.startCodeableConcept && this.startCodeableConcept.toJSONInternal(),
            target: this.target && this.target.map(v => v.toJSONInternal()),
            statusDate: this.statusDate,
            statusReason: this.statusReason,
            expressedBy: this.expressedBy && this.expressedBy.toJSONInternal(),

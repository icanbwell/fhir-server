...
class Goal extends Resource {
        ...
        Object.defineProperty(this, 'achievementStatus', {
            ...
            set: valueProvided => {
                ...
                if (valueProvided instanceof CodeableConcept){
                    this.__data.achievementStatus = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'startCodeableConcept', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (valueProvided instanceof CodeableConcept){
                    this.__data.startCodeableConcept = valueProvided;
                } else {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.target = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof GoalTarget ?
                                v : new GoalTarget(v)
                            );
                } else {
                    if (valueProvided instanceof GoalTarget) {
                        this.__data.target = valueProvided;
                    } else {
                        this.__data.target = [new GoalTarget(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'expressedBy', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.expressedBy = valueProvided;
                } else {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    ...
                    if (valueProvided instanceof Reference) {
                        ...
                        this.__data.addresses = [new Reference(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'outcomeCode', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.outcomeCode = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof CodeableConcept ?
                                v : new CodeableConcept(v)
                            );
                    ...
                    if (valueProvided instanceof CodeableConcept) {
                        ...
                        this.__data.outcomeCode = [new CodeableConcept(valueProvided)];
                    }
                }
            }
        });
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.outcomeCode) {await async.each(this.outcomeCode, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}

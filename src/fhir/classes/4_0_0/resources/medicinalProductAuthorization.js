        ...
        */
        Object.defineProperty(this, 'dataExclusivityPeriod', {
            ...
            set: valueProvided => {
                ...
                const Period = require('../complex_types/period.js');
                if (valueProvided instanceof Period){
                    this.__data.dataExclusivityPeriod = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'legalBasis', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (valueProvided instanceof CodeableConcept){
                    this.__data.legalBasis = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'jurisdictionalAuthorization', {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.jurisdictionalAuthorization = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof MedicinalProductAuthorizationJurisdictionalAuthorization ?
                                v : new MedicinalProductAuthorizationJurisdictionalAuthorization(v)
                            );
                } else {
                    if (valueProvided instanceof MedicinalProductAuthorizationJurisdictionalAuthorization) {
                        this.__data.jurisdictionalAuthorization = valueProvided;
                    } else {
                        this.__data.jurisdictionalAuthorization = [new MedicinalProductAuthorizationJurisdictionalAuthorization(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'holder', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.holder = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'regulator', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.regulator = valueProvided;
                } else {

...
class AdverseEvent extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.resultingCondition) { async.each(this.resultingCondition, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            ...
            if (this.suspectEntity) { async.each(this.suspectEntity, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.subjectMedicalHistory) { async.each(this.subjectMedicalHistory, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.referenceDocument) { async.each(this.referenceDocument, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.study) { async.each(this.study, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

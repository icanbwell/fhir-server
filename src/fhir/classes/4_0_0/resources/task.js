    ...
    created in the same context.
        ...
        */
        Object.defineProperty(this, 'groupIdentifier', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.groupIdentifier = null;
                    return;
                }
                let Identifier = require('../complex_types/identifier.js');
        ...
        */
        Object.defineProperty(this, 'businessStatus', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.businessStatus = null;
                    return;
                }
                let CodeableConcept = require('../complex_types/codeableConcept.js');
    ...
    (end).
        ...
        */
        Object.defineProperty(this, 'executionPeriod', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.executionPeriod = null;
                    return;
                }

        ...
        */
        Object.defineProperty(this, 'businessStatus', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (valueProvided instanceof CodeableConcept){
                    this.__data.businessStatus = valueProvided;
                } else {
        ...
        Object.defineProperty(this, 'executionPeriod', {
            ...
            set: valueProvided => {
                ...
                if (valueProvided instanceof Period){
                    this.__data.executionPeriod = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'restriction', {
            ...
            set: valueProvided => {
                ...
                if (valueProvided instanceof TaskRestriction){
                    this.__data.restriction = valueProvided;
                } else {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.input = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof TaskInput ?
                                v : new TaskInput(v)
                            );
                } else {
                    if (valueProvided instanceof TaskInput) {
                        this.__data.input = valueProvided;
                    } else {
                        this.__data.input = [new TaskInput(valueProvided)];
                    }
                }
            }
        });
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.output = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof TaskOutput ?
                                v : new TaskOutput(v)
                            );
                } else {
                    if (valueProvided instanceof TaskOutput) {
                        this.__data.output = valueProvided;
                    } else {
                        this.__data.output = [new TaskOutput(valueProvided)];
                    }
                }
            }
        });

...
class InsurancePlan extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.coverage) { async.each(this.coverage, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.plan) { async.each(this.plan, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

...
class MedicationDispense extends Resource {
        ...
        Object.defineProperty(this, 'statusReasonCodeableConcept', {
            ...
            set: valueProvided => {
                ...
                if (valueProvided instanceof CodeableConcept){
                    this.__data.statusReasonCodeableConcept = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'statusReasonReference', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.statusReasonReference = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'performer', {
            ...
            set: valueProvided => {
                ...
                const MedicationDispensePerformer = require('../backbone_elements/medicationDispensePerformer.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.performer = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof MedicationDispensePerformer ?
                                v : new MedicationDispensePerformer(v)
                            );
                } else {
                    if (valueProvided instanceof MedicationDispensePerformer) {
                        this.__data.performer = valueProvided;
                    } else {
                        this.__data.performer = [new MedicationDispensePerformer(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'authorizingPrescription', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.authorizingPrescription = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof Reference ?
                                v : new Reference(v)
                            );
                    ...
                    if (valueProvided instanceof Reference) {
                        ...
                        this.__data.authorizingPrescription = [new Reference(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'substitution', {
            ...
            set: valueProvided => {
                ...
                const MedicationDispenseSubstitution = require('../backbone_elements/medicationDispenseSubstitution.js');
                if (valueProvided instanceof MedicationDispenseSubstitution){
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.statusReasonCodeableConcept) {await this.statusReasonCodeableConcept.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.statusReasonReference) {await this.statusReasonReference.updateReferencesAsync({fnUpdateReferenceAsync});}
            ...
            if (this.authorizingPrescription) {await async.each(this.authorizingPrescription, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.type) {await this.type.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.quantity) {await this.quantity.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.daysSupply) {await this.daysSupply.updateReferencesAsync({fnUpdateReferenceAsync});}
    ...
    toJSONInternal() {
        ...
        const json = {
            ...
            status: this.status,
            statusReasonCodeableConcept: this.statusReasonCodeableConcept && this.statusReasonCodeableConcept.toJSONInternal(),
            statusReasonReference: this.statusReasonReference && this.statusReasonReference.toJSONInternal(),
            ...
            authorizingPrescription: this.authorizingPrescription && this.authorizingPrescription.map(v => v.toJSONInternal()),
            type: this.type && this.type.toJSONInternal(),
            quantity: this.quantity && this.quantity.toJSONInternal(),
            daysSupply: this.daysSupply && this.daysSupply.toJSONInternal(),
            whenPrepared: this.whenPrepared,
            whenHandedOver: this.whenHandedOver,

        ...
        */
        Object.defineProperty(this, 'statusHistory', {
            ...
            set: valueProvided => {
                ...
                const EpisodeOfCareStatusHistory = require('../backbone_elements/episodeOfCareStatusHistory.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.statusHistory = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof EpisodeOfCareStatusHistory ?
                                v : new EpisodeOfCareStatusHistory(v)
                            );
                } else {
                    if (valueProvided instanceof EpisodeOfCareStatusHistory) {
                        this.__data.statusHistory = valueProvided;
                    } else {
                        this.__data.statusHistory = [new EpisodeOfCareStatusHistory(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'diagnosis', {
            ...
            set: valueProvided => {
                ...
                const EpisodeOfCareDiagnosis = require('../backbone_elements/episodeOfCareDiagnosis.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.diagnosis = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof EpisodeOfCareDiagnosis ?
                                v : new EpisodeOfCareDiagnosis(v)
                            );
                } else {
                    if (valueProvided instanceof EpisodeOfCareDiagnosis) {
                        this.__data.diagnosis = valueProvided;
                    } else {
                        this.__data.diagnosis = [new EpisodeOfCareDiagnosis(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'referralRequest', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.referralRequest = valueProvided
                            .filter(v => v)
                    ...
                    if (valueProvided instanceof Reference) {
                        ...
                        this.__data.referralRequest = [new Reference(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'careManager', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.careManager = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'team', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.team = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof Reference ?
                                v : new Reference(v)
                            );
                    ...
                    if (valueProvided instanceof Reference) {
                        ...
                        this.__data.team = [new Reference(valueProvided)];
                    }
                }
            }
        });

...
class EpisodeOfCare extends Resource {
    ...
    */
    ...
    updateReferences({fnUpdateReference}) {
            ...
            if (this.referralRequest) {this.referralRequest.forEach(v => v.updateReferences({fnUpdateReference}));}
            if (this.careManager) {this.careManager.updateReferences({fnUpdateReference});}
            if (this.team) {this.team.forEach(v => v.updateReferences({fnUpdateReference}));}

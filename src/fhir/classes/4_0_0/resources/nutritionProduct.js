...
class NutritionProduct extends Resource {
     ...
     * @param {NutritionProductNutrient[]|undefined} [nutrient],
     * @param {NutritionProductIngredient[]|undefined} [ingredient],
     * @param {CodeableReference[]|undefined} [knownAllergen],
     * @param {NutritionProductProductCharacteristic[]|undefined} [productCharacteristic],
     * @param {NutritionProductInstance|undefined} [instance],
    ...
    */
    ...
    nutritional properties, preparation methods, etc.
        ...
        */
        ...
        /**
         * @description The code assigned to the product, for example a manufacturer number or other
    terminology.
         * @property {CodeableConcept|undefined}
        */
        ...
        /**
         * @description The organisation (manufacturer, representative or legal authorisation holder)
    that is responsible for the device.
        ...
        */
         ...
         * @property {NutritionProductNutrient[]|undefined}
        */
        Object.defineProperty(this, 'nutrient', {
            ...
            set: valueProvided => {
                ...
                const NutritionProductNutrient = require('../backbone_elements/nutritionProductNutrient.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.nutrient = FhirResourceCreator.createArray(valueProvided, NutritionProductNutrient);
            }
        });

        /**
         * @description Ingredients contained in this product.
         * @property {NutritionProductIngredient[]|undefined}
        */
        Object.defineProperty(this, 'ingredient', {
            ...
            set: valueProvided => {
                ...
                const NutritionProductIngredient = require('../backbone_elements/nutritionProductIngredient.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.ingredient = FhirResourceCreator.createArray(valueProvided, NutritionProductIngredient);
            }
        });
        ...
        */
        Object.defineProperty(this, 'knownAllergen', {
            // https://www.w3schools.com/js/js_object_es5.asp
            enumerable: true,
            configurable: true,
            get: () => this.__data.knownAllergen,
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.knownAllergen = undefined;
                    return;
                }
                const CodeableReference = require('../complex_types/codeableReference.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.knownAllergen = FhirResourceCreator.createArray(valueProvided, CodeableReference);
            }
        });

        /**
         * @description Specifies descriptive properties of the nutrition product.
         * @property {NutritionProductProductCharacteristic[]|undefined}
        */
        Object.defineProperty(this, 'productCharacteristic', {
            // https://www.w3schools.com/js/js_object_es5.asp
            enumerable: true,
            configurable: true,
            get: () => this.__data.productCharacteristic,
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.productCharacteristic = undefined;
                    return;
                }
                const NutritionProductProductCharacteristic = require('../backbone_elements/nutritionProductProductCharacteristic.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.productCharacteristic = FhirResourceCreator.createArray(valueProvided, NutritionProductProductCharacteristic);
            }
        });

        /**
         * @description Conveys instance-level information about this product item. One or several
    physical, countable instances or occurrences of the product.
         * @property {NutritionProductInstance|undefined}
        */
        Object.defineProperty(this, 'instance', {
            ...
            set: valueProvided => {
                ...
                const NutritionProductInstance = require('../backbone_elements/nutritionProductInstance.js');
                const {FhirResourceCreator} = require('../../../fhirResourceCreator');
                this.__data.instance = FhirResourceCreator.create(valueProvided, NutritionProductInstance);
            }
        });
    ...
    */
    clone() {
        return new NutritionProduct(this.toJSONInternal());
    }
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.knownAllergen) {await async.each(this.knownAllergen, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.productCharacteristic) {await async.each(this.productCharacteristic, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
...
module.exports = NutritionProduct;

...
class OperationDefinition extends Resource {
    ...
    trail entries do not count as 'affecting  state'.
        ...
        */
        Object.defineProperty(this, 'affectsState', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.affectsState = undefined;
                    return;
                }
    ...
    resource as a whole.
        ...
        */
        Object.defineProperty(this, 'inputProfile', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.inputProfile = undefined;
                    return;
                }
    ...
    resource.
        ...
        */
        Object.defineProperty(this, 'outputProfile', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.outputProfile = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'parameter', {
            ...
            set: valueProvided => {
                ...
                const OperationDefinitionParameter = require('../backbone_elements/operationDefinitionParameter.js');
                if (Array.isArray(valueProvided)) {
                    ...
                    if (valueProvided instanceof OperationDefinitionParameter) {
                        ...
                        this.__data.parameter = [new OperationDefinitionParameter(valueProvided)];
                    }
                }
            }
        });
    ...
    for this operation.
        ...
        */
        Object.defineProperty(this, 'overload', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.overload = undefined;
                    return;
                }
                const OperationDefinitionOverload = require('../backbone_elements/operationDefinitionOverload.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.overload = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof OperationDefinitionOverload ?
                                v : new OperationDefinitionOverload(v)
                            );
                } else {
                    if (valueProvided instanceof OperationDefinitionOverload) {
                        this.__data.overload = valueProvided;
                    } else {
                        this.__data.overload = [new OperationDefinitionOverload(valueProvided)];
                    }
                }
            }
        });
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.overload) {await async.each(this.overload, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

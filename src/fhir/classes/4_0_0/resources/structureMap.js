            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.structure = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof StructureMapStructure ?
                                v : new StructureMapStructure(v)
                            );
                } else {
                    if (valueProvided instanceof StructureMapStructure) {
                        this.__data.structure = valueProvided;
                    } else {
                        this.__data.structure = [new StructureMapStructure(valueProvided)];
                    }
                }
            }
        });
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.group = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof StructureMapGroup ?
                                v : new StructureMapGroup(v)
                            );
                } else {
                    if (valueProvided instanceof StructureMapGroup) {
                        this.__data.group = valueProvided;
                    } else {
                        this.__data.group = [new StructureMapGroup(valueProvided)];
                    }
                }
            }
        });

...
class Contract extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.subject) { async.each(this.subject, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.authority) { async.each(this.authority, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.domain) { async.each(this.domain, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.site) { async.each(this.site, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.term) { async.each(this.term, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.signer) { async.each(this.signer, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.friendly) { async.each(this.friendly, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.legal) { async.each(this.legal, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.rule) { async.each(this.rule, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

...
class CapabilityStatement extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.rest) { async.each(this.rest, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.messaging) { async.each(this.messaging, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.document) { async.each(this.document, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

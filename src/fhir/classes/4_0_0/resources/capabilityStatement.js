...
class CapabilityStatement extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.rest) { async.each(this.rest, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.messaging) { async.each(this.messaging, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.document) { async.each(this.document, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }
    ...
    toJSONInternal() {
        ...
        const json = {
            ...
            instantiates: this.instantiates,
            imports: this.imports,
            software: this.software && this.software.toJSONInternal(),
            implementation: this.implementation && this.implementation.toJSONInternal(),
            fhirVersion: this.fhirVersion,
            format: this.format,
            patchFormat: this.patchFormat,
            implementationGuide: this.implementationGuide,

...
class Patient extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.generalPractitioner) { async.each(this.generalPractitioner, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.managingOrganization) {await this.managingOrganization.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.link) { async.each(this.link, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

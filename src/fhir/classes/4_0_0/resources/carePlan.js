...
class CarePlan extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.contributor) { async.each(this.contributor, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.activity) { async.each(this.activity, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

...
class TestScript extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.origin) {await async.each(this.origin, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            ...
            if (this.fixture) {await async.each(this.fixture, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.profile) {await async.each(this.profile, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}

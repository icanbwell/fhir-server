        ...
        */
        Object.defineProperty(this, 'uniqueId', {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.uniqueId = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof NamingSystemUniqueId ?
                                v : new NamingSystemUniqueId(v)
                            );
                } else {
                    if (valueProvided instanceof NamingSystemUniqueId) {
                        this.__data.uniqueId = valueProvided;
                    } else {
                        this.__data.uniqueId = [new NamingSystemUniqueId(valueProvided)];
                    }
                }
            }
        });

...
class ResearchSubject extends Resource {
        ...
        */
        Object.defineProperty(this, 'study', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.study = FhirResourceCreator.create(valueProvided, Reference);
            }
        });
        ...
        */
        Object.defineProperty(this, 'individual', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.individual = FhirResourceCreator.create(valueProvided, Reference);
            }
        });

        /**
         * @description The name of the arm in the study the subject is expected to follow as part of
    this study.
         * @property {String|undefined}
        */
        Object.defineProperty(this, 'assignedArm', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.assignedArm = undefined;
                    return;
                }
                this.__data.assignedArm = valueProvided;
            }
        });

        /**
         * @description The name of the arm in the study the subject actually followed as part of this
    study.
         * @property {String|undefined}
        */
        Object.defineProperty(this, 'actualArm', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.actualArm = undefined;
                    return;
                }
                this.__data.actualArm = valueProvided;
            }
        });
        ...
        */
        Object.defineProperty(this, 'consent', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.consent = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.consent = FhirResourceCreator.create(valueProvided, Reference);
            }
        });
    ...
    */
    ...
    async updateReferencesAsync ({ fnUpdateReferenceAsync }) {
            ...
            if (this.study) { await this.study.updateReferencesAsync({ fnUpdateReferenceAsync }); }
            if (this.individual) { await this.individual.updateReferencesAsync({ fnUpdateReferenceAsync }); }
            if (this.consent) { await this.consent.updateReferencesAsync({ fnUpdateReferenceAsync }); }
    }

...
class Endpoint extends Resource {
    ...
    */
    ...
    updateReferences({fnUpdateReference}) {
            ...
            if (this.connectionType) {this.connectionType.updateReferences({fnUpdateReference});}
            ...
            if (this.payloadType) {this.payloadType.forEach(v => v.updateReferences({fnUpdateReference}));}
    }

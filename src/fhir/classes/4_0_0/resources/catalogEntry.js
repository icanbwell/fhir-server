...
class CatalogEntry extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.additionalIdentifier) { async.each(this.additionalIdentifier, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.classification) { async.each(this.classification, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.validityPeriod) {await this.validityPeriod.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.additionalCharacteristic) { async.each(this.additionalCharacteristic, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.additionalClassification) { async.each(this.additionalClassification, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.relatedEntry) { async.each(this.relatedEntry, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

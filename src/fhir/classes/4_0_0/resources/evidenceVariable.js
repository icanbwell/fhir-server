        ...
        */
        Object.defineProperty(this, 'characteristic', {
            ...
            set: valueProvided => {
                ...
                let EvidenceVariableCharacteristic = require('../backbone_elements/evidenceVariableCharacteristic');
                this.__data.characteristic = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new EvidenceVariableCharacteristic(v)) : [new EvidenceVariableCharacteristic(valueProvided)];
            }
        });

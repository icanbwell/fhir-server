            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.characteristic = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof EvidenceVariableCharacteristic ?
                                v : new EvidenceVariableCharacteristic(v)
                            );
                } else {
                    if (valueProvided instanceof EvidenceVariableCharacteristic) {
                        this.__data.characteristic = valueProvided;
                    } else {
                        this.__data.characteristic = [new EvidenceVariableCharacteristic(valueProvided)];
                    }
                }
            }
        });

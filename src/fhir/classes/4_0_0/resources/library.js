...
class Library extends Resource {
        ...
        */
        Object.defineProperty(this, 'parameter', {
            ...
            set: valueProvided => {
                ...
                this.__data.parameter = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new ParameterDefinition(v)) : [new ParameterDefinition(valueProvided)];
            }
        });
    ...
    successfully perform the computations defined by the library.
        ...
        */
        Object.defineProperty(this, 'dataRequirement', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.dataRequirement = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'content', {
            ...
            set: valueProvided => {
                ...
                this.__data.content = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new Attachment(v)) : [new Attachment(valueProvided)];
            }
        });
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.dataRequirement) { async.each(this.dataRequirement, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.content) { async.each(this.content, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

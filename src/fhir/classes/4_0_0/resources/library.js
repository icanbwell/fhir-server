...
class Library extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.dataRequirement) { async.each(this.dataRequirement, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.content) { async.each(this.content, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

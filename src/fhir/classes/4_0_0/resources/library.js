            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.parameter = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof ParameterDefinition ?
                                v : new ParameterDefinition(v)
                            );
                } else {
                    if (valueProvided instanceof ParameterDefinition) {
                        this.__data.parameter = valueProvided;
                    } else {
                        this.__data.parameter = [new ParameterDefinition(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'dataRequirement', {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.dataRequirement = valueProvided
                            .filter(v => v)
                    ...
                    if (valueProvided instanceof DataRequirement) {
                        ...
                        this.__data.dataRequirement = [new DataRequirement(valueProvided)];
                    }
                }
            }
        });

...
class ManufacturedItemDefinition extends Resource {
     ...
     * @param {ManufacturedItemDefinitionProperty[]|undefined} [property],
    ...
    */
        ...
        */
        Object.defineProperty(this, 'manufacturedDoseForm', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.manufacturedDoseForm = FhirResourceCreator.create(valueProvided, CodeableConcept);
            }
        });
    ...
    currently causes technical issues).
        ...
        */
        ...
        /**
         * @description The ingredients of this manufactured item. This is only needed if the
        ...
        */
        Object.defineProperty(this, 'property', {
            ...
            set: valueProvided => {
                ...
                const ManufacturedItemDefinitionProperty = require('../backbone_elements/manufacturedItemDefinitionProperty.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.property = FhirResourceCreator.createArray(valueProvided, ManufacturedItemDefinitionProperty);
            }
        });
     ...
     * @param {string|undefined} [_uuid]
     * @param {string|undefined} [_sourceId]
     * @returns {ManufacturedItemDefinition}
    */
    create (
            {
            id,
    ...
    */
    clone () {
        return new ManufacturedItemDefinition(this.toJSONInternal());
    }
...
module.exports = ManufacturedItemDefinition;

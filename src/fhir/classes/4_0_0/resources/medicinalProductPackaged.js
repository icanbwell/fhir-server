...
class MedicinalProductPackaged extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.batchIdentifier) { async.each(this.batchIdentifier, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.packageItem) { async.each(this.packageItem, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

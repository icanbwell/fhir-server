        ...
        */
        Object.defineProperty(this, 'goal', {
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.goal = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof PlanDefinitionGoal ?
                                v : new PlanDefinitionGoal(v)
                            );
                } else {
                    if (valueProvided instanceof PlanDefinitionGoal) {
                        this.__data.goal = valueProvided;
                    } else {
                        this.__data.goal = [new PlanDefinitionGoal(valueProvided)];
                    }
                }
            }
        });
            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.action = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof PlanDefinitionAction ?
                                v : new PlanDefinitionAction(v)
                            );
                } else {
                    if (valueProvided instanceof PlanDefinitionAction) {
                        this.__data.action = valueProvided;
                    } else {
                        this.__data.action = [new PlanDefinitionAction(valueProvided)];
                    }
                }
            }
        });

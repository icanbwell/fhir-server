            ...
            set: valueProvided => {
                ...
                if (Array.isArray(valueProvided)) {
                    this.__data.component = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof SearchParameterComponent ?
                                v : new SearchParameterComponent(v)
                            );
                } else {
                    if (valueProvided instanceof SearchParameterComponent) {
                        this.__data.component = valueProvided;
                    } else {
                        this.__data.component = [new SearchParameterComponent(valueProvided)];
                    }
                }
            }
        });

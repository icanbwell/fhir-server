        ...
        */
        Object.defineProperty(this, 'synthesisType', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (valueProvided instanceof CodeableConcept){
                    this.__data.synthesisType = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'studyType', {
            ...
            set: valueProvided => {
                ...
                const CodeableConcept = require('../complex_types/codeableConcept.js');
                if (valueProvided instanceof CodeableConcept){
                    this.__data.studyType = valueProvided;
                } else {
    ...
    research.
        ...
        */
        Object.defineProperty(this, 'exposure', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.exposure = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
                if (valueProvided instanceof Reference){
                    this.__data.exposure = valueProvided;
                } else {
    ...
    research.
        ...
        */
        Object.defineProperty(this, 'sampleSize', {
            ...
            set: valueProvided => {
                ...
                const RiskEvidenceSynthesisSampleSize = require('../backbone_elements/riskEvidenceSynthesisSampleSize.js');
                if (valueProvided instanceof RiskEvidenceSynthesisSampleSize){
                    this.__data.sampleSize = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'riskEstimate', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.riskEstimate = undefined;
                    return;
                }
                const RiskEvidenceSynthesisRiskEstimate = require('../backbone_elements/riskEvidenceSynthesisRiskEstimate.js');
                if (valueProvided instanceof RiskEvidenceSynthesisRiskEstimate){
                    this.__data.riskEstimate = valueProvided;
                } else {
        ...
        */
        Object.defineProperty(this, 'certainty', {
            ...
            set: valueProvided => {
                ...
                const RiskEvidenceSynthesisCertainty = require('../backbone_elements/riskEvidenceSynthesisCertainty.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.certainty = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof RiskEvidenceSynthesisCertainty ?
                                v : new RiskEvidenceSynthesisCertainty(v)
                            );
                } else {
                    if (valueProvided instanceof RiskEvidenceSynthesisCertainty) {
                        this.__data.certainty = valueProvided;
                    } else {
                        this.__data.certainty = [new RiskEvidenceSynthesisCertainty(valueProvided)];
                    }
                }
            }
        });

...
class RiskEvidenceSynthesis extends Resource {
        ...
        */
        Object.defineProperty(this, 'certainty', {
            ...
            set: valueProvided => {
                ...
                this.__data.certainty = Array.isArray(valueProvided) ? valueProvided.filter(v => v).map(v => new RiskEvidenceSynthesisCertainty(v)) : [new RiskEvidenceSynthesisCertainty(valueProvided)];
            }
        });
    ...
    */
    ...
    updateReferences({fnUpdateReference}) {
            ...
            if (this.riskEstimate) {this.riskEstimate.updateReferences({fnUpdateReference});}

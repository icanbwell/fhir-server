...
class MeasureReport extends Resource {
        ...
        */
        Object.defineProperty(this, 'reporter', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.reporter = FhirResourceCreator.create(valueProvided, Reference);
            }
        });
        ...
        */
        Object.defineProperty(this, 'group', {
            ...
            set: valueProvided => {
                ...
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.group = FhirResourceCreator.createArray(valueProvided, MeasureReportGroup);
            }
        });
        ...
        */
        Object.defineProperty(this, 'evaluatedResource', {
            ...
            set: valueProvided => {
                ...
                const Reference = require('../complex_types/reference.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.evaluatedResource = FhirResourceCreator.createArray(valueProvided, Reference);
            }
        });
    ...
    */
    ...
    async updateReferencesAsync ({ fnUpdateReferenceAsync }) {
            ...
            if (this.evaluatedResource) { await async.each(this.evaluatedResource, async v => await v.updateReferencesAsync({ fnUpdateReferenceAsync })); }
    }

    ...
    documenting a scenario.
        ...
        */
        Object.defineProperty(this, 'actor', {
            ...
            set: valueProvided => {
                ...
                const ExampleScenarioActor = require('../backbone_elements/exampleScenarioActor.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.actor = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof ExampleScenarioActor ?
                                v : new ExampleScenarioActor(v)
                            );
                } else {
                    if (valueProvided instanceof ExampleScenarioActor) {
                        this.__data.actor = valueProvided;
                    } else {
                        this.__data.actor = [new ExampleScenarioActor(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'instance', {
            ...
            set: valueProvided => {
                ...
                const ExampleScenarioInstance = require('../backbone_elements/exampleScenarioInstance.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.instance = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof ExampleScenarioInstance ?
                                v : new ExampleScenarioInstance(v)
                            );
                } else {
                    if (valueProvided instanceof ExampleScenarioInstance) {
                        this.__data.instance = valueProvided;
                    } else {
                        this.__data.instance = [new ExampleScenarioInstance(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'workflow', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.workflow = undefined;
                    return;
                }

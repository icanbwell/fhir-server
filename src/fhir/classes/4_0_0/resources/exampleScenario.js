...
class ExampleScenario extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.actor) { async.each(this.actor, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.instance) { async.each(this.instance, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.process) { async.each(this.process, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

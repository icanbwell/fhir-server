...
class ExampleScenario extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.instance) { async.each(this.instance, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.process) { async.each(this.process, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

...
class AppointmentResponse extends Resource {
    ...
    */
    ...
    updateReferences({fnUpdateReference}) {
            ...
            if (this.appointment) {this.appointment.updateReferences({fnUpdateReference});}
            if (this.participantType) {this.participantType.forEach(v => v.updateReferences({fnUpdateReference}));}

        ...
        */
        Object.defineProperty(this, 'focus', {
            ...
            set: valueProvided => {
                ...
                const MessageDefinitionFocus = require('../backbone_elements/messageDefinitionFocus.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.focus = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof MessageDefinitionFocus ?
                                v : new MessageDefinitionFocus(v)
                            );
                } else {
                    if (valueProvided instanceof MessageDefinitionFocus) {
                        this.__data.focus = valueProvided;
                    } else {
                        this.__data.focus = [new MessageDefinitionFocus(valueProvided)];
                    }
                }
            }
        });
        ...
        */
        Object.defineProperty(this, 'allowedResponse', {
            ...
            set: valueProvided => {
                ...
                const MessageDefinitionAllowedResponse = require('../backbone_elements/messageDefinitionAllowedResponse.js');
                if (Array.isArray(valueProvided)) {
                    this.__data.allowedResponse = valueProvided
                            .filter(v => v)
                            .map(v => v instanceof MessageDefinitionAllowedResponse ?
                                v : new MessageDefinitionAllowedResponse(v)
                            );
                } else {
                    if (valueProvided instanceof MessageDefinitionAllowedResponse) {
                        this.__data.allowedResponse = valueProvided;
                    } else {
                        this.__data.allowedResponse = [new MessageDefinitionAllowedResponse(valueProvided)];
                    }
                }
            }
        });

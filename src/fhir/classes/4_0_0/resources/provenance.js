...
class Provenance extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.agent) { async.each(this.agent, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.entity) { async.each(this.entity, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.signature) { async.each(this.signature, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

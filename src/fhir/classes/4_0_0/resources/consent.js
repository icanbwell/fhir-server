...
class Consent extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.organization) { async.each(this.organization, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            ...
            if (this.policy) { async.each(this.policy, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.policyRule) {await this.policyRule.updateReferencesAsync({fnUpdateReferenceAsync});}
            if (this.verification) { async.each(this.verification, async v => await v.updateReferences({fnUpdateReferenceAsync}));}

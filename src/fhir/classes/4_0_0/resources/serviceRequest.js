    ...
    require additional instructions specifying how the bandage should be applied.
        ...
        */
        Object.defineProperty(this, 'quantityQuantity', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.quantityQuantity = null;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'quantityRatio', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.quantityRatio = null;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'quantityRange', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.quantityRange = null;
                    return;
                }
    ...
    activation.
        ...
        */
        Object.defineProperty(this, 'performerType', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.performerType = null;
                    return;
                }
                let CodeableConcept = require('../complex_types/codeableConcept.js');

...
class EnrollmentResponse extends Resource {
    ...
    itself).
        ...
        */
        Object.defineProperty(this, 'requestProvider', {
            ...
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.requestProvider = undefined;
                    return;
                }
                const Reference = require('../complex_types/reference.js');
                const { FhirResourceCreator } = require('../../../fhirResourceCreator');
                this.__data.requestProvider = FhirResourceCreator.create(valueProvided, Reference);
            }
        });
    ...
    */
    ...
    async updateReferencesAsync ({ fnUpdateReferenceAsync }) {
            ...
            if (this.requestProvider) { await this.requestProvider.updateReferencesAsync({ fnUpdateReferenceAsync }); }
    }

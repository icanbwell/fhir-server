...
class SubscriptionStatus extends Resource {
     ...
     * @param {canonical|undefined} [topic],
     * @param {CodeableConcept[]|undefined} [error],
    ...
    */
    ...
    subscription.
        ...
        */
        ...
        /**
         * @description The total number of actual events which have been generated since the
    ...
    handshake and heartbeat notifications.
        ...
        */
        Object.defineProperty(this, 'eventsSinceSubscriptionStart', {
            // https://www.w3schools.com/js/js_object_es5.asp
            enumerable: true,
            configurable: true,
            get: () => this.__data.eventsSinceSubscriptionStart,
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.eventsSinceSubscriptionStart = undefined;
                    return;
                }
                this.__data.eventsSinceSubscriptionStart = valueProvided;
            }
        });

        /**
         * @description Detailed information about events relevant to this subscription notification.
         * @property {SubscriptionStatusNotificationEvent[]|undefined}
        */
        Object.defineProperty(this, 'notificationEvent', {
            // https://www.w3schools.com/js/js_object_es5.asp
            enumerable: true,
            configurable: true,
            get: () => this.__data.notificationEvent,
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.notificationEvent = undefined;
                    return;
                }
        ...
        */
        Object.defineProperty(this, 'subscription', {
            ...
            enumerable: true,
            configurable: true,
            get: () => this.__data.subscription,
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    this.__data.subscription = undefined;
                    return;
                }
        ...
        /**
         * @description The reference to the SubscriptionTopic for the Subscription which generated
    this notification.

...
class Coverage extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.payor) { async.each(this.payor, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.class) { async.each(this.class, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.costToBeneficiary) { async.each(this.costToBeneficiary, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.contract) { async.each(this.contract, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

...
class SubstancePolymer extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.copolymerConnectivity) { async.each(this.copolymerConnectivity, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.monomerSet) { async.each(this.monomerSet, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.repeat) { async.each(this.repeat, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

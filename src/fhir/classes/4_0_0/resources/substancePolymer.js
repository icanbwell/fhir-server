...
class SubstancePolymer extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.copolymerConnectivity) { async.each(this.copolymerConnectivity, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.monomerSet) { async.each(this.monomerSet, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.repeat) { async.each(this.repeat, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

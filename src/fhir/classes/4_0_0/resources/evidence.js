...
class Evidence extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.exposureVariant) { async.each(this.exposureVariant, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.outcome) { async.each(this.outcome, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

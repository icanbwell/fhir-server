        ...
        */
        Object.defineProperty(this, 'exposureVariant', {
            ...
            set: valueProvided => {
                ...
                let Reference = require('../complex_types/reference.js');
                this.__data.exposureVariant = Array.isArray(valueProvided) ? valueProvided.map(v => new Reference(v)) : [new Reference(valueProvided)];
            }
        });
        ...
        */
        Object.defineProperty(this, 'outcome', {
            ...
            set: valueProvided => {
                ...
                let Reference = require('../complex_types/reference.js');
                this.__data.outcome = Array.isArray(valueProvided) ? valueProvided.map(v => new Reference(v)) : [new Reference(valueProvided)];
            }
        });

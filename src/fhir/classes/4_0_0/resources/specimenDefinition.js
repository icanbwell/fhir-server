...
class SpecimenDefinition extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.patientPreparation) { async.each(this.patientPreparation, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.collection) { async.each(this.collection, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
            if (this.typeTested) { async.each(this.typeTested, async v => await v.updateReferences({fnUpdateReferenceAsync}));}
    }

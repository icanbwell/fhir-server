...
class Procedure extends Resource {
    ...
    */
    ...
    async updateReferencesAsync({fnUpdateReferenceAsync}) {
            ...
            if (this.report) { async.each(this.report, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.complication) { async.each(this.complication, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.complicationDetail) { async.each(this.complicationDetail, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.followUp) { async.each(this.followUp, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.note) { async.each(this.note, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.focalDevice) { async.each(this.focalDevice, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.usedReference) { async.each(this.usedReference, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
            if (this.usedCode) { async.each(this.usedCode, async v => await v.updateReferencesAsync({fnUpdateReferenceAsync}));}
    }

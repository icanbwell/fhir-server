const USE_DATADOG_SDK = process.env.USE_DATADOG_SDK === 'true';

if (USE_DATADOG_SDK) {
    // Import and initialize Datadog APM SDK only if the flag is true
    ...
    // Import OpenTelemetry only if the Datadog flag is false

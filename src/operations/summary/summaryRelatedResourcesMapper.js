...
/**
 * @type {{[k: string]:Array<SummaryRelatedResources>}}
 */
...
class SummaryRelatedResourcesMapper {
    constructor() { }
     ...
     * @returns {Array<SummaryRelatedResources>} - An array of related resource map.
     */
    relatedResources(resourceType, specificReltedResourceTypeSet) {
        if (!RelatedResourceMap[resourceType]) {
            throw new Error(`SummaryRelatedResourcesMapper doesn't support ${resourceType} resource`)
        }
...
module.exports = { SummaryRelatedResourcesMapper }

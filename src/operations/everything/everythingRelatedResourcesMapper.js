...
/**
 * @type {Array<EverythingRelatedResources>}
 */
const patientLinkedResources = [
    {
        type: "Account",
        params: "patient={ref}",
...
const RelatedResourceMap = {
    Patient: patientLinkedResources,
    Person: [
        ...patientLinkedResources,
        {
            type: "Subscription",
            customQuery: {
                query: `{"extension":{"$elemMatch":{"url":"https://icanbwell.com/codes/client_person_id","valueString":"{_uuid}"}}}`,
        ...
        },
        {
            ...
            customQuery: {
                query: `{"identifier":{"$elemMatch":{"system":"https://icanbwell.com/codes/client_person_id","value":"{_uuid}"}}}`,
                requiredValues: ["_uuid"],

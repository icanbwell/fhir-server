...
module.exports = {
    Query: {
        ...
        diagnosticReport: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'DiagnosticReport');
        },
    },
    ...
    DiagnosticReport: {
        ...
        specimen: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.specimen);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        result: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.result);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        imagingStudy: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.imagingStudy);
        },
    },
};

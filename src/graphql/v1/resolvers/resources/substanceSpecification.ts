...
module.exports = {
    Query: {
        ...
        substanceSpecification: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'SubstanceSpecification');
        },
    },
    SubstanceSpecification: {
        ...
        source: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.source);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        nucleicAcid: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.nucleicAcid);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        polymer: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.polymer);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        protein: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.protein);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars

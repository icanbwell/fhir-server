...
module.exports = {
    Query: {
        ...
        task: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'Task');
        },
    },
    TaskRequester: {
    ...
    Task: {
        ...
        focus: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.focus);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        for: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.for);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        owner: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.owner);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        insurance: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.insurance);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars

...
module.exports = {
    Query: {
        ...
        contract: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'Contract');
        },
    },
    ContractAuthor: {
    ...
    Contract: {
        ...
        subject: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.subject);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        authority: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.authority);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        domain: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.domain);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars

...
module.exports = {
    Query: {
        ...
        medicationDispense: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'MedicationDispense');
        },
    },
    ...
    MedicationDispense: {
        ...
        destination: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.destination);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        receiver: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.receiver);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        eventHistory: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.eventHistory);
        },
    },
};

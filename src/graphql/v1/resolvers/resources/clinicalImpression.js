...
module.exports = {
    Query: {
        ...
        clinicalImpression: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'ClinicalImpression');
        },
    },
    ...
    ClinicalImpression: {
        ...
        assessor: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.assessor);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        previous: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.previous);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        problem: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.problem);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars

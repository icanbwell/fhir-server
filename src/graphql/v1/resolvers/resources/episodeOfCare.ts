...
module.exports = {
    Query: {
        ...
        episodeOfCare: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'EpisodeOfCare');
        },
    },
    ...
    EpisodeOfCare: {
        ...
        careManager: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.careManager);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        team: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.team);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars

...
module.exports = {
    Query: {
        ...
        medicinalProduct: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'MedicinalProduct');
        },
    },
    ...
    MedicinalProduct: {
        ...
        masterFile: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.masterFile);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        contact: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.contact);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars

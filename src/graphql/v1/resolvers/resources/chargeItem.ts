...
module.exports = {
    Query: {
        ...
        chargeItem: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'ChargeItem');
        },
    },
    ChargeItemSubject: {
    ...
    ChargeItem: {
        ...
        context: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.context);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        costCenter: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.costCenter);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        service: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.service);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        account: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.account);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars

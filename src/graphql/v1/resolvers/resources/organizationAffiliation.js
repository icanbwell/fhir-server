...
module.exports = {
    Query: {
        ...
        organizationAffiliation: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'OrganizationAffiliation');
        },
    },
    OrganizationAffiliation: {
        ...
        organization: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.organization);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        network: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.network);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        location: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.location);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        endpoint: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.endpoint);
        },
    },
};

...
module.exports = {
    Query: {
        ...
        imagingStudy: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'ImagingStudy');
        },
    },
    ImagingStudySubject: {
    ...
    ImagingStudy: {
        ...
        referrer: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.referrer);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        interpreter: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.interpreter);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars

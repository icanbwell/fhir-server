...
module.exports = {
    Query: {
        ...
        effectEvidenceSynthesis: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'EffectEvidenceSynthesis');
        },
    },
    EffectEvidenceSynthesis: {
        ...
        population: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.population);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        exposure: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.exposure);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        outcome: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.outcome);
        },
    },
};

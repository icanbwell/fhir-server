...
module.exports = {
    Query: {
        ...
        medicinalProductAuthorization: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'MedicinalProductAuthorization');
        },
    },
    ...
    MedicinalProductAuthorization: {
        ...
        holder: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.holder);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        regulator: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.regulator);
        },
    },
};

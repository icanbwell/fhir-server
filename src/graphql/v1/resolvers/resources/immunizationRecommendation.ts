...
module.exports = {
    Query: {
        ...
        immunizationRecommendation: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'ImmunizationRecommendation');
        },
    },
    ImmunizationRecommendation: {
        ...
        authority: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.authority);
        },
    },
};

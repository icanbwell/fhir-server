...
module.exports = {
    Query: {
        ...
        encounter: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'Encounter');
        },
    },
    EncounterSubject: {
    ...
    Encounter: {
        ...
        appointment: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.appointment);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        partOf: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.partOf);
        },
    },
};

...
module.exports = {
    Query: {
        ...
        communication: async (parent, args, context, info) => {
            return await getResources(parent, args, context, info, 'Communication');
        },
    },
    ...
    Communication: {
        ...
        inResponseTo: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.inResponseTo);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        about: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.about);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        ...
        recipient: async (parent, args, context, info) => {
            return await findResourcesByReference(parent, args, context, info, parent.recipient);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        sender: async (parent, args, context, info) => {
            return await findResourceByReference(parent, args, context, info, parent.sender);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars

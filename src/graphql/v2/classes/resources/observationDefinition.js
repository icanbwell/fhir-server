...
class ObservationDefinition {
        ...
        */
        Object.defineProperty(this, 'permittedDataType', {
            ...
            set: value => {
                ...
                this.__data.permittedDataType = value;
            }
        });
        ...
        */
        Object.defineProperty(this, 'qualifiedInterval', {
            ...
            set: value => {
                ...
                this.__data.qualifiedInterval = new ObservationDefinitionQualifiedInterval(value);
            }
        });
    ...
    toJSON() {
        return {
            ...
            permittedDataType: this.permittedDataType && this.permittedDataType.toJSON(),
            ...
            qualifiedInterval: this.qualifiedInterval && this.qualifiedInterval.toJSON(),

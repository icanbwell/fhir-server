...
class ConceptMap {
        ...
        */
        Object.defineProperty(this, 'sourceUri', {
            ...
            set: value => {
                ...
                let uri = require('../simple_types/uri.js');
                // eslint-disable-next-line new-cap
                this.__data.sourceUri = new uri(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'sourceCanonical', {
            ...
            set: value => {
                ...
                // eslint-disable-next-line new-cap
                this.__data.sourceCanonical = new canonical(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'targetUri', {
            ...
            set: value => {
                ...
                let uri = require('../simple_types/uri.js');
                // eslint-disable-next-line new-cap
                this.__data.targetUri = new uri(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'targetCanonical', {
            ...
            set: value => {
                ...
                let canonical = require('../simple_types/canonical.js');
                // eslint-disable-next-line new-cap
                this.__data.targetCanonical = new canonical(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'group', {
            ...
            set: value => {
                ...
                this.__data.group = new ConceptMapGroup(value);
            }
        });
    ...
    toJSON() {
        return {
            ...
            sourceUri: this.sourceUri && this.sourceUri.toJSON(),
            sourceCanonical: this.sourceCanonical && this.sourceCanonical.toJSON(),
            targetUri: this.targetUri && this.targetUri.toJSON(),
            targetCanonical: this.targetCanonical && this.targetCanonical.toJSON(),

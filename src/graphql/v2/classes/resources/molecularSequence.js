...
class MolecularSequence {
        ...
        */
        Object.defineProperty(this, 'variant', {
            ...
            set: value => {
                ...
                this.__data.variant = new MolecularSequenceVariant(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'quality', {
            ...
            set: value => {
                ...
                this.__data.quality = new MolecularSequenceQuality(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'repository', {
            ...
            set: value => {
                ...
                this.__data.repository = new MolecularSequenceRepository(value);
            }
        });

        /**
         * @description Pointer to next atomic sequence which at most contains one variant.
         * @property {MolecularSequence[]|undefined}
        */
        Object.defineProperty(this, 'pointer', {
            ...
            set: value => {
                ...
                let Reference = require('../complex_types/reference.js');
                this.__data.pointer = new Reference(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'structureVariant', {
            ...
            set: value => {
                ...
                this.__data.structureVariant = new MolecularSequenceStructureVariant(value);
            }
        });
    ...
    toJSON() {
        return {
            ...
            variant: this.variant && this.variant.toJSON(),
            observedSeq: this.observedSeq,
            quality: this.quality && this.quality.toJSON(),
            readCoverage: this.readCoverage,
            repository: this.repository && this.repository.toJSON(),
            pointer: this.pointer && this.pointer.toJSON(),
            structureVariant: this.structureVariant && this.structureVariant.toJSON(),
        };
    }
}

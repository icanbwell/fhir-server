...
class DeviceUseStatement {
    ...
    or completed.
        ...
        */
         ...
         * @property {DeviceUseStatementSubject}
        */
    ...
    information that supports or is used to derive the DeviceUseStatement.
         * @property {DeviceUseStatementDerivedFrom[]|undefined}
        */
        ...
        */
        Object.defineProperty(this, 'recordedOn', {
            ...
            set: value => {
                ...
                let dateTime = require('../simple_types/dateTime.js');
                // eslint-disable-next-line new-cap
                this.__data.recordedOn = new dateTime(value);
            }
        });

        /**
         * @description Who reported the device was being used by the patient.
         * @property {DeviceUseStatementSource|undefined}
        */
        ...
        */
         ...
         * @property {DeviceUseStatementReasonReference[]|undefined}
        */
    ...
    toJSON() {
        return {
            ...
            recordedOn: this.recordedOn && this.recordedOn.toJSON(),

...
class VerificationResult {
        ...
        */
        Object.defineProperty(this, 'targetLocation', {
            ...
            set: value => {
                ...
                this.__data.targetLocation = value;
            }
        });
        ...
        */
        Object.defineProperty(this, 'validationProcess', {
            ...
            set: value => {
                ...
                let CodeableConcept = require('../complex_types/codeableConcept.js');
                this.__data.validationProcess = new CodeableConcept(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'lastPerformed', {
            ...
            set: value => {
                ...
                let dateTime = require('../simple_types/dateTime.js');
                // eslint-disable-next-line new-cap
                this.__data.lastPerformed = new dateTime(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'nextScheduled', {
            ...
            set: value => {
                ...
                // eslint-disable-next-line new-cap
                this.__data.nextScheduled = new date(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'primarySource', {
            ...
            set: value => {
                ...
                this.__data.primarySource = new VerificationResultPrimarySource(value);
            }
        });
        ...
        */
        Object.defineProperty(this, 'validator', {
            ...
            set: value => {
                ...
                this.__data.validator = new VerificationResultValidator(value);
            }
        });
    ...
    toJSON() {
        return {
            ...
            validationProcess: this.validationProcess && this.validationProcess.toJSON(),
            frequency: this.frequency && this.frequency.toJSON(),
            lastPerformed: this.lastPerformed && this.lastPerformed.toJSON(),
            nextScheduled: this.nextScheduled && this.nextScheduled.toJSON(),
            failureAction: this.failureAction && this.failureAction.toJSON(),
            primarySource: this.primarySource && this.primarySource.toJSON(),
            attestation: this.attestation && this.attestation.toJSON(),
            validator: this.validator && this.validator.toJSON(),
        };
    }
}

module.exports = {
    ...
    testPathIgnorePatterns: [
        ...
        '<rootDir>/src/tests/unit/operations/everything/everythingHelper.securityBugs.test.js',
        '<rootDir>/src/tests/unit/operations/graph/graph.test.js',
        '<rootDir>/src/tests/unit/operations/graph/graphHelpers.securityBugs.test.js',

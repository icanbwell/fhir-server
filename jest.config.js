...
module.exports = {
    ...
    testPathIgnorePatterns: [
        ...
        '<rootDir>/src/tests/unit/dataLayer/builders/groupMemberEventBuilder.bugs.test.js',
        '<rootDir>/src/tests/unit/dataLayer/bulkWriteExecutors/clickHouseBulkWriteExecutor.bugs.test.js',
        '<rootDir>/src/tests/unit/dataLayer/databaseAttachmentManager.test.js',
        '<rootDir>/src/tests/unit/dataLayer/databaseBulkInserter.test.js',
        ...
        '<rootDir>/src/tests/unit/dataLayer/fastDatabaseBulkInserter.test.js',
        ...
        '<rootDir>/src/tests/unit/operations/common/fhirLoggingManager.test.js',
        ...
        '<rootDir>/src/tests/unit/operations/streaming/mongoStreamReader.test.js',
        '<rootDir>/src/tests/unit/operations/streaming/resourcePreparerTransform.test.js',
        '<rootDir>/src/tests/unit/operations/streaming/resourceWriters/fhirBundleWriter.test.js',
        ...
        '<rootDir>/src/tests/unit/utils/auditLogger.test.js',

...
For environments other than [dev, perf, client-sandbox, staging, bulk-staging]:
...
To set environment variables for dev environment update the <environment>-ue1.values.yaml in https://github.com/icanbwell/helm.helix-service/tree/main/.helm/fhir-server
